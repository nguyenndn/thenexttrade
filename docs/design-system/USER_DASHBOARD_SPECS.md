...
### Menu Items
- **Container:** `flex items-center gap-4 px-4 py-3.5 rounded-2xl`
...
- **Card Styling:** `bg-white dark:bg-[#0B0E14] border border-gray-100 dark:border-white/5 rounded-2xl shadow-sm`
