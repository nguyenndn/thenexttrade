...
**BỎ tiêu đề H1** vì sidebar đã highlight menu hiện tại. Chỉ hiển thị dòng mô tả + filter bar trên cùng 1 hàng.

- **Description:** `text-base text-primary font-bold` (màu xanh theme, bold)
- **Filter Bar:** Căn phải, chứa AccountSelector + DateRangePicker
- **Responsive:** Mobile stack dọc (3 hàng), Tablet mô tả + filters ngang, Desktop 1 dòng.

```tsx
<div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 mb-4">
    <p className="text-base text-primary font-bold">[Mô tả page ngắn gọn]</p>
