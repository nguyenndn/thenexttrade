        ...
        <div className="min-h-screen bg-[#0B0E14] text-white flex flex-col font-sans selection:bg-blue-500/30">
            ...
            <main className="flex-1 container mx-auto px-4 py-12 md:py-20 flex flex-col items-center justify-center gap-10 md:gap-16">
                ...
                <div className="w-full max-w-5xl animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-200">
                    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-[#1E2028] to-[#0F1117] border border-white/5 p-6 md:p-12 text-center group hover:border-blue-500/30 transition-all duration-500 shadow-2xl shadow-black/50">
                        {/* Background Effects */}
                        ...
                        <div className="relative z-10 flex flex-col items-center gap-4 md:gap-6">
                            ...
                            <Link href="/auth/register">
                                <Button className="h-12 md:h-14 px-8 md:px-10 rounded-2xl font-bold text-base md:text-lg bg-blue-600 hover:bg-blue-500 text-white shadow-xl shadow-blue-600/20 hover:shadow-blue-600/40 hover:-translate-y-1 transition-all duration-300">
                                    Get Started Free
