...
export default async function TradingSystemDetailPage({ params }: PageProps) {
    ...
    let displayVersion =
        dbProduct?.version ||
        system.version ||
        system.parameters.find((p) => p.name.toLowerCase() === "version")
            ?.defaultValue ||
        "1.0.0";
        ...
        <TradingSystemsPageShell maxWidth="max-w-7xl">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                ...
                <div className="text-[11px] font-bold text-gray-400 dark:text-gray-500 tracking-wider">
                    TRADING SYSTEMS &bull; {system.platform} &bull;{" "}
                ...
                <div className="mb-8 rounded-3xl border border-emerald-500/15 dark:border-emerald-500/10 bg-white/80 dark:bg-[#111318]/50 p-6 md:p-8 shadow-sm backdrop-blur-md relative overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                        <div className="max-w-2xl">
                            ...
                            <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed font-semibold mt-4">
                                ...
                                trades running even when your PC is offline.
                            </p>
                        </div>
                    ...
                    <details className="group border-t border-gray-200/50 dark:border-white/5 pt-4 mt-5 relative z-10">
                        ...
                        <div className="mt-2.5 text-xs text-gray-500 dark:text-gray-400 leading-relaxed font-semibold">
                            ...
                            running in the cloud 24/7. Running your Expert
                            Advisor on a VPS ensures continuous execution, low
                            latency to the broker's servers, and safeguards
                            against power outages, system sleep modes, or home
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                        <div className="max-w-2xl">
                            ...
                            <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed font-semibold">
                                ...
                                eligible account under our partner network.
                                Access is free but subject to active partner
                                verification.
                            </p>
                        </div>
                    ...
                    <div className="mt-6 pt-4 border-t border-dashed border-gold/20 dark:border-gold/10 text-[11px] font-semibold text-gray-400 dark:text-gray-500 flex items-start gap-2">
                        ...
                        <div>
                            {system.slug === "goldscalperninja" && (
                                <p>
                                    Risk Note: EA GoldScalperNinja utilizes
                                    automated grid execution. Grid systems can
                                    increase market exposure quickly; ensure you
                                    configure strict daily loss limits and test
                                    on demo/cent environments before live
                                    deployment.
                                </p>
                            )}
                            {system.slug === "trade-manager" && (
                                <p>
                                    Usage Note: Trade Manager is an execution
                                    assistant tool. All trading decisions,
                                    manual entries, and risk parameters remain
                                    the sole responsibility of the user.
                                </p>
                            )}
                            {system.slug === "gsn-phoenix-grid" && (
                                <p>
                                    Risk Warning: GSN Phoenix Grid is an
                                    advanced grid and hedging system designed
                                    for experienced traders only. It uses
                                    aggressive multipliers and hedging cycles
                                    that carry high margin exposure risk.
                                </p>
                            )}
                        </div>
                    </div>
                ...
                <div className="rounded-3xl border border-gray-200 dark:border-white/10 bg-white/60 dark:bg-[#111318]/30 p-6 shadow-sm">
                    ...
                    <div className="space-y-4">
                        {system.faqs.map((faq, idx) => (
                            <div
                                key={idx}
                                className="border-b border-gray-200/50 dark:border-white/5 last:border-0 pb-4 last:pb-0"
                            >
