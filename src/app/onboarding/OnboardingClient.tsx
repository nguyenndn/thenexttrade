                    ...
                    {step === 1 && (
                        <div className="animate-in fade-in duration-300">
                            ...
                            <form action={handleStep1Submit} className="space-y-5">
                                ...
                                {/* User Identity Row */}
                                <div className="flex items-center gap-3 p-3.5 rounded-xl border border-amber-950/10 dark:border-white/5 bg-slate-500/5 dark:bg-white/[0.02]">
                        ...
                        <div className="animate-in fade-in duration-300">
                                        ...
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                tradingGoal === g.id
                                                    ...
                                                    : "border-amber-900/10 dark:border-white/10 hover:border-amber-500/35 dark:hover:border-amber-500/25 bg-white/30 dark:bg-white/[0.01]"
                                            )}
                                        >
                                            <div className={cn(
                            ...
                            <div className="flex gap-3">
                                <Button
                                    ...
                                    type="button"
                                    onClick={() => setStep(1)}
                                    className="flex items-center gap-1.5 border-amber-900/10 dark:border-white/10 text-slate-600 dark:text-slate-300 hover:bg-amber-500/10 hover:text-slate-900 dark:hover:text-white rounded-xl font-extrabold"
                                >
                                    <ArrowLeft size={14} />
                                    Back
                                </Button>
                        ...
                        <div className="animate-in fade-in duration-300">
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-6">
                                {[
                                    ...
                                    <div
                                        key={i}
                                        className="flex items-center gap-2.5 p-3 rounded-xl border border-amber-900/10 dark:border-white/5 bg-white/60 dark:bg-white/[0.02]"
                                    >
