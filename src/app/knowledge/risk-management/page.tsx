...
export default async function RiskManagementPage() {
    ...
    return (
        <div className="min-h-screen bg-[#F7F4EC] dark:bg-[#090805] text-gray-700 dark:text-gray-300 relative overflow-hidden transition-colors duration-300">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-8 mb-16">
                        {PILLAR_SECTIONS.map((section, idx) => (
                            <section 
                                key={idx} 
                                className="bg-white/70 dark:bg-white/[0.02] border border-amber-900/10 dark:border-white/5 rounded-2xl p-6 md:p-8 hover:border-amber-500/20 hover:bg-white/80 dark:hover:bg-white/[0.03] transition-all duration-300 shadow-sm"
                            >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {RISK_TOOLS.map((tool) => (
                                <Link
                                    key={tool.href}
                                    href={tool.href}
                                    className="group flex items-start gap-4 p-5 rounded-2xl border border-amber-900/10 dark:border-white/5 bg-white/70 dark:bg-white/[0.02] hover:border-amber-500/30 hover:bg-white/90 dark:hover:bg-[#11100C]/50 hover:shadow-lg hover:shadow-amber-500/[0.02] transition-all duration-300"
                                >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {relatedArticles.map((article) => (
                                    <Link
                                        ...
                                        className="group p-5 rounded-2xl border border-amber-900/10 dark:border-white/5 bg-white/70 dark:bg-white/[0.02] hover:border-amber-500/30 hover:bg-white/90 dark:hover:bg-[#11100C]/50 hover:shadow-md transition-all duration-300"
                                    >
