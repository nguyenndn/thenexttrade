    ...
    return (
        <main className="min-h-screen bg-[#F7F4EC] dark:bg-[#090805] flex flex-col relative overflow-hidden">
            ...
            <div className="flex-1 pt-24 pb-16 relative z-10 px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-3xl mx-auto text-center space-y-6 mb-16 mt-8">
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-white dark:bg-[#1E2028] border border-gray-200 dark:border-white/10 rounded-2xl p-8 md:p-14 shadow-xl transition-colors duration-300 animate-in fade-in slide-in-from-bottom-10 duration-1000">
                        {/* 
