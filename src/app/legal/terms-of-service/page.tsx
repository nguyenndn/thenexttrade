    ...
    return (
        <>
            <div className="max-w-3xl mx-auto text-center space-y-6 mb-20 mt-12">
                ...
                <h1 className="text-4xl md:text-5xl font-black tracking-tighter text-gray-900 dark:text-white leading-tight animate-in fade-in slide-in-from-bottom-6 duration-700">Terms of Service</h1>
            ...
            <div className="mt-8 p-4 bg-gray-50 dark:bg-[#151925] rounded-xl text-sm text-gray-500 dark:text-gray-400 italic text-center border border-gray-200 dark:border-white/5">
