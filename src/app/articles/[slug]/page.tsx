...
export default async function ArticlePage({ params }: { params: Promise<{ slug: string }> }) {
 ...
 {/* Content Card */}
 <div className="bg-white dark:bg-[#1E2028] rounded-xl shadow-sm border border-dashboard p-6 sm:p-8 lg:p-10">
 <div
 ...
 className="px-4 py-2 bg-white dark:bg-[#1E2028] border border-dashboard rounded-full text-sm font-bold text-gray-600 dark:text-gray-500 hover:bg-primary hover:text-white hover:border-primary transition-all shadow-sm"
 >
 #{tag.name}
 </Link>
 ))}
