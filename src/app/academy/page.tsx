 ...
 />
      ...
      <section className="relative overflow-hidden bg-[linear-gradient(180deg,#fffaf0_0%,#ffffff_70%,#f8fafc_100%)] dark:bg-none dark:bg-[#0B0E14] px-6 pt-32 pb-10 sm:pb-14">
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
          ...
          <svg className="absolute left-1/2 top-8 -translate-x-1/2 h-[220px] w-[900px] max-w-none opacity-[0.55] dark:opacity-[0.35] sm:h-[260px]" viewBox="0 0 900 260" fill="none" aria-hidden="true">
            <defs>
              <linearGradient id="academyPath" x1="0" y1="0" x2="1" y2="0">
                <stop offset="0%" stopColor="#10b981" stopOpacity="0.7" />
                <stop offset="50%" stopColor="#F59E0B" stopOpacity="0.85" />
                <stop offset="100%" stopColor="#10b981" stopOpacity="0.6" />
              </linearGradient>
            </defs>
            <path d="M40 210 C180 120 280 170 420 90 C560 20 680 80 840 40" stroke="url(#academyPath)" strokeWidth="3" fill="none" />
            <path d="M80 230 C210 150 300 190 450 110 C590 45 700 105 860 60" stroke="#F59E0B" strokeOpacity="0.45" strokeWidth="2.5" fill="none" />
            <path d="M20 250 C150 180 260 210 400 140 C540 70 660 120 880 50" stroke="#10b981" strokeOpacity="0.3" strokeWidth="2" fill="none" />
            {/* Animated path markers — dots traveling along curves */}
            <circle r="5" fill="#F59E0B" fillOpacity="0.9">
              <animateMotion dur="8s" repeatCount="indefinite" path="M40 210 C180 120 280 170 420 90 C560 20 680 80 840 40" />
            </circle>
            <circle r="4" fill="#F59E0B" fillOpacity="0.7">
              <animateMotion dur="12s" repeatCount="indefinite" path="M80 230 C210 150 300 190 450 110 C590 45 700 105 860 60" />
            </circle>
            <circle r="3.5" fill="#10b981" fillOpacity="0.8">
              <animateMotion dur="10s" repeatCount="indefinite" path="M20 250 C150 180 260 210 400 140 C540 70 660 120 880 50" />
            </circle>
            {/* Secondary glow dots — offset timing for organic feel */}
            <circle r="3" fill="#F59E0B" fillOpacity="0.5">
              <animateMotion dur="8s" begin="-4s" repeatCount="indefinite" path="M40 210 C180 120 280 170 420 90 C560 20 680 80 840 40" />
            </circle>
            <circle r="2.5" fill="#10b981" fillOpacity="0.4">
              <animateMotion dur="10s" begin="-5s" repeatCount="indefinite" path="M20 250 C150 180 260 210 400 140 C540 70 660 120 880 50" />
            </circle>
          </svg>
        </div>
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg md:text-xl mb-6 sm:mb-10 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
            11 levels. 30+ modules. A structured path from your first trade to confident, disciplined execution.
          </p>
