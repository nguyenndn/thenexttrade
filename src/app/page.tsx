...
async function HomeFeed({ isLoggedIn }: HomeFeedProps) {
  ...
  const trustMetrics = await cache.wrap("home:trust_metrics", async () => {
              ...
              <Link href="/academy">
                ...
                >
                  ...
                  <span className="flex items-center gap-2 relative z-10">
                    Explore Academy <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform duration-300" />
                  </span>
                </Button>
              </Link>
            </div>
