...
async function HomeFeed() {
 ...
 {/* Trending Topics */}
 <section className="py-10 sm:py-16 relative bg-gray-50/50 dark:bg-[#0F1117] border-t border-dashboard overflow-hidden">
 ...
 <section className="relative py-12 sm:py-20 border-t border-dashboard bg-gradient-to-b from-slate-100 via-slate-50 to-slate-100 dark:from-[#0B0E14] dark:via-[#0F1219] dark:to-[#0B0E14] overflow-hidden">
 {/* Background Effects */}
 ...
 <Link key={article.id} href={`/articles/${article.slug}`} className="group relative bg-white dark:bg-[#1E2028] rounded-xl p-2 shadow-sm hover:shadow-lg transition-all duration-300 border border-dashboard flex flex-col">
 ...
 <div className={`shadow-lg shadow-black/20 px-3 py-1.5 rounded-lg text-xs font-black text-white ${idx === 0 ? 'bg-gradient-to-r from-amber-500 to-yellow-400' :
 ...
 <section id="academy-preview" className="py-10 sm:py-16 relative overflow-hidden bg-white dark:bg-[#0B0E14] border-t border-dashboard">
 ...
 <FadeIn delay={0.2} direction="up">
 {/* Daily Quote */}
 <section className="py-10 sm:py-16 relative overflow-hidden border-t border-dashboard bg-gray-50/50 dark:bg-[#0F1117]">
 {/* Background Effects */}
 <div className="absolute inset-0 bg-[radial-gradient(hsl(var(--primary))_1.5px,transparent_1.5px)] [background-size:32px_32px] opacity-[0.3] dark:opacity-[0.2]"></div>
 <DynamicFirefly />
