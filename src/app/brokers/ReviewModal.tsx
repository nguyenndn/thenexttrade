...
function ReviewModal({
    ...
    return (
        <motion.div
            ...
            role="dialog"
            aria-modal="true"
            aria-label={`Review of ${item.name}`}
            onClick={onClose}
        >
            {/* Backdrop */}
            ...
            >
                {/* Header */}
                <div className="p-5 pb-4 border-b border-dashboard flex items-center gap-4 shrink-0">
                    <div
                ...
                {/* Footer CTA */}
                {hasUrl && (
                    <div className="p-4 border-t border-dashboard shrink-0">
                        <a
                            href={item.url!}
                            target="_blank"
