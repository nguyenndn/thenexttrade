            ...
            <div className="relative overflow-hidden">
                ...
                <div className="pt-32 sm:pt-40 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#00C888]/10 text-[#00C888] font-bold text-xs uppercase tracking-wider mb-6 border border-[#00C888]/20 animate-in fade-in slide-in-from-bottom-4">
                            <ShieldCheck size={16} />
                        ...
                        <h1 className="text-4xl md:text-6xl font-black text-gray-900 dark:text-white mb-6 tracking-tight animate-in fade-in slide-in-from-bottom-5">
                            Top <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00C888] to-teal-400">Trusted Brokers</span>
                        </h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {brokers.map((broker: any, index: number) => (
                            <div key={broker.id || index} className="bg-white/80 dark:bg-[#1E2028]/80 backdrop-blur-sm rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-white/5 hover:border-[#00C888] transition-all duration-300 group hover:-translate-y-1 hover:shadow-xl">
                                ...
                                <ul className="space-y-3 mb-8 min-h-[100px]">
                                    {broker.features?.slice(0, 3).map((feature: string, i: number) => (
                                        <li key={i} className="flex items-start gap-3 text-sm text-gray-600 dark:text-gray-300">
                                            <div className="w-1.5 h-1.5 rounded-full bg-[#00C888] mt-1.5 flex-shrink-0" />
                                            {feature}
                                        </li>
                                    ))}
                                </ul>
                                ...
                                <a
                                    ...
                                    className="block w-full text-center py-3 px-6 bg-[#00C888] hover:bg-[#00B078] text-white font-bold rounded-xl transition-colors shadow-lg shadow-[#00C888]/20"
                                >
                                    Open Account
                                </a>
                            </div>
