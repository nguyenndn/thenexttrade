...
export const metadata: Metadata = {
    ...
    description:
        "Stay ahead with our real-time economic calendar. Track high-impact forex news events, central bank announcements, and key economic indicators.",
    keywords: [
        "economic calendar",
        "forex news",
        "NFP",
    ...
    openGraph: {
        ...
        description:
            "Real-time economic calendar with high-impact news events.",
        type: "website",
