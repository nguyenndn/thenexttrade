...
export function EconomicCalendarClient() {
 ...
 {/* Breadcrumb */}
 <div className="flex items-center gap-2.5 text-xs font-semibold bg-gray-50/50 dark:bg-white/[0.02] border border-dashboard/80 rounded-xl px-4 py-2.5 mb-8 w-fit shadow-sm relative z-10 backdrop-blur-sm">
 ...
 {/* Week Navigation Bar */}
 <div className={`rounded-xl border shadow-sm p-2 flex items-center justify-between gap-2 ${isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-dashboard'}`}>
 ...
 {/* Calendar Table */}
 <div className={`rounded-xl border overflow-hidden shadow-sm ${isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-dashboard'}`}>
 {/* Card Header with Full Date */}
 <div className={`px-4 py-4 flex items-center justify-between border-b ${isDark ? 'border-slate-700 bg-slate-800' : 'border-dashboard bg-white'}`}>
 ...
 {/* Table Header */}
 <div className={`grid grid-cols-12 gap-2 md:gap-4 px-4 py-3 border-b text-xs font-bold uppercase tracking-wider ${isDark ? 'bg-slate-900/50 border-slate-700 text-gray-500' : 'bg-gray-50 border-dashboard text-gray-600'}`}>
