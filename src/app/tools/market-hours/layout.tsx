...
export const metadata: Metadata = {
    ...
    description:
        "Track live forex market hours across Sydney, Tokyo, London, and New York sessions. Identify session overlaps and optimal trading times for maximum volatility.",
    keywords: [
        "forex market hours",
        "trading sessions",
        "market overlap",
    ...
    openGraph: {
        ...
        description:
            "Visualize major forex market sessions and identify high-volatility trading opportunities.",
        type: "website",
