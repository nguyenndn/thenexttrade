    ...
    return (
        <div className="w-full space-y-5">
            ...
            {/* ═══════════════════════════════════════════════════════════════════
                HERO BANNER
            ═══════════════════════════════════════════════════════════════════ */}
            <div className="relative overflow-hidden rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#1E2028] shadow-sm">
                {/* Ambient Glow */}
                ...
                <div className="relative px-6 py-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-5">
                        {FEATURES.map(({ icon: Icon, label, desc, color, bg }) => (
                            <div key={label} className="flex items-center gap-3 px-4 py-3 rounded-xl bg-gray-50/80 dark:bg-white/[0.03] border border-gray-100 dark:border-white/5 transition-colors hover:bg-gray-100/80 dark:hover:bg-white/[0.05]">
            ...
            <div className="rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#1E2028] overflow-hidden shadow-sm">
                <div className="px-6 py-5">
                    <div className="flex items-center gap-2.5 mb-5">
                        ...
                        <h2 className="text-sm font-black tracking-tight text-gray-700 dark:text-white">Sync API Key</h2>
                    </div>

                    {!keyData.hasKey ? (
                        /* ── No key yet ── */
                        <div className="text-center py-10">
                            <div className="w-16 h-16 mx-auto rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 flex items-center justify-center mb-5">
                        ...
                        <div className="space-y-4">
                                ...
                                <div className="flex gap-2">
                                    <div className="flex-1 relative">
                                        <input
                                            ...
                                            className="w-full px-4 py-3 bg-gray-50 dark:bg-[#151925] border border-gray-200 dark:border-white/10 rounded-xl text-sm font-mono text-gray-700 dark:text-gray-300 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/20 transition-all select-all"
                                        />
                                    </div>
                                    <Button
                                        onClick={copyKey}
                                        variant="outline"
                                        size="icon"
                                        className="shrink-0 h-[46px] w-[46px] rounded-xl text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary border-gray-200 dark:border-white/10"
                            ...
                            <div className="flex items-center gap-3 pt-4 border-t border-gray-100 dark:border-white/5">
                                <Button
                                    ...
                                    variant="outline"
                                    disabled={isGenerating}
                                    className="px-5 h-10 font-bold text-sm border-gray-200 dark:border-white/10 hover:border-primary/40 hover:text-primary dark:hover:text-primary"
                                >
            ...
            <div className="rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#1E2028] overflow-hidden shadow-sm">
                <div className="px-6 py-5">
                    <div className="flex items-center gap-2.5 mb-5">
                        ...
                        <h2 className="text-sm font-black tracking-tight text-gray-700 dark:text-white">Quick Start</h2>
                    </div>
