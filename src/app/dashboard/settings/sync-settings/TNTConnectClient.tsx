...
export default function TNTConnectClient() {
 ...
 <div key={label} className="flex items-center gap-3 px-4 py-3 rounded-xl bg-gray-50/80 dark:bg-white/[0.03] border border-dashboard transition-colors hover:bg-gray-100/80 dark:hover:bg-white/[0.05]">
