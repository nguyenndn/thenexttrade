...
export function ReferralsClient({ referralCode, data }: ReferralsClientProps) {
    ...
    return (
        <div className="space-y-5">
            <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#0B0E14]">
                ...
                <div className="border-t border-gray-100 px-5 py-4 dark:border-white/10">
                    <div className="grid gap-3 md:grid-cols-3">
                        {stats.map((stat) => (
                            <div
                                key={stat.label}
                                className="flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50 p-3 dark:border-white/5 dark:bg-white/[0.03]"
                            >
                ...
                <div className="border-t border-gray-100 px-5 py-4 dark:border-white/10">
                    ...
                    <div className="flex items-stretch gap-0">
                        <div className="flex flex-1 items-center truncate rounded-l-xl border border-r-0 border-gray-200 bg-gray-50 px-4 py-2.5 font-mono text-sm text-gray-500 dark:border-white/10 dark:bg-[#151925]">
                            {referralLink}
                        </div>
                        <Button
                            type="button"
