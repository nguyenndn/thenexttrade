...
export default async function UserAcademyDashboard() {
 ...
 {nextLesson ? (
 <div id="onborda-academy-resume" className="relative overflow-hidden rounded-xl bg-gradient-to-br from-white via-emerald-50 to-teal-50 dark:from-[#1E2028] dark:to-[#151925] border border-emerald-200/60 border-dashboard p-6 shadow-sm">
 ...
 {/* Available Quizzes */}
 <div className="bg-white dark:bg-[#151925] p-6 rounded-xl border border-dashboard shadow-sm">
 ...
 <div className="bg-white dark:bg-[#151925] p-6 rounded-xl border border-dashboard shadow-sm hover:border-primary/30 transition-colors group">
