...
export function QuizClient({
    ...
    const unlockedIndexes = useMemo(() => {
        ...
        for (let i = 1; i < moduleLessons.length; i++) {
            const allPrevDone = moduleLessons
                .slice(0, i)
        ...
        try {
            ...
            if ("error" in res) {
                ...
                if (res.isCorrect) {
                    ...
                    toast.success(
                        "Excellent! Your answer is absolutely correct."
                    );
                } else {
                    // Trigger CSS shake
                    setShakeActive(true);
                    ...
                    toast.error(
                        "Incorrect! The Quiz Coach is analyzing your response..."
                    );
                }
            }
        } catch (err) {
    ...
    const sidebarContent = (
        <>
            ...
            <div className="bg-white dark:bg-[#151925] rounded-xl border border-dashboard shadow-sm p-5 space-y-3">
                ...
                <div className="pt-2 border-t border-dashboard">
                    ...
                    <div className="w-full bg-gray-100 dark:bg-white/5 rounded-full h-1.5 overflow-hidden">
                        <div
                            ...
                            style={{
                                width: `${moduleLessons.length > 0 ? (completedInModule / moduleLessons.length) * 100 : 0}%`,
                            }}
                        />
                    </div>
                </div>
                {/* Best score */}
                {bestScore !== null && (
                    <div className="pt-2 border-t border-dashboard flex items-center justify-between text-xs">
            ...
            {moduleLessons.length > 0 && (
                <div className="bg-white dark:bg-[#151925] rounded-xl border border-dashboard shadow-sm overflow-hidden">
                    ...
                    <div className="divide-y divide-gray-50 divide-dashboard">
                        {moduleLessons.map((l, idx) => {
                            ...
                            if (isLocked) {
                                return (
                                    <div
                                        key={l.id}
                                        className="flex items-center gap-3 px-4 py-3 text-sm opacity-50"
                                    >
                    ...
                    <div className="p-4 border-t border-dashboard">
                        <div className="flex items-center gap-2 text-sm font-bold text-amber-600 dark:text-amber-400">
                            <Trophy size={14} className="shrink-0" /> Module
                            Quiz
                            {result?.passed && (
                                <CheckCircle
                                    size={12}
        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 text-base font-bold w-full sm:w-auto">
                    {firstLessonSlug && (
                        <Link
                            href={`/dashboard/academy/lessons/${firstLessonSlug}`}
                            className="flex items-center gap-1.5 text-gray-500 hover:text-primary px-3 py-1.5 rounded-full bg-gray-100 dark:bg-white/5 transition-colors text-sm"
                        >
                            <BookOpen size={14} />
                    ...
                    {result ? (
                        <div className="bg-white dark:bg-[#151925] rounded-xl border border-dashboard shadow-sm overflow-hidden">
                            ...
                            >
                                ...
                                <h2 className="text-2xl font-black text-gray-700 dark:text-white mb-2">
                                    {result.passed
                                        ? "Quiz Passed!"
                                        : "Not Quite..."}
                                </h2>
                                ...
                                <div className="mx-8 mb-8 p-4 rounded-xl bg-gradient-to-r from-amber-500/10 to-yellow-500/10 border border-amber-500/20">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <Link
                                            ...
                                            className="px-3 py-1.5 bg-amber-500 hover:bg-amber-600 text-white rounded-lg text-xs font-bold transition-colors whitespace-nowrap"
                                        >
                                            View Certificate
                                        </Link>
                                    </div>
 ...
 `,
                                ...
                                {question && (
                                    <div
                                        className={cn(
                                            "p-6 lg:p-8 transition-transform",
                                            shakeActive && "animate-quiz-shake"
                                        )}
                                    >
                                            ...
                                            {question.options.map(
                                                (option, idx) => {
                                                    ...
                                                    if (isChecked) {
                                                        if (isCorrectOption) {
                                                            buttonClass =
                                                                "border-emerald-500 bg-emerald-500/5 dark:bg-emerald-500/10 ring-2 ring-emerald-500/20 text-emerald-700 dark:text-emerald-400";
                                                            circleClass =
                                                            ...
                                                            buttonClass =
                                                                "border-red-500 bg-red-500/5 dark:bg-red-500/10 ring-2 ring-red-500/20 text-red-700 dark:text-red-400";
                                                            circleClass =
                                                                "bg-red-500 text-white border-red-500";
                                                        } else {
                                                            buttonClass =
                                                                "border-dashboard opacity-40 cursor-not-allowed";
                                                            circleClass =
                                                                "bg-gray-100 dark:bg-white/5 text-gray-400 border-dashboard";
                                                        }
                                                    } else {
                                                        if (isSelectedOption) {
                                                            buttonClass =
                                                            ...
                                                            buttonClass =
                                                                "border-dashboard hover:border-gray-300 dark:hover:border-white/20 hover:bg-gray-50 dark:hover:bg-white/5";
                                                            circleClass =
                                                                "bg-gray-100 dark:bg-white/5 text-gray-600 border-dashboard";
                                                        }
                                                    }
                                        ...
                                        {checkedAnswers[question.id]?.checked &&
                                            !checkedAnswers[question.id]
                                                ?.isCorrect &&
                                            checkedAnswers[question.id]
                                                ?.explanation && (
