...
export function QuizClient({ quiz, previousAttempts, bestScore, moduleLessons, completedLessonIds, firstLessonSlug }: QuizProps) {
 ...
 <h3 className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Module Quiz</h3>
 <h2 className="text-lg font-bold text-gray-700 dark:text-white leading-tight">{quiz.title}</h2>
 {quiz.description && (
 ...
 <span className="flex-1 truncate text-gray-500 dark:text-gray-600">{l.title}</span>
 </div>
 );
 }
 ...
 <span className="flex-1 truncate text-gray-600 dark:text-gray-500">{l.title}</span>
 {l.duration && (
 ...
 <div className="bg-white dark:bg-[#151925] rounded-xl border border-dashboard shadow-sm p-5 space-y-3">
 <h3 className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Previous Attempts</h3>
 ...
 buttonClass = "border-dashboard opacity-40 cursor-not-allowed";
 circleClass = "bg-gray-100 dark:bg-white/5 text-gray-400 border-dashboard";
 }
 } else {
 if (isSelectedOption) {
 ...
 buttonClass = "border-dashboard hover:border-gray-300 dark:hover:border-white/20 hover:bg-gray-50 dark:hover:bg-white/5";
 circleClass = "bg-gray-100 dark:bg-white/5 text-gray-600 border-dashboard";
 }
 }
