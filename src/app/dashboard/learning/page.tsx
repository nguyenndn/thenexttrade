...
export default async function MyLearningPage() {
 ...
 {courses.map(course => (
 <div key={course.id} className="bg-white dark:bg-[#0B0E14] rounded-xl border border-dashboard shadow-sm overflow-hidden flex flex-col group hover:border-[#2F80ED]/30 transition-colors">
