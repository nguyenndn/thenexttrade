...
export default function FundedChallengePage() {
 ...
 <span
 key={item}
 className="px-3 py-1.5 rounded-full bg-gray-100 dark:bg-white/5 border border-dashboard text-xs font-bold text-gray-500 dark:text-gray-400"
 >
 {item}
 </span>
 ))}
 ...
 {/* Hero */}
 <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-6 border border-dashboard dark:border-white/[0.06]">
 ...
 {/* Rules */}
 <div className="bg-white dark:bg-[#1A1D27] rounded-xl border border-dashboard dark:border-white/[0.06] p-6">
