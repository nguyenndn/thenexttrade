    ...
    return (
      <div className="bg-white dark:bg-[#1E2028] rounded-xl border border-gray-200 dark:border-white/10 shadow-sm p-12 text-center">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          Be the first to claim the top spot! Start learning, trading, and
      ...
      <div className="overflow-x-auto custom-scrollbar">
        <table className="w-full text-left border-collapse">
          <thead className="bg-gray-50 dark:bg-white/5 text-xs uppercase text-gray-400 font-bold tracking-wider">
            <tr>
              <th className="w-16 text-center py-3 px-3">Rank</th>
              <th className="py-3 px-3">User</th>
              <th className="py-3 px-3 hidden sm:table-cell">Tier</th>
          ...
          <tbody className="divide-y divide-gray-100 dark:divide-white/5">
            ...
            {/* Separator + current user row (if not in top list) */}
