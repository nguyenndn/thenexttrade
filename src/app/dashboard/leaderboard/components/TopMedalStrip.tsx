...
function getMainValue(entry: LeaderboardEntry, type: LeaderboardType, sortBy?: "percentage" | "currency") {
 switch (type) {
 case "xp":
 ...
 const winRateVal = entry.winRate !== undefined ? entry.winRate : entry.value;
...
export function TopMedalStrip({ entries, currentUserId, onUserClick, type, sortBy = "currency" }: TopMedalStripProps) {
