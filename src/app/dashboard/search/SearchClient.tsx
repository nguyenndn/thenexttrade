                ...
                {isLoading ? (
                    ...
                    <>
                        {results.length > 0 ? (
                            <div className="grid gap-3">
                                {results.map((result) => (
                                    <Link
                                        ...
                                        href={result.slug}
                                        className="block bg-white dark:bg-[#151925] p-5 rounded-2xl border border-gray-100 dark:border-white/5 hover:border-primary dark:hover:border-primary transition-colors group shadow-sm"
                                    >
                            ...
                            <div className="text-center py-12 bg-white dark:bg-[#151925] rounded-2xl border border-gray-100 dark:border-white/5">
