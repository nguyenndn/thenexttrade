                            ...
                            <div className="grid gap-3">
                                {results.map((result) => (
                                    <Link
                                        ...
                                        href={result.slug}
                                        className="block bg-white dark:bg-[#151925] p-5 rounded-2xl border border-gray-100 dark:border-white/5 hover:border-[#00C888] dark:hover:border-[#00C888] transition-colors group shadow-sm"
                                    >
