                                ...
                                <div className="grid gap-4">
                                    {results.map((result) => (
                                        <Link
                                            ...
                                            href={result.slug}
                                            className="block bg-white dark:bg-[#1E2028] p-5 rounded-xl border border-gray-100 dark:border-white/5 hover:border-primary dark:hover:border-primary transition-colors group shadow-sm"
                                        >
