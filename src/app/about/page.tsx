...
export const metadata: Metadata = {
    ...
    description:
        "The story behind TheNextTrade. After years of losses and scattered learning, I built a free forex education platform so new traders don't repeat my mistakes.",
    openGraph: {
        title: "About TheNextTrade | My Journey from Losses to Building Free Trading Tools",
        description:
            "From blown accounts to building the platform I wish I had — the personal story behind TheNextTrade.",
    },
};
                    ...
                    <ScrollReveal>
                        <div className="max-w-4xl mx-auto text-center space-y-4 sm:space-y-6 mt-6 sm:mt-12">
                            ...
                            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                                I lost everything chasing shortcuts. Then I
                                spent years learning the hard way. This is why I
                                built TheNextTrade &mdash; so you don&apos;t
                                have to.
                            </p>
                        </div>
                    </ScrollReveal>
                            ...
                            <div className="bg-gradient-to-br from-white to-emerald-50/50 dark:from-[#1E2028] dark:to-[#1a2520] border border-emerald-200/60 dark:border-primary/20 rounded-2xl p-10 md:p-14 shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all duration-500 relative overflow-hidden group h-full">
                                ...
                                <div className="relative z-10 space-y-6">
                                    ...
                                    <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
                                        To give every retail trader — regardless
                                        of budget — free access to the same
                                        quality tools and education that I spent
                                        years searching for. No paid signals. No
                                        get-rich-quick promises. Just real
                                        knowledge, structured learning, and
                                        honest resources.
                                    </p>
                                </div>
                            </div>
                        ...
                        <ScrollReveal delay={0.3} direction="right">
                            <div className="bg-gradient-to-br from-white to-cyan-50/50 dark:from-[#1E2028] dark:to-[#1a2025] border border-cyan-200/60 dark:border-cyan-500/20 rounded-2xl p-10 md:p-14 shadow-sm hover:shadow-xl hover:shadow-cyan-500/5 transition-all duration-500 relative overflow-hidden group h-full">
                                ...
                                <div className="relative z-10 space-y-6">
                                    ...
                                    <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
                                        One platform where a new trader can
                                        learn everything — from what a pip is to
                                        building a complete trading system. A
                                        place where the knowledge isn&apos;t
                                        scattered, the tools aren&apos;t
                                        paywalled, and the path is clear from
                                        day one.
                                    </p>
                                </div>
                            </div>
                ...
                <section className="px-4 mb-12 sm:mb-24 max-w-6xl mx-auto">
                    <ScrollReveal>
                        <div className="text-center mb-16 space-y-4">
                            <h2 className="text-3xl md:text-4xl font-black tracking-tight text-gray-700 dark:text-white">
                                What I Believe In
                            </h2>
                        ...
                        {[
                            {
                                ...
                                bg: "bg-gradient-to-br from-blue-100 to-indigo-50 dark:from-blue-500/15 dark:to-indigo-500/5",
                                border: "border-blue-200/60 dark:border-blue-500/15",
                                hoverBorder:
                                    "hover:border-blue-500/35 dark:hover:border-blue-500/30",
                                hoverShadow:
                                    "hover:shadow-[0_12px_30px_rgba(59,130,246,0.03)] dark:hover:shadow-[0_12px_30px_rgba(59,130,246,0.01)]",
                                title: "No Shortcuts",
                                desc: "I don't sell signals or promise overnight riches. Trading is a skill — it takes time, discipline, and real education to develop.",
                            },
                            {
                                icon: TrendingUp,
                                ...
                                hoverBorder:
                                    "hover:border-emerald-500/35 dark:hover:border-primary/30",
                                hoverShadow:
                                    "hover:shadow-[0_12px_30px_rgba(16,185,129,0.03)] dark:hover:shadow-[0_12px_30px_rgba(16,185,129,0.01)]",
                                title: "Systems Over Gambling",
                                desc: "Every tool and lesson on this platform teaches systematic, rule-based trading. Because consistent profits come from consistent processes.",
                            },
                            {
                                icon: Users,
                                ...
                                hoverBorder:
                                    "hover:border-amber-500/35 dark:hover:border-gold/30",
                                hoverShadow:
                                    "hover:shadow-[0_12px_30px_rgba(245,158,11,0.03)] dark:hover:shadow-[0_12px_30px_rgba(245,158,11,0.01)]",
                            ...
                            >
                                <div
                                    className={`bg-white/80 dark:bg-[#131622]/60 border border-amber-500/15 dark:border-white/[0.06] rounded-2xl p-8 shadow-sm hover:-translate-y-0.5 transition-all duration-300 h-full backdrop-blur-md overflow-hidden relative group ${item.hoverBorder} ${item.hoverShadow}`}
                                >
                                    <div
                                        className={`w-14 h-14 rounded-xl ${item.bg} ${item.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
                                    >
                                        <item.icon size={28} />
                                    </div>
                                    <h3 className="text-xl font-bold mb-3 text-gray-800 dark:text-white group-hover:text-amber-600 dark:group-hover:text-gold transition-colors">
                                        {item.title}
                                    </h3>
                    ...
                    <ScrollReveal>
                        <div className="rounded-3xl p-10 md:p-16 text-center border border-amber-500/35 dark:border-amber-500/30 bg-gradient-to-br from-amber-500/[0.08] via-amber-50/70 to-orange-500/[0.08] dark:from-transparent dark:to-transparent dark:bg-white/[0.04] shadow-[0_20px_50px_rgba(245,158,11,0.08)] dark:shadow-[0_0_60px_rgba(245,158,11,0.06)] relative overflow-hidden backdrop-blur-md">
                            ...
                            <div className="relative z-10 space-y-8">
                                <h2 className="text-3xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-b from-gray-900 via-gray-900 to-gray-700 dark:from-white dark:via-white dark:to-gray-300 leading-tight">
                                    Ready to Start Your Journey?
                                </h2>
                                <p className="text-sm sm:text-base md:text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
                                    Don&apos;t make the mistakes I made. Start
                                    with the right tools, the right knowledge,
