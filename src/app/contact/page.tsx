...
export default function ContactPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#F7F4EC] dark:bg-transparent text-gray-700 dark:text-white transition-colors duration-300 relative overflow-hidden">
            ...
            <main className="flex-grow pt-24 pb-20 relative z-10 px-4">
                ...
                <div className="max-w-3xl mx-auto text-center space-y-6 mb-20 mt-12">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black tracking-tighter text-gray-700 dark:text-white leading-tight animate-in fade-in slide-in-from-bottom-6 duration-700">
                        Let's Get in{" "}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-[#00A06D]">
                            Touch
                        </span>
                    </h1>
                ...
                <div className="max-w-3xl mx-auto">
                    <div className="bg-white dark:bg-[#1E2028] border border-dashboard rounded-xl p-8 md:p-14 shadow-xl relative overflow-hidden transition-colors duration-300">
                        <div className="relative z-10 mb-8">
                            <h2 className="text-3xl font-black text-gray-700 dark:text-white tracking-tight mb-2">
                                Send us a message
                            </h2>
                        ...
                        {status === "success" && (
                            <div className="mb-8 rounded-xl bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/20 p-5 flex items-start gap-4 animate-in fade-in zoom-in-95 duration-200 shadow-sm">
                                ...
                                <div>
                                    <h4 className="text-green-800 dark:text-green-400 font-bold mb-1 text-lg">
                                        Message Sent Successfully
                                    </h4>
                                    <p className="text-green-600 dark:text-green-500/80 font-medium leading-relaxed">
                                        Thank you for reaching out. Our team
                                        will review your message and get back to
                                        you to the provided email.
                                    </p>
                                </div>
                            </div>
                        )}
                        ...
                        {status === "error" && (
                            <div className="mb-8 rounded-xl bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 p-5 flex items-start gap-4 animate-in fade-in zoom-in-95 duration-200 shadow-sm">
                                ...
                                <div>
                                    <h4 className="text-red-800 dark:text-red-400 font-bold mb-1 text-lg">
                                        Failed to Send Message
                                    </h4>
                                    <p className="text-red-600 dark:text-red-500/80 font-medium leading-relaxed">
                                        {errorMessage}
                                    </p>
                                </div>
                            </div>
                        ...
                        >
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label
                                        htmlFor="name"
                                        className="block text-sm font-bold text-gray-700 dark:text-gray-300 ml-1"
                                    >
                                        Full Name
                                    </label>
                                    <Input
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    id="message"
                                    rows={6}
                                    className={`w-full p-5 rounded-xl bg-gray-50/50 dark:bg-[#131622]/40 border ${errors.message ? "border-red-500 focus:border-red-500 focus:ring-4 focus:ring-red-500/20" : "border-dashboard "} text-base outline-none focus:ring-4 focus:ring-primary/20 focus:border-primary transition-all placeholder:text-gray-500 dark:placeholder:text-gray-600 placeholder:font-normal text-gray-700 dark:text-white font-medium resize-none`}
                                ...
                                ></textarea>
                                {errors.message && (
                                    <p className="text-error text-xs mt-1 ml-1 font-medium">
                                        {errors.message}
                                    </p>
                                )}
                            </div>
