...
export const metadata: Metadata = {
    ...
    description:
        "Master the markets with TheNextTrade. Advanced Position Size Calculator, Trading Journal, and premium Forex Academy materials.",
    keywords: [
        "Forex",
        "Trading Journal",
        "Position Calculator",
    ...
    return (
        <html lang="en" suppressHydrationWarning>
            <head>
                <link
                    rel="dns-prefetch"
                    href="https://sdugjioikugfomjitfwg.supabase.co"
                />
                {gaMeasurementId && (
                    <>
                        <link
                ...
                <ThemeProvider>
                    ...
                    <JsonLd
                        ...
                        data={{
                            ...
                            foundingDate: "2024",
                            sameAs: ["https://twitter.com/thenexttrade"],
                            contactPoint: {
                                "@type": "ContactPoint",
