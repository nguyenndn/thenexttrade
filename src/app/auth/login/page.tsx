...
function LoginSuccessOverlay({
    ...
    return createPortal(
        <div
            className="fixed inset-0 z-[99999] flex flex-col items-center justify-center select-none bg-[#F7F4EC] dark:bg-[linear-gradient(135deg,#2b2344_0%,#193451_50%,#06454f_100%)] transition-colors"
            style={{ margin: 0 }}
        >
...
export default function LoginPage() {
    ...
    const [transitionRedirectTo, setTransitionRedirectTo] = useState<
        string | undefined
    >();
    ...
    return (
        <>
            ...
            {showTransition && (
                <LoginSuccessOverlay
                    name={transitionName}
                    redirectTo={transitionRedirectTo}
                />
            )}
        </>
    );
