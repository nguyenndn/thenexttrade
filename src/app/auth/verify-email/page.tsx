    ...
    return (
        <div className="w-full max-w-[480px] mx-auto bg-white dark:bg-[#1E2028] p-8 rounded-xl border border-gray-200 dark:border-white/10 shadow-xl transition-colors duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                    type="submit"
                    className="w-full h-14 bg-[#0B0E14] text-white hover:bg-[#1E2028] dark:bg-primary dark:text-black dark:hover:bg-[#00b078] font-bold text-base border-none rounded-xl shadow-md transition-all shadow-black/5 flex items-center justify-center gap-2"
                    isLoading={loading}
