...
export default function SecurityDashboard() {
        ...
        try {
            const res = await fetch("/api/admin/security/blocked-ips", {
                ...
                body: JSON.stringify({
                    ...
                    durationMinutes: blockForm.duration
                        ? parseInt(blockForm.duration)
                        : undefined,
                }),
            });
            if (res.ok) {
    ...
    return (
        <Tabs
            value={tab}
            onValueChange={(v) => setTab(v as "events" | "blocked")}
            tabsId="admin-security"
        >
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-300 mt-0.5">
                                Monitor threats, blocked IPs & security events.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="flex items-end gap-1 h-20">
                            {trend.map((t, i) => (
                                ...
                                >
                                    ...
                                    <div
                                        className="w-full rounded-lg bg-gradient-to-t from-primary/80 to-emerald-400/80 transition-all hover:from-primary hover:to-emerald-400"
                                        style={{
                            ...
                            <div className="overflow-x-auto custom-scrollbar">
                                <table className="w-full text-left border-collapse">
                                    <thead className="bg-gray-50 dark:bg-white/5 text-xs uppercase text-gray-500 font-bold tracking-wider">
                                        <tr>
                                            <th className="px-6 py-4 border-b border-gray-200 dark:border-white/10">
                                                Type
                                            </th>
                                            <th className="px-6 py-4 border-b border-gray-200 dark:border-white/10">
                                                IP
                                            </th>
                                            <th className="px-6 py-4 border-b border-gray-200 dark:border-white/10 hidden md:table-cell">
                                                Path
                                            </th>
                                            <th className="px-6 py-4 border-b border-gray-200 dark:border-white/10 hidden lg:table-cell">
                                                Detail
                                            </th>
                                            <th className="px-6 py-4 border-b border-gray-200 dark:border-white/10 text-right">
                                                Time
                                            </th>
                                        </tr>
                                    </thead>
                                        ...
                                        {events.length === 0 ? (
                                            ...
                                            events.map((ev) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-6 py-4 text-gray-500 dark:text-gray-400 hidden md:table-cell max-w-[200px] truncate">
                                                        {ev.path || "-"}
                                                    </td>
                                                    <td className="px-6 py-4 text-gray-500 dark:text-gray-400 hidden lg:table-cell max-w-[300px] truncate text-xs">
                                                        {ev.detail || "-"}
                                                    </td>
                            ...
                            <div className="bg-white dark:bg-[#1E2028] rounded-xl border border-gray-200 dark:border-white/10 p-5 shadow-sm">
                                ...
                                <div className="space-y-3">
                                    {topIPs.slice(0, 5).map((t, i) => (
                                        ...
                                        >
                                            <span className="text-xs font-mono font-bold text-gray-700 dark:text-gray-300 w-36 truncate">
                                                {t.ip}
                                            </span>
                                            <div className="flex-1 h-2 bg-gray-100 dark:bg-white/5 rounded-full overflow-hidden">
                                                <div
                                                    ...
                                                    style={{
                                                        width: `${(t.count / topIPs[0].count) * 100}%`,
                                                    }}
                                                />
                                            </div>
                            ...
                            <div className="p-6 space-y-5">
                                ...
                                <div className="flex items-center justify-end gap-3 pt-2">
                                    ...
                                    <Button
                                        ...
                                        disabled={!blockForm.ip || blocking}
                                        isLoading={blocking}
