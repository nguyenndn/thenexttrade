...
export default async function EADashboardPage() {
 ...
 <div className="bg-white dark:bg-[#0B0E14] rounded-xl p-5 border border-dashboard shadow-sm h-full flex flex-col">
 ...
 <div
 key={license.id}
 className="flex items-center justify-between p-3.5 rounded-xl bg-gray-50 dark:bg-white/5 border border-dashboard hover:shadow-md transition-shadow group"
 >
 ...
 <div className="bg-white dark:bg-[#0B0E14] rounded-xl p-5 border border-dashboard shadow-sm h-full">
