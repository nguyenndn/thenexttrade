...
export default function Loading() {
 ...
 {[1, 2, 3, 4].map((i) => (
 <div key={i} className="h-32 bg-white dark:bg-[#1E2028] rounded-xl border border-dashboard animate-pulse" />
 ))}
 </div>
 ...
 {[1, 2, 3].map((i) => (
 <div key={i} className="h-40 bg-white dark:bg-[#1E2028] rounded-xl border border-dashboard animate-pulse" />
 ))}
 </div>
 </div>
 );
