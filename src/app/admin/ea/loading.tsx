        ...
        <div className="space-y-6 pb-10 animate-in fade-in max-w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[1, 2, 3, 4].map((i) => (
                    <div
                        key={i}
                        className="h-32 bg-white dark:bg-[#1E2028] rounded-xl border border-gray-200 dark:border-white/10 animate-pulse"
                    />
                ))}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[1, 2, 3].map((i) => (
                    <div
                        key={i}
                        className="h-40 bg-white dark:bg-[#1E2028] rounded-xl border border-gray-200 dark:border-white/10 animate-pulse"
                    />
                ))}
            </div>
        </div>
