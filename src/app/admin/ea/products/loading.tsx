...
export default function Loading() {
 ...
 <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-dashboard pb-8">
 ...
 <div className="h-16 bg-white dark:bg-[#0B0E14] rounded-xl border border-dashboard animate-pulse mb-6" />

 {/* Table Card Skeleton */}
 <div className="h-96 bg-white dark:bg-[#151925] rounded-xl border border-dashboard flex flex-col p-4 animate-pulse">
