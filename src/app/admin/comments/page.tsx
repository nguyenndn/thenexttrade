                                    ...
                                    Array.from({ length: 5 }).map((_, i) => (
                                        <tr key={i} className="animate-pulse">
                                            <td className="pl-6 pr-4 py-4">
                                                <div className="w-5 h-5 bg-gray-200 dark:bg-white/10 rounded-lg" />
                                            </td>
                                            <td className="py-4 px-6">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <div className="h-3 w-32 bg-gray-100 dark:bg-white/5 rounded-lg" />
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="py-4 px-6">
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="h-4 w-3/4 bg-gray-100 dark:bg-white/5 rounded-lg" />
                                                </div>
                                            </td>
                                            <td className="py-4 px-6">
                                                <div className="h-4 w-24 bg-gray-200 dark:bg-white/10 rounded-lg" />
                                        ...
                                        >
                                            <td className="pl-6 pr-4 py-4">
                                                <Button
                                                    ...
                                                    className={`w-5 h-5 min-w-0 min-h-0 p-0 flex items-center justify-center text-gray-500 hover:bg-transparent hover:text-gray-600 ${selectedIds.has(comment.id) ? "text-primary" : ""}`}
