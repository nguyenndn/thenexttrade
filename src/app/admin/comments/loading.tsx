        ...
        <div className="space-y-10 pb-10 animate-in fade-in">
            ...
            <div className="space-y-4">
                {[...Array(5)].map((_, i) => (
                    <div
                        key={i}
                        className="bg-white dark:bg-[#151925] border border-gray-200 dark:border-white/10 rounded-xl p-6 shadow-sm animate-pulse"
                    >
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="h-4 w-2/3 bg-gray-50 dark:bg-white/5 rounded-lg" />
                        </div>
                    </div>
                ))}
            </div>
