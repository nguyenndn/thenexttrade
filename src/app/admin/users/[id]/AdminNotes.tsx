...
export function AdminNotes({ userId, initialNotes }: AdminNotesProps) {
 ...
 rows={4}
 className="w-full p-3 rounded-lg bg-gray-50 dark:bg-white/5 border border-dashboard text-sm text-gray-700 dark:text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary/50 resize-none"
 />
 </div>
 </div>
 );
