...
export default async function UserDetailPage({
 ...
 {/* Profile Card */}
 <div className="relative overflow-hidden rounded-xl border border-dashboard bg-white shadow-sm border-dashboard dark:bg-[#151925]">
 {/* Gradient Cover */}
 ...
 <div className="mt-3 inline-flex max-w-full items-center gap-2 rounded-full border border-dashboard bg-white/80 px-3 py-1 text-xs font-bold text-gray-700 shadow-sm border-dashboard dark:bg-white/5 dark:text-gray-200">
 {countryCode ? (
 <>
 <img
 ...
 <div className="border-t border-dashboard bg-gray-50/70 p-4 border-dashboard dark:bg-[#1a1f2e] sm:px-6 sm:py-4">
 ...
 {/* Trading Accounts */}
 <div className="bg-white dark:bg-[#151925] border border-dashboard rounded-xl overflow-hidden">
 <div className="p-4 sm:p-6 border-b border-dashboard flex items-center justify-between">
 ...
 <div className="bg-white dark:bg-[#151925] border border-dashboard rounded-xl p-4 sm:p-6 overflow-hidden">
 <h3 className="text-base font-bold text-gray-700 dark:text-white border-b border-dashboard pb-3 mb-4">
 Activity Overview
 </h3>
 ...
 <div key={stat.label} className="rounded-lg border border-dashboard bg-gray-50 p-3 text-center border-dashboard dark:bg-white/5">
 ...
 {/* Achievements */}
 <div className="bg-white dark:bg-[#151925] border border-dashboard rounded-xl overflow-hidden">
 <div className="px-4 sm:px-6 py-3 border-b border-dashboard flex items-center justify-between">
 ...
 {user.badges.map(ub => (
 <div key={ub.id} className="flex flex-col items-center gap-1 p-2 rounded-lg bg-gray-50 dark:bg-white/5 border border-dashboard hover:border-primary/30 transition-colors group" title={ub.badge.description}>
 ...
 <div className="xl:col-span-3 bg-white dark:bg-[#151925] border border-dashboard rounded-xl p-4 sm:p-6">
 <h3 className="text-base font-bold text-gray-700 dark:text-white border-b border-dashboard pb-3 mb-4">
 Recent Activity Timeline
 </h3>
 {timelineEvents.length > 0 ? (
 <div className="max-h-[290px] overflow-y-auto pr-1">
 <div className="relative border-l-2 border-dashboard ml-4 space-y-5 pl-5">
