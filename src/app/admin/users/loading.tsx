            ...
            <div className="bg-white dark:bg-[#151925] rounded-xl border border-gray-200 dark:border-white/10 overflow-hidden">
                ...
                <div className="bg-gray-50 dark:bg-white/5 px-6 py-4 flex gap-4">
                    {[...Array(5)].map((_, i) => (
                        <div
                            key={i}
                            className="h-4 bg-gray-200 dark:bg-white/10 rounded-lg w-full"
                        />
                    ))}
                </div>
                    ...
                    {[...Array(8)].map((_, i) => (
                        ...
                        >
                            ...
                            <div className="space-y-2 w-full">
                                <div className="h-4 w-1/3 bg-gray-100 dark:bg-white/5 rounded-lg" />
                                <div className="h-3 w-1/4 bg-gray-50 dark:bg-white/5 rounded-lg" />
                            </div>
