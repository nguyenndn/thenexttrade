export default function Loading() {
 ...
 {/* Header Skeleton */}
 <div className="border-b border-dashboard pb-8">
 ...
 {[...Array(5)].map((_, i) => (
 <div key={i} className="h-10 w-full bg-white dark:bg-[#151925] rounded-xl border border-dashboard" />
 ))}
 </div>

 {/* Form Area */}
 <div className="lg:col-span-3 space-y-6">
 <div className="bg-white dark:bg-[#151925] rounded-xl border border-dashboard p-8 space-y-6">
 ...
 <div className="h-12 w-full bg-gray-50 dark:bg-white/5 rounded-xl border border-dashboard" />
 </div>
 ))}
 </div>
 ...
 <div className="h-32 w-full bg-gray-50 dark:bg-white/5 rounded-xl border border-dashboard" />
 </div>
