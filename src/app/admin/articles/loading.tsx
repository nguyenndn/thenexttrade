        ...
        <div className="space-y-10 pb-10 animate-pulse">
            ...
            <div className="bg-white dark:bg-[#151925] rounded-xl border border-gray-200 dark:border-white/10 overflow-hidden">
                ...
                <div className="p-6 border-b border-gray-200 dark:border-white/10 flex gap-4">
                    ...
                    <div className="h-10 w-32 bg-gray-50 dark:bg-white/5 rounded-xl" />
                </div>

                {/* Table Header */}
                <div className="bg-gray-50 dark:bg-white/5 px-6 py-4 flex gap-4">
                    <div className="h-4 w-1/2 bg-gray-200 dark:bg-white/10 rounded-lg" />
                    <div className="h-4 w-1/4 bg-gray-200 dark:bg-white/10 rounded-lg" />
                    <div className="h-4 w-1/4 bg-gray-200 dark:bg-white/10 rounded-lg" />
                </div>
                    ...
                    {[...Array(6)].map((_, i) => (
                        ...
                        >
                            <div className="space-y-2 flex-1">
                                <div className="h-5 w-3/4 bg-gray-100 dark:bg-white/5 rounded-lg" />
                                <div className="h-3 w-1/2 bg-gray-50 dark:bg-white/5 rounded-lg" />
                            </div>
                            <div className="h-6 w-24 bg-gray-100 dark:bg-white/5 rounded-full shrink-0" />
