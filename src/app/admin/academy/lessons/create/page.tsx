...
function LessonForm() {
    ...
    const [modules, setModules] = useState<
        { id: string; title: string; levelTitle: string; levelId: string }[]
    >([]);
    ...
    return (
        <div className="w-full space-y-6 pb-24">
            <AdminPageHeader
                ...
                backHref={
                    modules.find((m) => m.id === formData.moduleId)?.levelId
                        ? `/admin/academy/${modules.find((m) => m.id === formData.moduleId)!.levelId}`
                        : "/admin/academy"
                }
            >
                <AIRewriteDialog
