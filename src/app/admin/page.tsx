...
function WidgetSkeleton() {
 return (
 <div className="bg-white dark:bg-[#1E2028] p-6 rounded-xl border border-dashboard shadow-sm h-full min-h-[350px] flex items-center justify-center animate-pulse">
