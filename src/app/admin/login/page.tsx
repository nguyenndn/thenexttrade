...
export default function AdminLoginPage() {
    ...
    return (
        <div className="bg-white dark:bg-[#1E2028] p-8 rounded-2xl border border-gray-200 dark:border-white/10 shadow-2xl shadow-black/5 dark:shadow-black/20 transition-colors duration-300">
            {/* Admin Badge */}
