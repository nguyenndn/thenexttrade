...
import { Save, ShieldAlert, Bell, MessageCircle, Loader2 } from "lucide-react";
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    Temporarily disable EA registration and API
                                    access.
                                </p>
                            </div>
                            <Controller
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    Automatically grant access without admin
                                    review.
                                </p>
                            </div>
                            <Controller
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            {errors.adminAlertEmail && (
                                <p className="text-red-500 text-xs mt-1">
                                    {errors.adminAlertEmail.message}
                                </p>
                            )}
                            <p className="text-xs text-gray-600 mt-2">
                                Where to send new pending request alerts.
                            </p>
                        </div>
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-white/10">
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    Notify users automatically when approved.
                                </p>
                            </div>
                            <Controller
                                control={control}
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    Push notifications to a Telegram group or
                                    channel.
                                </p>
                            </div>
                            <Controller
                        ...
                        {errors.telegramEnabled && isTelegramEnabled && (
                            <p className="text-red-500 text-sm mt-2">
                                {errors.telegramEnabled.message}
                            </p>
                        )}
                    </div>
                </div>
