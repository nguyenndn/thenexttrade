...
export function IbOverviewClient({ range, overview, leadStats, vipStats }: Props) {
 ...
 <div className="flex flex-col gap-5 border-b border-dashboard pb-8 border-dashboard lg:flex-row lg:items-center lg:justify-between">
 ...
 <div className="flex items-center gap-2 rounded-xl border border-dashboard bg-white p-1 shadow-sm border-dashboard dark:bg-[#10131B]">
 ...
 <div className="rounded-xl border border-white/70 bg-white/80 p-4 shadow-sm border-dashboard dark:bg-white/[0.04]">
 ...
 key={action.title}
 href={action.href}
 className="group rounded-xl border border-dashboard bg-white p-5 shadow-sm transition-all hover:-translate-y-0.5 hover:border-emerald-200 hover:shadow-lg border-dashboard dark:bg-[#151925] dark:hover:border-emerald-500/20"
 >
 ...
 <div className="rounded-xl border border-dashboard bg-white p-5 shadow-sm border-dashboard dark:bg-[#1E2028]">
 ...
 <div className="rounded-xl border border-dashboard bg-white p-6 shadow-sm border-dashboard dark:bg-[#1E2028]">
 ...
 <div className="mt-5 rounded-xl border border-dashboard bg-gray-50 px-4 py-3 border-dashboard dark:bg-white/[0.02]">
 ...
 <div
 key={source.source}
 className="flex items-center justify-between rounded-xl border border-dashboard bg-gray-50 px-4 py-2.5 border-dashboard dark:bg-white/[0.02]"
 >
 ...
 <Link
 href="/admin/ib/pipeline"
 className="group flex items-center gap-3 rounded-xl border border-dashboard bg-white px-5 py-4 shadow-sm transition-all hover:border-amber-200 hover:shadow-lg border-dashboard dark:bg-[#1E2028] dark:hover:border-amber-500/20"
 >
 ...
 <Link
 href="/admin/ib/traders"
 className="group flex items-center gap-3 rounded-xl border border-dashboard bg-white px-5 py-4 shadow-sm transition-all hover:border-cyan-200 hover:shadow-lg border-dashboard dark:bg-[#1E2028] dark:hover:border-cyan-500/20"
 >
 ...
 className="group flex items-center gap-3 rounded-xl border border-dashboard bg-white px-5 py-4 shadow-sm transition-all hover:border-gray-300 hover:shadow-lg border-dashboard dark:bg-[#1E2028] dark:hover:border-white/20"
 >
