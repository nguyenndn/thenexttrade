...
export function ToolsPageShell({
  ...
  return (
    <div className={`min-h-screen flex flex-col bg-[#f8faf9] dark:bg-transparent text-gray-700 dark:text-white relative isolate overflow-hidden ${className}`}>
      ...
      {/* Technical grid, softened so the cards remain the focus */}
      ...
      {/* Library pages feel more discoverable; tool pages feel more focused. */}
      <div
        className={
          isWorkspace
            ? "absolute inset-x-0 top-16 -z-10 h-[360px] bg-[radial-gradient(ellipse_at_50%_0%,rgba(245,158,11,0.055),transparent_56%),linear-gradient(90deg,transparent,rgba(16,185,129,0.055)_50%,transparent)] [mask-image:linear-gradient(to_bottom,#000,transparent)] dark:bg-[radial-gradient(ellipse_at_50%_0%,rgba(245,158,11,0.055),transparent_58%),linear-gradient(90deg,transparent,rgba(16,185,129,0.035)_50%,transparent)]"
            : "absolute inset-x-0 top-16 -z-10 h-[440px] bg-[radial-gradient(ellipse_at_50%_0%,rgba(245,158,11,0.045),transparent_60%),linear-gradient(90deg,transparent,rgba(16,185,129,0.06)_50%,transparent)] [mask-image:linear-gradient(to_bottom,#000,transparent)] dark:bg-[radial-gradient(ellipse_at_50%_0%,rgba(245,158,11,0.05),transparent_62%),linear-gradient(90deg,transparent,rgba(16,185,129,0.038)_50%,transparent)]"
        }
      />
      ...
      {!isWorkspace && <DynamicFirefly />}

      <PublicHeader />

      <main className={`flex-1 pt-28 sm:pt-32 pb-16 relative z-10 ${mainClassName}`}>
