...
export function EventRow({ event, timezone = "Asia/Bangkok" }: EventRowProps) {
    ...
    return (
        <div className="grid grid-cols-12 gap-2 md:gap-4 py-3 border-b border-dashboard hover:bg-gray-50 dark:hover:bg-white/5 transition-colors items-center px-4 group">
            ...
            <div className="col-span-6 md:col-span-5">
                <p
                    className="font-semibold text-gray-700 dark:text-white text-sm md:text-sm line-clamp-1 group-hover:text-cyan-500 transition-colors cursor-pointer"
                    title={event.title}
                >
                    {event.title}
                </p>
