...
export const ALL_TIMEZONES: TimezoneOption[] = [
    {
        ...
        offsetDisplay: "GMT -11",
    },
    {
        label: "Hawaii (GMT -10)",
        value: "Pacific/Honolulu",
        offsetDisplay: "GMT -10",
    },
    {
        label: "Alaska (GMT -9)",
    ...
    {
        label: "Puerto Rico (GMT -4)",
        value: "America/Puerto_Rico",
        offsetDisplay: "GMT -4",
    },
    {
        label: "Sao Paulo (GMT -3)",
        value: "America/Sao_Paulo",
        offsetDisplay: "GMT -3",
    },
    {
        label: "South Georgia (GMT -2)",
    ...
    },
    {
        ...
        value: "Asia/Kolkata",
        offsetDisplay: "GMT +5:30",
    },
    {
        label: "Kathmandu (GMT +5:45)",
        value: "Asia/Kathmandu",
        offsetDisplay: "GMT +5:45",
    },
    { label: "Dhaka (GMT +6)", value: "Asia/Dhaka", offsetDisplay: "GMT +6" },
    {
        label: "Yangon (GMT +6:30)",
        value: "Asia/Yangon",
        offsetDisplay: "GMT +6:30",
    },
    {
        label: "Bangkok (GMT +7)",
        value: "Asia/Bangkok",
    ...
    {
        label: "Adelaide (GMT +10:30)",
        value: "Australia/Adelaide",
        offsetDisplay: "GMT +10:30",
    },
    {
        label: "Solomon Is. (GMT +11)",
    ...
    },
    {
        label: "Fiji (GMT +12)",
        value: "Pacific/Fiji",
        offsetDisplay: "GMT +12",
    },
    {
        label: "Auckland (GMT +13)",
        value: "Pacific/Auckland",
        offsetDisplay: "GMT +13",
    },
    {
        label: "Kiritimati (GMT +14)",
        value: "Pacific/Kiritimati",
        offsetDisplay: "GMT +14",
    },
];
...
export function TimezoneSelector({ value, onChange }: TimezoneSelectorProps) {
    ...
    const defaultZone =
        ALL_TIMEZONES.find((z) => z.value === "Asia/Bangkok") ||
        ALL_TIMEZONES[0];
    const selectedZone =
        ALL_TIMEZONES.find((z) => z.value === value) || defaultZone;
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <Button
                ...
                className={`flex items-center gap-2 px-3 py-2 rounded-lg border transition-all h-auto w-full sm:w-auto font-normal ${
                    isDark
                        ? "bg-slate-800 border-slate-700 hover:border-slate-600 text-gray-200"
                        : "bg-white border-dashboard hover:border-gray-300 text-gray-700"
                }`}
            >
                ...
                <span className="text-xs font-medium truncate">
                    ...
                    <span className="opacity-70">
                        ({selectedZone.offsetDisplay})
                    </span>
                    <span className="ml-1 font-bold text-cyan-500">
                        {currentTime}
                    </span>
                </span>
                <ChevronDown
                ...
                <div
                    className={`absolute right-0 mt-2 w-64 rounded-xl shadow-xl border overflow-hidden z-50 ${
                        isDark
                            ...
                            : "bg-white border-dashboard"
                    }`}
                >
                    <div
                        className={`px-4 py-2 text-xs font-bold uppercase tracking-wider border-b ${
                            isDark
                                ? "bg-slate-900/50 text-gray-500 border-slate-700"
                                : "bg-gray-50 text-gray-600 border-dashboard"
                        }`}
                    >
                        Select Timezone
                    </div>
                        ...
                        {ALL_TIMEZONES.map((zone) => (
                            ...
                            >
                                <div className="flex flex-col items-start text-left">
                                    <span
                                        className={`font-medium ${selectedZone.label === zone.label ? "text-cyan-500" : ""}`}
                                    >
                                        {zone.label}
                                    </span>
