...
export function FilterModal({ isOpen, onClose, onApply, initialFilters }: FilterModalProps) {
 ...
 onClick={onClose}
 variant="outline"
 className={`rounded-lg font-medium text-sm transition-colors ${isDark ? 'text-gray-500 hover:text-white hover:bg-slate-700' : 'text-gray-600 hover:text-gray-700 hover:bg-gray-100'}`}
 >Cancel
 </Button>
 <Button
