...
export async function ToolPageLayout({ tool, children }: ToolPageLayoutProps) {
 ...
 <div className="mb-16">
 <div className="bg-white dark:bg-[#151925] border border-dashboard rounded-2xl p-6 md:p-8 shadow-lg">
 {children}
 </div>
 </div>
 ...
 <div className="mb-16">
 <div className="bg-gray-50 dark:bg-[#151925] border border-dashboard rounded-2xl p-6 md:p-8">
 <div className="flex items-center gap-3 mb-6">
