        ...
        <div className="min-h-screen flex flex-col bg-white dark:bg-[#0B0E14] text-gray-900 dark:text-white">
            ...
            <main className="flex-1 pt-28 pb-20">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-16">
                        <div className="bg-gradient-to-br from-primary/5 to-teal-500/5 dark:from-primary/10 dark:to-teal-500/10 border border-primary/10 dark:border-primary/20 rounded-2xl p-6 md:p-8">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-xl font-bold text-gray-900 dark:text-white">How to Use This Calculator</h2>
                            </div>
                                ...
                                {tool.howToUse.map((step, idx) => (
                                    <div key={idx} className="flex gap-4">
                                        ...
                                        <div>
                                            ...
                                            <span className="text-gray-600 dark:text-gray-400 text-sm"> — {step.detail}</span>
                                        </div>
                                    </div>
                                ))}
                            </div>
                    ...
                    {/* ── Section 4: What Is ── */}
                    <div className="mb-16">
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">{tool.whatIs.heading}</h2>
                        <div className="space-y-4">
                    ...
                    <div className="mb-16">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white">Similar Tools You Might Find Useful</h2>
                        </div>
