            ...
            <div className="space-y-6">
                ...
                <div className="space-y-3 pt-4 border-t border-dashboard">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span
                            className={`font-bold ${data.avgPnLAfterWin >= 0 ? "text-green-500" : "text-red-500"}`}
                        >
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span
                            className={`font-bold ${data.avgPnLAfterLoss >= 0 ? "text-green-500" : "text-red-500"}`}
                        >
...
function IndicatorCard({
 ...
 `}
        >
            ...
            <p
                className={`text-2xl font-black ${isGood ? "text-gray-700 dark:text-white" : "text-red-500"}`}
            >
                {value}
            </p>
            {subtext && (
