...
export function EdgeInfoContent() {
    return (
        <div className="space-y-8 text-gray-700 dark:text-gray-300">
            {/* Introduction */}
            <section className="bg-white dark:bg-[#15171E] p-6 sm:p-8 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm">
            ...
            <section>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                    {[
                        ...
                        <div key={tier.name} className="p-3 sm:p-4 rounded-xl border border-gray-100 dark:border-gray-800 flex flex-col items-center justify-center text-center bg-white dark:bg-[#15171E] shadow-sm">
            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
                ...
                <section className="flex flex-col h-full">
                    ...
                    <ul className="space-y-3 bg-white dark:bg-[#15171E] p-5 sm:p-6 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm flex-1 text-sm sm:text-base">
            ...
            {/* Fair Use Rules */}
            <section className="bg-gray-50 dark:bg-gray-800/30 p-5 sm:p-6 rounded-xl border border-gray-100 dark:border-gray-800">
