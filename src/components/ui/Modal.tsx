    ...
    return createPortal(
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
            <div
                ...
                onClick={onClose}
            />
            <div className="relative w-full max-w-4xl max-h-[90vh] flex flex-col transform rounded-xl bg-white dark:bg-[#151925] shadow-xl transition-all border border-dashboard cursor-default">
