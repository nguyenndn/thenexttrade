...
export type ButtonVariant = "primary" | "secondary" | "accent" | "ghost" | "link" | "outline" | "destructive";
...
export function buttonVariants({
  ...
  const variants: Record<ButtonVariant, string> = {
    ...
    outline: "border-dashboard hover:border-gray-300 dark:hover:border-white/20 text-gray-700 dark:text-gray-300 bg-transparent hover:bg-gray-50 dark:hover:bg-white/5",
