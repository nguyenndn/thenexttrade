...
export function ImageUploader({
    ...
    if (isInputVisible) {
        return (
            <div
                className={`aspect-video rounded-xl border-2 border-dashed border-primary bg-gray-50 dark:bg-black/20 flex flex-col items-center justify-center p-4 gap-2 ${className}`}
            >
                ...
                <input
                    ...
                    className="w-full text-xs p-2 rounded-lg border border-dashboard bg-white dark:bg-white/5 outline-none focus:border-primary"
                    autoFocus
 ...
 ${value ? "border-transparent" : "border-dashboard hover:border-primary bg-gray-50 dark:bg-black/20"}
 ${className}
 `}
        >
            {value ? (
                    ...
                    <div className="relative w-full h-full">
                        <img
                            ...
                            onError={(e) => {
                                ...
                                target.src =
                                    "https://placehold.co/600x400?text=Link+Error+-+Try+Copy+Image+Address";
                                toast.error(
                                    "Failed to load image! Please make sure it's a Direct Link ending in .png/.jpg"
                                );
                            }}
                        />
                    ...
                    <div className="text-[10px] text-gray-500 text-center mt-1">
                        ...
                        <div className="flex gap-2 justify-center mt-1">
                            ...
                            <span
                                ...
                                title="Right Click on Chart -> Copy Image Address"
                            >
                                TradingView
                            </span>
                        </div>
