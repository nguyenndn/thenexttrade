...
export function CardSkeleton({ className }: { className?: string }) {
 return (
 <div className={cn("rounded-xl border border-dashboard dark:border-slate-800 bg-white dark:bg-slate-900 p-4", className)}>
...
export function StatsSkeleton({ className }: { className?: string }) {
 ...
 <div key={i} className="rounded-xl border border-dashboard dark:border-slate-800 bg-white dark:bg-slate-900 p-6">
