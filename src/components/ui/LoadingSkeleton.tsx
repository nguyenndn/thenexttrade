...
export function CardSkeleton({ className }: { className?: string }) {
    return (
        <div
            className={cn(
                "rounded-xl border border-dashboard dark:border-slate-800 bg-white dark:bg-slate-900 p-4",
                className
            )}
        >
...
export function HeroSkeleton({ className }: { className?: string }) {
    return (
        <div
            className={cn(
                "h-[500px] rounded-xl bg-slate-200 dark:bg-slate-800 animate-pulse",
                className
            )}
        >
    ...
    return (
        ...
        >
            {Array.from({ length: 4 }).map((_, i) => (
                <div
                    key={i}
                    className="rounded-xl border border-dashboard dark:border-slate-800 bg-white dark:bg-slate-900 p-6"
                >
...
export function TableSkeleton({ rows = 5 }: { rows?: number }) {
    return (
        <div className="rounded-xl border border-dashboard dark:border-slate-800 bg-white dark:bg-slate-900">
            <div className="p-4 border-b border-dashboard dark:border-slate-800">
...
export function PageSkeleton() {
    return (
        <div className="min-h-screen bg-white dark:bg-slate-900">
            <div className="h-16 border-b border-dashboard dark:border-slate-800 bg-white dark:bg-slate-900 animate-pulse" />
