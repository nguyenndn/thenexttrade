            ...
            {stats.map((stat, i) => (
                ...
                >
                    <div className="flex items-center gap-3">
                        <div
                            className={`w-9 h-9 shrink-0 rounded-xl flex items-center justify-center ${BG_COLORS[stat.color] || "bg-gray-100 dark:bg-gray-800"} ${ICON_COLORS[stat.color] || "text-gray-500"}`}
                        >
