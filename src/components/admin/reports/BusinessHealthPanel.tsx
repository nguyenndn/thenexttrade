  ...
  return (
    <div className="bg-white/50 dark:bg-[#1E2028] border border-gray-200 dark:border-white/10 dark:border-white/5 rounded-xl p-6 backdrop-blur-sm">
      ...
      <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5 mb-6">
        High-level overview of IB conversions, funding rates, and total system assets.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mb-1">IB Referred Users</p>
            ...
            <p className="text-xs text-gray-400 mt-1">vs {data.directSignups.toLocaleString()} direct signups</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mb-1">Funded Traders</p>
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-black text-slate-800 dark:text-white">
            ...
            <p className="text-xs text-gray-400 mt-1">vs {data.unfundedAccounts.toLocaleString()} unfunded</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mb-1">Total System Assets</p>
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-black text-slate-800 dark:text-white">
                {formatCurrency(data.totalSystemAssets)}
              </span>
            </div>
            <p className="text-xs text-gray-400 mt-1">Avg: {formatCurrency(data.averageBalance)} per funded user</p>
          </div>
        </div>
      </div>
    </div>
