                        ...
                        <table className="w-full text-xs">
                            <thead>
                                <tr className="border-b border-gray-200 dark:border-white/10">
                                    <th className="px-3 py-2 text-left font-bold text-gray-400 uppercase">
                                        From
                                    </th>
                                    <th className="px-3 py-2 text-left font-bold text-gray-400 uppercase">
                                        To
                                    </th>
                                    <th className="px-3 py-2 text-right font-bold text-gray-400 uppercase">
                                        Drop
                                    </th>
                                    <th className="px-3 py-2 text-right font-bold text-gray-400 uppercase">
                                        Rate
                            ...
                            <tbody>
                                {data.dropoffs.map((d, i) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-3 py-2 text-right tabular-nums font-bold text-red-500">
                                            {d.dropCount}
                                        </td>
