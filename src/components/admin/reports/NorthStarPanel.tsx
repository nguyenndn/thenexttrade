...
export function NorthStarPanel({ data }: NorthStarPanelProps) {
 ...
 return (
 <section className="relative overflow-hidden rounded-3xl border border-dashboard bg-[linear-gradient(135deg,#ffffff_0%,#fbfffd_52%,#fff8ea_100%)] shadow-[0_18px_50px_rgba(15,23,42,0.07)] dark:bg-[linear-gradient(135deg,#121722_0%,#111827_56%,#17120a_100%)]">
 ...
 <div className="mb-1 border-l border-dashboard pl-5">
 ...
 <div className="mt-7 border-t border-dashboard pt-5">
 ...
 <div className="mt-5 grid min-w-0 grid-cols-1 border-y border-dashboard sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-6">
 ...
 <div
 key={step.key}
 className="group min-w-0 border-b border-dashboard p-4 transition-colors last:border-b-0 hover:bg-white/70 dark:hover:bg-white/[0.03] sm:border-r sm:last:border-r-0 2xl:border-b-0"
 >
