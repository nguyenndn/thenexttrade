                    ...
                    <table className="w-full text-xs">
                        <thead>
                            <tr className="border-b border-gray-200 dark:border-white/10">
                                ...
                                <th className="px-4 py-2 text-center font-bold text-gray-400 uppercase">
                                    Band
                                </th>
    ...
    return (
        <tr className="border-b border-gray-50 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
            <td className="px-4 py-2.5">
                <p className="font-semibold text-gray-700 dark:text-white truncate max-w-[160px]">
                    {user.name || "—"}
                </p>
            ...
            <td className="px-4 py-2.5 text-center">
                <span
                    className={cn(
                        ...
                        bandColors[user.qualityBand]
                    )}
                >
                    {user.qualityBand}
                </span>
            </td>
            <td className="px-4 py-2.5 text-right tabular-nums font-bold text-gray-700 dark:text-white">
                {user.qualityScore}
            </td>
