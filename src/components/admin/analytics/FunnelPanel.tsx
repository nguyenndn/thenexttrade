...
const STAGES = [
    {
        key: "visitors",
        label: "Active Users",
        desc: "Total active sessions",
        color: "#6366f1",
    },
    {
        key: "interested",
        label: "Explored Leaderboard",
        desc: "Viewed Leaderboard",
        color: "#22d3ee",
    },
    {
        key: "signedUp",
        label: "Learned",
        desc: "Completed a lesson/journal",
        color: "#10b981",
    },
    {
        key: "activated",
            ...
            {hasData ? (
                    ...
                    {STAGES.map((stage, i) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div
                                    className="rounded-xl p-4 text-center transition-all hover:scale-[1.01]"
                                    style={{
                ...
                <div className="text-center py-12">
                    ...
                    <p className="text-sm text-gray-400">
                        No funnel data yet. Start tracking events to see
                        conversion rates.
                    </p>
                </div>
            )}
