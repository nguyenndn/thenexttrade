        ...
        <div className="bg-white dark:bg-[#1E2028] rounded-xl border border-gray-200 dark:border-white/10 p-5">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-sm font-bold text-gray-900 dark:text-white">Recent Visitors</h2>
                    {onlineCount > 0 && (
                ...
                <span className="text-xs text-gray-400">Auto-refreshing 15s</span>
            </div>
            ...
            {loading ? (
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                        <thead>
                            <tr className="text-[10px] text-gray-400 uppercase tracking-wider border-b border-gray-100 dark:border-white/5">
                        ...
                        <tbody>
                            {visitors.map((v, i) => (
                                <tr key={`${v.sessionId}-${i}`} className="border-b border-gray-50 dark:border-white/3 last:border-0 hover:bg-gray-50 dark:hover:bg-white/2 transition-colors">
                                    ...
                                    <td className="py-2.5">
                                        <span className="text-xs text-gray-500 font-mono truncate max-w-[180px] block">{v.pathname}</span>
                                    </td>
                                    <td className="py-2.5">
