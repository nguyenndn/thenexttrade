    ...
    return (
        <div className="space-y-4">
            ...
            <div className="bg-white dark:bg-[#1E2028] rounded-xl border border-gray-200 dark:border-white/10 p-5">
                ...
                <div className="flex items-center justify-between text-[10px] text-gray-400 uppercase tracking-wider pb-2 border-b border-gray-100 dark:border-white/5 mb-1">
                    <span>Article</span>
                    <span>Views</span>
                </div>
