        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-white dark:bg-[#1E2028] rounded-xl border border-gray-200 dark:border-white/10 p-5">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <h2 className="text-sm font-bold text-gray-900 dark:text-white">Custom Events</h2>
                </div>
            ...
            <div className="bg-white dark:bg-[#1E2028] rounded-xl border border-gray-200 dark:border-white/10 p-5">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <h2 className="text-sm font-bold text-gray-900 dark:text-white">Live Feed</h2>
                </div>
