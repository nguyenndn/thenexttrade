                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-white/10">
                            {isLoading ? (
                                        ...
                                        <div className="flex flex-col items-center justify-center text-gray-600">
                                            ...
                                            <p className="text-sm mt-1 mb-4">
                                                {searchQuery
                                                    ...
                                                    : "Create your first tag to start classifying content."}
                                            </p>
                                            {!searchQuery && (
                                                <Button
                                                    onClick={handleCreate}
                                ...
                                filteredTags.map((tag: Tag) => (
                                    <tr
                                        key={tag.id}
                                        className={`group hover:bg-gray-50 dark:hover:bg-white/[0.01] transition-colors ${selectedIds.has(tag.id) ? "bg-primary/5" : ""}`}
                                    >
                                        <td className="pl-6 pr-4 py-5">
                                            <Button
                                                ...
                                                className={`w-5 h-5 min-w-0 min-h-0 p-0 flex items-center justify-center text-gray-500 hover:bg-transparent hover:text-gray-600 ${selectedIds.has(tag.id) ? "text-primary" : ""}`}
                                                aria-label="Select"
                                            >
