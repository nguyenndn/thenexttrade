...
export default function CategoryList({ hideHeader }: { hideHeader?: boolean }) {
    ...
    const toggleSelectAll = () => {
        if (
            ...
            setSelectedIds(
                new Set(filteredCategories.map((c: Category) => c.id))
            );
        }
    };
                            ...
                            <tr>
                                <th className="pl-6 pr-4 py-5 w-14">
                                    <Button
                                        ...
                                        className="w-5 h-5 min-w-0 min-h-0 p-0 flex items-center justify-center text-gray-500 hover:text-gray-600 hover:bg-transparent"
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-white/10">
                            {isLoading ? (
                                ...
                                filteredCategories.map((category: Category) => (
                                    <tr
                                        key={category.id}
                                        className={`group hover:bg-gray-50 dark:hover:bg-white/[0.01] transition-colors ${selectedIds.has(category.id) ? "bg-primary/5" : ""}`}
                                    >
                                        <td className="pl-6 pr-4 py-5">
                                            <Button
                                                ...
                                                className={`w-5 h-5 min-w-0 min-h-0 p-0 flex items-center justify-center text-gray-500 hover:bg-transparent hover:text-gray-600 ${selectedIds.has(category.id) ? "text-primary" : ""}`}
                                                aria-label="Select"
                                            >
                                                {selectedIds.has(
                                                    category.id
                                        ...
                                        <td className="px-6 py-5 text-right">
                                            <div className="flex justify-end">
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent
                                                        align="end"
                                                        className="w-40 p-1.5 rounded-xl border-gray-200 dark:border-white/10 shadow-xl bg-white dark:bg-[#151925] z-[100]"
                                                    >
                                                        <DropdownMenuItem
                                                            onClick={() =>
                                                                handleEdit(
                                                            ...
                                                            className="flex items-center gap-2 px-3 py-2 text-sm font-semibold rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-white/10 text-gray-700 dark:text-gray-300 transition-colors outline-none"
                                                        >
                                                            <Edit2
                                                                size={14}
                                                        ...
                                                        <DropdownMenuItem
                                                            ...
                                                            className="flex items-center gap-2 px-3 py-2 text-sm font-semibold rounded-lg cursor-pointer text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors outline-none"
                                                        >
                                                            <Trash2 size={14} />
                                                            <span>Delete</span>
                                                        </DropdownMenuItem>
