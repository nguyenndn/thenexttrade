...
export function EAProductForm({ product }: EAProductFormProps) {
 ...
 <Button
 variant="outline"
 className="w-full justify-between rounded-xl border-dashboard bg-gray-50 dark:bg-[#151925] p-2.5 h-auto text-sm outline-none hover:bg-gray-100 dark:hover:bg-white/5 transition-all text-gray-700 dark:text-white font-medium"
 >
 ...
 rows={4}
 className="w-full rounded-xl border border-dashboard bg-gray-50 dark:bg-[#151925] p-3 text-sm text-gray-700 dark:text-white font-medium outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all placeholder:text-gray-500 dark:placeholder:text-gray-600 min-h-[100px]"
