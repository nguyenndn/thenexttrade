...
export function PendingAccountCard({ license, onApprove, onReject }: PendingAccountCardProps) {
 ...
 return (
 <div className="bg-white dark:bg-[#1E2028] rounded-xl p-6 border border-dashboard shadow-sm hover:shadow-md transition-shadow flex flex-col items-center text-center group h-full relative">
