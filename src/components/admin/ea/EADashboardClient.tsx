...
export function EADashboardClient({
 ...
 <div className="bg-white dark:bg-[#0B0E14] rounded-xl border border-dashboard shadow-sm p-4">
 <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
 {quickActions.map((action) => (
 <Link
 key={action.href}
 href={action.href}
 className="flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors border border-transparent hover:border-dashboard dark:hover:border-white/10 group"
 >
 ...
 <div className="bg-white dark:bg-[#0B0E14] rounded-xl border border-dashboard shadow-sm p-6">
 ...
 className="flex items-center gap-4 py-3 border-b border-dashboard last:border-0"
 >
 {/* Status Icon */}
