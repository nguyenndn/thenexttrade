...
export function RichTextEditor({
 ...
 `}
        >
            {editable && (
                <div
                    className={`flex flex-col border-b border-gray-200 dark:border-white/10 dark:border-gray-800 bg-gray-50/50 dark:bg-[#151925] ${isFullscreen ? "sticky top-0 z-10" : "sticky top-0 z-10"}`}
                >
                    {/* Main Toolbar */}
 ...
 `}
                        ...
                        <div className="flex items-center gap-0.5 pr-2 border-r border-gray-200 dark:border-white/10 mr-1">
                            ...
                            <ToolbarButton
                                ...
                                icon={Zap}
                                title="Shortcuts"
                                className="text-yellow-600 dark:text-yellow-400 hover:bg-yellow-50 dark:hover:bg-yellow-500/10"
                            />
                            <ToolbarButton
                                onClick={() =>
                                    editor
                    ...
                    {editor.isActive("table") && (
                        <div className="flex flex-wrap items-center gap-2 p-2 bg-blue-50 dark:bg-blue-900/10 border-t border-blue-100 dark:border-blue-800 text-xs">
                            <span className="font-bold text-blue-600 dark:text-blue-400 px-2">
                                Table:
                            </span>
                ...
                <div className="border-b border-gray-200 dark:border-white/10 dark:border-gray-800 bg-gray-50 dark:bg-[#0B0E14] p-4 animate-in slide-in-from-top-2 duration-200">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                        {shortcuts.map((s) => (
                            <div
                                key={s.action}
                                className="flex items-center justify-between gap-2 px-2 py-1.5 rounded-lg bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10"
                            >
                                ...
                                <div className="flex items-center gap-0.5">
                                    {s.keys.map((key) => (
                                        <kbd
                                            key={key}
                                            className="px-1.5 py-0.5 text-[10px] font-mono font-bold bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-gray-300 rounded-lg border border-gray-200 dark:border-white/10"
                                        >
                                            {key}
                                        </kbd>
                                    ))}
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex justify-end gap-2">
                            ...
                            <Button variant="primary" onClick={confirmLink}>
                                Apply
                            </Button>
                        </div>
                    </div>
            ...
            {isFullscreen && (
                <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 bg-black/80 text-white text-xs px-4 py-2 rounded-full backdrop-blur-sm pointer-events-none opacity-60">
                    Press{" "}
                    <kbd className="px-1.5 py-0.5 font-mono bg-white/20 rounded-lg mx-1">
                        ESC
                    </kbd>{" "}
                    or click <Minimize size={12} className="inline" /> to exit
                    fullscreen
                </div>
            )}
        </div>
