...
export function ShortcutsMenuModal({
    isOpen,
    onClose,
    onSelect,
}: ShortcutsMenuModalProps) {
                ...
                <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-white/10">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Link
                            ...
                            target="_blank"
                            className="text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 flex items-center gap-1 bg-blue-50 dark:bg-blue-500/10 px-3 py-1.5 rounded-lg transition-colors"
                        >
                            <Plus size={16} /> Manage
                        </Link>
                        <Button
                            ...
                            className="w-auto h-auto p-2 text-gray-500 hover:text-gray-600 hover:bg-gray-100 rounded-xl dark:hover:bg-white/5 transition-colors border-0"
                        >
                            <X size={20} />
                        </Button>
                    </div>
                    ...
                    {isLoading ? (
                            ...
                            {filteredShortcuts.map((shortcut) => (
                                ...
                                >
                                    <div className="flex items-center gap-2 w-full mb-1">
                                        ...
                                        />
                                        <span className="font-semibold text-gray-700 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 truncate w-full transition-colors">
                                            {shortcut.name}
                                        </span>
                                    </div>
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-center p-8 bg-gray-50 dark:bg-white/5 rounded-xl border border-dashed border-gray-200 dark:border-white/10 mt-4">
                            ...
                            <p className="text-sm text-gray-500 mb-4 max-w-sm">
                                Create reusable content snippets to insert
                                instantly into your articles.
                            </p>
                            <Link
                                href="/admin/articles/shortcuts"
                                target="_blank"
