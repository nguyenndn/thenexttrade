            ...
            <DropdownMenu>
                ...
                >
                    <DropdownMenuItem
                        ...
                        className="font-medium cursor-pointer rounded-lg mx-1 my-1"
                    >
                        <ArrowUpRight
                            size={14}
                    ...
                    <DropdownMenuItem
                        ...
                        className="text-red-500 focus:text-red-500 focus:bg-red-50 dark:focus:bg-red-500/10 font-medium cursor-pointer rounded-lg mx-1 my-1"
                    >
