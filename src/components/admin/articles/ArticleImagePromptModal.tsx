...
export function ArticleImagePromptModal({
    prompts,
    onClose,
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-2xl max-h-[85vh] overflow-y-auto rounded-xl bg-white dark:bg-[#1E2028] border border-gray-200 dark:border-white/10 shadow-2xl">
                ...
                <div className="p-6 space-y-4">
                    ...
                    {prompts.inline.map(
                        (
                            item: { prompt: string; suggestedPath: string },
                            i: number
                        ) => (
                            <PromptBlock
                                key={i}
                    ...
                    <p className="text-[11px] text-gray-400 dark:text-gray-500 text-center pt-2">
                        Copy these prompts and paste into ChatGPT, DALL-E, or
                        Midjourney. Save generated images to the suggested
                        paths.
                    </p>
                </div>
            </div>
