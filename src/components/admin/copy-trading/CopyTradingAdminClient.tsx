...
export function CopyTradingAdminClient({
    ...
    return (
        <div className="space-y-4">
                            ...
                            {initialRegistrations.map((reg) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-5 text-sm text-blue-500 font-medium">
                                            {reg.telegramHandle || "—"}
                                        </td>
                                        <td className="px-6 py-5">
                                        ...
                                        <td className="px-6 py-5 text-sm font-bold text-gray-700 dark:text-white">
                                            $
                                            {reg.tradingCapital.toLocaleString()}
                                        </td>
                                        <td className="px-6 py-5">
                                            <span
                                                className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-bold border ${sc.color}`}
                                            >
            ...
            <ConfirmDialog
                ...
                onConfirm={() =>
                    confirmAction && handleAction(confirmAction.id, "reject")
                }
