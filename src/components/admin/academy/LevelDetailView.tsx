...
export function LevelDetailView({ level }: LevelDetailViewProps) {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            toast.success(
                `${deleteTarget.type === "module" ? "Module" : "Lesson"} deleted`
            );
    ...
    const totalDuration = level.modules.reduce(
        (sum, m) =>
            sum +
            m.lessons.reduce((ls, l) => ls + getReadingTime(l.content), 0),
        0
    );
                ...
                {level.modules.length === 0 ? (
                    <div className="text-center py-20 bg-white dark:bg-[#151925] rounded-xl border-2 border-dashed border-gray-200 dark:border-white/10">
                        ...
                        <p className="text-gray-600 text-sm mb-6">
                            Start by creating your first module for this level.
                        </p>
                        <Button
                            onClick={() => setIsCreateModuleOpen(true)}
                            className="gap-2"
                                        ...
                                        <div className="divide-y divide-gray-50">
                                            ...
                                            <div className="px-4 py-2 pl-16">
                                                ...
                                                >
                                                    <Button
                                                        variant="ghost"
                                                        className="text-xs text-primary font-bold h-auto p-1 hover:bg-transparent hover:underline"
                                                    >
                                                        + Add Lesson
                                                    </Button>
                                                </Link>
