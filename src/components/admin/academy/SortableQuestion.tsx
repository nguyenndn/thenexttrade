            ...
            <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-2">
                    <Button
                        ...
                        size="icon"
                        onClick={onEdit}
                        className="text-gray-500 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-500/10 rounded-lg transition-colors"
                    >
                        <Edit size={16} />
                    </Button>
                    <Button
                        ...
                        size="icon"
                        onClick={onDelete}
                        className="text-gray-500 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-lg transition-colors"
                    >
                        <Trash size={16} />
                    </Button>
                </div>
