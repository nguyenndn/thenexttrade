            ...
            >
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-white/5 border-b border-gray-200 dark:border-white/10">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button
                            ...
                            className="p-2 h-auto w-auto text-gray-500 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-lg transition-colors"
                        >
                            <Trash size={16} />
                        </Button>
                    </div>
                ...
                {isExpanded && (
                    <div className="p-4 bg-gray-50/50 dark:bg-[#151925]/50">
                        <div className="space-y-2 min-h-[50px]">{children}</div>

                        <Button
                            variant="outline"
                            onClick={() => onAddLesson(module.id)}
                            className="mt-4 w-full h-auto py-2.5 flex items-center justify-center gap-2 text-sm font-medium text-gray-600 border border-dashed border-gray-300 rounded-xl hover:border-primary hover:text-primary hover:bg-primary/5 transition-all group"
                        >
                            <Plus
                                size={16}
