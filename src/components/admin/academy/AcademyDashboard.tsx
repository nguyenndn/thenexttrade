            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <Popover>
                                    <PopoverTrigger asChild>
                                        <Button
                                            variant="ghost"
                                            size="icon"
                                            className="hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-colors text-gray-500"
                                        >
                ...
                {initialLevels.length === 0 && (
                    ...
                    >
                        ...
                        <span className="font-bold text-gray-600 group-hover:text-primary">
