...
export function CreateLessonModal({ isOpen, onClose, moduleId, onSuccess }: CreateLessonModalProps) {
 ...
 {...register("slug")}
 readOnly
 className="w-full rounded-xl border border-dashboard bg-gray-50 dark:bg-white/5 px-4 py-2.5 text-sm outline-none text-gray-600 dark:text-gray-300 cursor-not-allowed"
 ...
 <div className="grid grid-cols-2 gap-4">
 <div className="space-y-0">
 <label className="block mb-2 text-sm font-bold text-gray-700 dark:text-gray-300">Video URL <span className="font-normal text-gray-500">(Optional)</span></label>
 <input
 {...register("videoUrl")}
 className="w-full rounded-xl border border-dashboard bg-white dark:bg-white/5 px-4 py-2.5 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-600"
 ...
 <div className="space-y-0">
 <label className="block mb-2 text-sm font-bold text-gray-700 dark:text-gray-300">Duration <span className="font-normal text-gray-500">(min)</span></label>
 <input
 type="number"
 {...register("duration")}
 className="w-full rounded-xl border border-dashboard bg-white dark:bg-white/5 px-4 py-2.5 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-600"
 ...
 size="smd"
 isLoading={isLoading}
 className="bg-primary hover:bg-[#00b078] text-white border-none shadow-lg shadow-primary/30 font-bold"
 >
 Create Lesson
 </Button>
 </div>
