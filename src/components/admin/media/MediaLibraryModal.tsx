...
export function MediaLibraryModal({
    ...
    const handleUpdate = async (key: "alt" | "caption", value: string) => {
        ...
        setMediaList((prev) =>
            prev.map((m) => (m.id === selectedMedia.id ? updated : m))
        );
    };
            ...
            <div className="relative z-10 bg-white dark:bg-[#151925] w-full max-w-5xl h-[85vh] rounded-xl shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-200 cursor-default">
                ...
                <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-white/10">
                    ...
                    <Button
                        ...
                        size="icon"
                        onClick={onClose}
                        className="p-2 h-auto w-auto hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-colors"
                    >
                ...
                <div className="flex flex-1 overflow-hidden">
                    ...
                    {activeTab === "library" && selectedMedia && (
                        <div className="w-[300px] bg-gray-50 dark:bg-[#0B0E14] border-l border-gray-200 dark:border-white/10 p-4 overflow-y-auto space-y-6">
                            <div>
                                <h4 className="font-bold text-gray-700 dark:text-white mb-2 text-sm uppercase">
                                    Item Details
                                </h4>
                                ...
                                <div className="text-xs text-gray-600 space-y-1">
                                    <div className="font-bold text-gray-700 dark:text-gray-300 line-clamp-1">
                                        {selectedMedia.filename}
                                    </div>
                                    <div>
                                        {selectedMedia.createdAt.substring(
                                            0,
                                            10
                                        )}
                                    </div>
                                    <div>
                                        {(selectedMedia.size / 1024).toFixed(1)}{" "}
                                        KB
                                    </div>
                                    <a
                                    ...
                                    >
                                        View Full URL <ExternalLink size={10} />
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            handleUpdate("alt", e.target.value)
                                        }
                                    ...
                                    <p className="text-[10px] text-gray-500 mt-1">
                                        Describe these images for better SEO and
                                        accessibility.
                                    </p>
                                </div>
                                <div>
