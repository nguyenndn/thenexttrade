...
import { rejectAccount } from "@/app/admin/trading-systems/accounts/actions";
...
export function RejectLicenseModal({
    isOpen,
    onClose,
    license,
    adminId,
}: RejectLicenseModalProps) {
    ...
    const handleReject = async () => {
        ...
        setIsLoading(true);
        try {
            const res = await rejectAccount(license.id, { reason: finalReason });
            ...
            <DialogContent className="max-w-md bg-white dark:bg-[#1E2028] border-gray-200 dark:border-white/10">
                ...
                <div className="space-y-6 py-4">
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                        You are about to reject the request for account{" "}
