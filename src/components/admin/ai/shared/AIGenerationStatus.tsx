    ...
    return (
        <div className="flex flex-col items-center justify-center h-full text-gray-400 space-y-6 animate-in fade-in duration-500">
            <div className="relative">
                ...
                <div className="w-20 h-20 border-4 border-[#00C888] border-t-transparent rounded-full animate-spin absolute top-0 left-0 shadow-[0_0_15px_rgba(0,200,136,0.3)]" />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <Loader2 className="w-8 h-8 text-[#00C888] animate-pulse" />
                </div>
            </div>
