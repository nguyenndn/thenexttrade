                                ...
                                <div key={idx} className="bg-white dark:bg-[#0F1117] p-4 rounded-lg border border-gray-200 dark:border-gray-800 shadow-sm">
                                    ...
                                    <div className="space-y-2 pl-9">
                                        {q.options.map((opt, optIdx) => (
                                            ...
                                            >
                                                <span className={`w-4 h-4 rounded-full border mr-3 flex items-center justify-center ${opt.isCorrect ? "border-[#00C888] bg-[#00C888]" : "border-gray-300 dark:border-gray-600"
                                                    }`}>
