...
export default function LessonCard({ lesson }: LessonCardProps) {
    return (
        <PremiumCard className="flex flex-col h-full group hover:border-[#00C888]/50 transition-all cursor-pointer">
            <div className="p-6 flex-1">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2 line-clamp-1 group-hover:text-[#00C888] transition-colors">
                    {lesson.title}
                </h3>
            ...
            <div className="p-4 border-t border-gray-100 dark:border-white/5 bg-gray-50 dark:bg-white/[0.02] flex justify-between items-center">
                <Link
                    ...
                    className="text-sm font-semibold text-gray-600 dark:text-gray-300 group-hover:text-[#00C888] transition-colors flex items-center w-full justify-between"
                >
                    Edit Content
                    <FileText size={16} className="text-gray-400 group-hover:text-[#00C888] group-hover:translate-x-1 transition-transform" />
                </Link>
            </div>
        </PremiumCard>
    );
