...
export function PendingActionsWidget({ items }: { items: PendingItem[] }) {
    return (
        <div className="bg-white dark:bg-[#1E2028] border border-gray-100 dark:border-white/5 rounded-xl p-6 h-full flex flex-col shadow-sm hover:shadow-md transition-shadow">
