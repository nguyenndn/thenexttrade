            ...
            <div className="space-y-3 flex-1 overflow-y-auto pr-1">
                {items.length === 0 ? (
                    ...
                    items.map((item) => (
                        <div
                            key={item.id}
                            className="group flex items-start gap-3 p-3 rounded-xl border border-gray-50 bg-gray-50/50 dark:bg-white/[0.02] hover:bg-white dark:hover:bg-white/5 hover:border-amber-200 dark:hover:border-amber-500/30 transition-all cursor-pointer"
                        >
                            <div
                                className={cn(
