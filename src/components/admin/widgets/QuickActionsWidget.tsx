...
export function QuickActionsWidget() {
 ...
 key={idx}
 href={action.href}
 className="flex flex-col items-center gap-2.5 p-5 rounded-xl bg-white dark:bg-[#1E2028] border border-dashboard shadow-sm hover:shadow-md hover:border-primary/30 transition-all group text-center"
 >
