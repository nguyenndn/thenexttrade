...
export function UserCharts({ roleData, activityData, countryData }: UserChartsProps) {
 ...
 <div className="lg:col-span-2 bg-white dark:bg-[#0B0E14] p-6 rounded-xl border border-dashboard shadow-sm">
 ...
 <div className="bg-white dark:bg-[#0B0E14] p-6 rounded-xl border border-dashboard shadow-sm">
 <h3 className="text-lg font-bold mb-6 text-gray-700 dark:text-white">Role Distribution</h3>
 <div className="h-[300px] w-full">
 <UserRoleChart data={roleData} />
 </div>
 </div>
 <div className="lg:col-span-3 bg-white dark:bg-[#0B0E14] p-6 rounded-xl border border-dashboard shadow-sm">
 ...
 <div
 key={country.country}
 className="rounded-xl border border-dashboard bg-gray-50/70 dark:bg-white/[0.03] p-4"
 >
 ...
 <div className="rounded-xl border border-dashed border-dashboard p-8 text-center">
