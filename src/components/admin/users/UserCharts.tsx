  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <div className="bg-white dark:bg-[#1E2028] p-5 rounded-xl border border-gray-200 dark:border-white/10 shadow-sm flex flex-col justify-between">
        <h3 className="text-sm font-bold text-gray-800 dark:text-gray-200 mb-4">User Signups Trend</h3>
      ...
      {/* Role Distribution */}
      <div className="bg-white dark:bg-[#1E2028] p-5 rounded-xl border border-gray-200 dark:border-white/10 shadow-sm flex flex-col justify-between">
        <h3 className="text-sm font-bold text-gray-800 dark:text-gray-200 mb-4">Role Distribution</h3>
        <div className="h-[220px] w-full">
      ...
      <div className="bg-white dark:bg-[#1E2028] p-5 rounded-xl border border-gray-200 dark:border-white/10 shadow-sm flex flex-col justify-between">
        <div className="flex items-center justify-between gap-4 mb-4">
          <div>
            <h3 className="text-sm font-bold text-gray-800 dark:text-gray-200">Users by Country</h3>
            <p className="text-[11px] text-gray-500 mt-0.5">Based on account profile.</p>
          </div>
        ...
        {countryData.length > 0 ? (
                ...
                >
                  <div className="flex items-center justify-between gap-3 mb-1.5">
                    <div className="flex items-center gap-2 min-w-0">
                      <span className="text-sm shrink-0">{getCountryFlag(country.country)}</span>
                    ...
                    <div className="text-right shrink-0 flex items-baseline gap-1">
                      <span className="text-xs font-black text-gray-800 dark:text-white">{country.value}</span>
          ...
          <div className="flex-1 flex flex-col items-center justify-center rounded-xl border border-dashed border-gray-200 dark:border-white/10 p-4 text-center">
            <p className="text-xs font-semibold text-gray-600 dark:text-gray-300">No country data yet</p>
          </div>
        )}
      </div>
    </div>
