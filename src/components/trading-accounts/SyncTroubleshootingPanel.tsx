...
export function SyncTroubleshootingPanel({ method, className = "" }: SyncTroubleshootingPanelProps) {
  ...
  return (
    <div className={`rounded-xl border border-gray-200 dark:border-white/10 overflow-hidden ${className}`}>
      {/* Trigger */}
      <button
        type="button"
      ...
      >
        ...
        <span className="flex-1">Having trouble with {methodLabel}?</span>
