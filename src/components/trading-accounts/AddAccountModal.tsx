            ...
            <div className="relative z-10 bg-white dark:bg-[#1E2028] rounded-xl w-full max-w-lg max-h-[90vh] overflow-y-auto border border-gray-100 dark:border-white/5 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="p-6">
                    ...
                    ${p.disabled
                                            ...
                                            : "border-gray-100 dark:border-white/5 bg-white dark:bg-[#151925] hover:border-primary hover:bg-white dark:hover:bg-[#151925] hover:shadow-md transition-shadow dark:hover:shadow-primary/10 hover:-translate-y-0.5"
                                        }
                  `}
                                >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex gap-3 pt-2">
                                ...
                                <Button
                                    ...
                                    disabled={isCreating}
                                    className="flex-1 h-12 font-bold shadow-lg shadow-primary/20 hover:-translate-y-0.5"
                                >
                                    {isCreating ? (
                                        <>
