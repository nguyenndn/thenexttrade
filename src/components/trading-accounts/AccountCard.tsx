...
const PRO_STATUS_CONFIG: Record<string, { label: string; className: string }> = {
 ...
 NONE: { label: "Free", className: "bg-gray-50 text-gray-500 border-dashboard/80 dark:bg-white/5 dark:text-gray-400 " },
};
...
const ELIGIBILITY_CHIP: Record<string, { label: string; className: string }> = {
 ...
 UNSUPPORTED_BROKER: { label: "Not Supported", className: "bg-gray-50 text-gray-500 border-dashboard/80 dark:bg-white/5 dark:text-gray-400 " },
 MISSING_ACCOUNT_INFO: { label: "Missing Info", className: "bg-gray-50 text-gray-500 border-dashboard/80 dark:bg-white/5 dark:text-gray-400 " },
};
...
export function AccountCard({
 ...
 <DropdownMenuContent align="end" className="w-50 p-1.5 rounded-xl border-dashboard shadow-xl bg-white dark:bg-[#1E2028] z-[100]">
