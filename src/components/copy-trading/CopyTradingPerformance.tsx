...
export function CopyTradingPerformance() {
 ...
 <div key={stat.label} className="flex items-center justify-between py-1 border-b border-dashboard last:border-0">
 ...
 <div ref={calendarRef} className="lg:col-span-3 bg-white dark:bg-[#1A1D27] rounded-xl border border-dashboard dark:border-white/[0.06] p-5">
 <div className="flex items-center justify-between mb-4">
 ...
 <div key={item.label} className="flex items-center justify-between py-1.5 border-b border-dashboard last:border-0">
