...
function AccountPerformanceView({ reg, pvsrData }: { reg: Registration; pvsrData: PVSRAccountDetail | null }) {
 ...
 {/* Trading Calendar */}
 <div ref={calendarRef} className="bg-white dark:bg-[#1E2028] rounded-xl p-6 border border-dashboard shadow-sm">
...
export function CopyTradingMyAccount() {
 ...
 return (
 <div key={reg.id} className="bg-white dark:bg-[#1A1D27] rounded-xl border border-dashboard dark:border-white/[0.06] overflow-hidden">
 {/* Status header bar */}
 <div className={`px-5 py-3 flex items-center gap-2.5 border-b border-dashboard ${sd.color}`}>
