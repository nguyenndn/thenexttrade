...
function ConfirmDialog({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="bg-white dark:bg-[#1E2028] rounded-2xl border border-dashboard shadow-2xl max-w-md w-full p-6">
                <div className="flex items-center gap-3 mb-4">
                    <div
                        className={`p-2.5 rounded-xl ${confirmColor === "red" ? "bg-red-500/10" : "bg-primary/10"}`}
                    >
                        <AlertTriangle
                            size={20}
                            className={
...
function AccountPerformanceView({
    ...
    reg: Registration;
    pvsrData: PVSRAccountDetail | null;
}) {
    ...
    const handleScreenshot = React.useCallback(async () => {
        ...
        try {
            ...
            const currentMonthName = new Date(calYear, calMonth).toLocaleString(
                "en-US",
            ...
            <div className="mt-4 pt-4 border-t border-dashboard">
                <div className="flex flex-col items-center py-10 text-gray-500">
                    ...
                    <p className="text-xs mt-1">
                        Performance data will appear after the first trade
                    </p>
                </div>
            </div>
        );
    ...
    return (
        <div className="space-y-4 mt-4 pt-4 border-t border-dashboard">
            {/* Frozen banner for disconnected */}
            {isFrozen && (
                <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gray-100 dark:bg-white/5 border border-dashboard">
                    <WifiOff size={14} className="text-gray-500" />
                    <p className="text-xs font-bold text-gray-500">
                        Disconnected — showing historical data
                    </p>
                </div>
            )}
            ...
            {acctInfo && (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    <div className="bg-white dark:bg-[#1E2028] border border-dashboard shadow-sm rounded-xl p-3">
                        <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">
                            Balance
                        </span>
                        <p className="text-base font-black text-gray-800 dark:text-white mt-0.5">
                            {formatCurrency(acctInfo.balance)}
                        </p>
                    </div>
                    <div className="bg-white dark:bg-[#1E2028] border border-dashboard shadow-sm rounded-xl p-3">
                        <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">
                        ...
                        <p className="text-base font-black text-gray-800 dark:text-white mt-0.5">
                            {formatCurrency(acctInfo.equity)}
                        </p>
                    </div>
                    <div className="bg-white dark:bg-[#1E2028] border border-dashboard shadow-sm rounded-xl p-3">
                        <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">
                    ...
                    <div className="bg-white dark:bg-[#1E2028] border border-dashboard shadow-sm rounded-xl p-3">
                        ...
                        <p className="text-base font-black text-red-500 mt-0.5">
                            {acctInfo.drawdownPercent.toFixed(2)}%
                        </p>
                    </div>
                </div>
            )}
            ...
            {/* Stats row */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className="bg-white dark:bg-[#1E2028] border border-dashboard shadow-sm hover:shadow-md transition-shadow duration-200 rounded-xl p-4">
                    <span className="text-[11px] font-bold text-gray-500 uppercase tracking-wider">
                        Highest Balance
                    </span>
                    <p className="text-lg font-black text-primary mt-1">
                        {formatCurrency(perf.coreMetrics.highestBalance)}
                    </p>
                </div>
                <div className="bg-white dark:bg-[#1E2028] border border-dashboard shadow-sm hover:shadow-md transition-shadow duration-200 rounded-xl p-4">
                    <span className="text-[11px] font-bold text-gray-500 uppercase tracking-wider">
                    ...
                    <p className="text-lg font-black text-primary mt-1">
                        {formatCurrency(
                            perf.advancedStats.totalNetProfit,
                            true
                        )}
                    </p>
                </div>
                <div className="bg-white dark:bg-[#1E2028] border border-dashboard shadow-sm hover:shadow-md transition-shadow duration-200 rounded-xl p-4">
                    ...
                    <div className="flex items-center gap-1.5 mt-1">
                        ...
                        <p className="text-lg font-black text-primary">
                            +{perf.advancedStats.growthPercent}%
                        </p>
                    </div>
                </div>
                <div className="bg-white dark:bg-[#1E2028] border border-dashboard shadow-sm hover:shadow-md transition-shadow duration-200 rounded-xl p-4">
                    ...
                    <p className="text-lg font-black text-red-500 mt-1">
                        {perf.advancedStats.maxDrawdownPercent.toFixed(2)}%
                    </p>
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-3">
                {/* Win Rate Donut */}
                <div className="bg-white dark:bg-[#1E2028] border border-dashboard shadow-sm hover:shadow-md transition-shadow duration-200 rounded-xl p-6 flex flex-col items-center justify-center">
                    <p className="text-xs font-bold uppercase tracking-wider text-gray-600 dark:text-gray-300 mb-3">
                        Win Rate
                    </p>
                ...
                {/* Key Stats */}
                <div className="bg-white dark:bg-[#1E2028] border border-dashboard shadow-sm hover:shadow-md transition-shadow duration-200 rounded-xl p-5 flex flex-col justify-center">
                    <div className="space-y-3 text-sm">
                        <div className="flex justify-between">
                            <span className="text-gray-500 font-bold text-[11px] uppercase">
                                Wins / Losses
                            </span>
                            <span className="font-black text-gray-700 dark:text-white">
                                {perf.advancedStats.winCount}W /{" "}
                                {perf.advancedStats.lossCount}L
                            </span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-gray-500 font-bold text-[11px] uppercase">
                            ...
                            <span className="font-black text-gray-700 dark:text-white">
                                {perf.advancedStats.totalTrades}
                            </span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-gray-500 font-bold text-[11px] uppercase">
                            ...
                            <span className="font-black text-gray-700 dark:text-white">
                                {perf.advancedStats.profitFactor.toFixed(2)}
                            </span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-gray-500 font-bold text-[11px] uppercase">
                            ...
                            <span className="font-black text-gray-700 dark:text-white">
                                {perf.advancedStats.recoveryFactor.toFixed(1)}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                {/* Best/Worst + Verified */}
                <div className="bg-white dark:bg-[#1E2028] border border-dashboard shadow-sm hover:shadow-md transition-shadow duration-200 rounded-xl p-5 flex flex-col justify-between">
                    <div className="space-y-3 text-sm">
                        <div className="flex justify-between">
                            <span className="text-gray-500 font-bold text-[11px] uppercase">
                                Best Trade
                        ...
                        <div className="flex justify-between">
                            ...
                            <span className="font-black text-red-500">
                                {formatCurrency(perf.advancedStats.worstTrade)}
                            </span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-gray-500 font-bold text-[11px] uppercase">
                            ...
                            <span className="font-black text-gray-700 dark:text-white">
                                {perf.advancedStats.avgHoldTime}
                            </span>
                        </div>
                    </div>
            ...
            {/* Equity Curve */}
            <div className="bg-white dark:bg-[#1E2028] p-6 rounded-xl border border-dashboard shadow-sm hover:shadow-md transition-shadow duration-200">
                <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="font-bold text-gray-700 dark:text-white text-base">
                                Equity Curve
                            </h3>
                    ...
                    <div className="text-right">
                        ...
                        <p
                            className={`text-lg font-black ${perf.advancedStats.totalNetProfit >= 0 ? "text-primary" : "text-red-500"}`}
                        >
                            {formatCurrency(
                                perf.advancedStats.totalNetProfit,
                                true
            ...
            <div
                ref={calendarRef}
                className="bg-white dark:bg-[#1E2028] rounded-xl p-6 border border-dashboard shadow-sm"
            >
 ...
 ${
     hasPnl
         ...
         : "bg-gray-50 dark:bg-white/5 text-gray-500 border-transparent"
                                                ...
                                                >
                                                    <span
                                                        className={`text-[10px] font-bold absolute top-1.5 left-2 ${hasPnl ? "text-gray-700 dark:text-gray-100" : "text-gray-700 dark:text-gray-500"}`}
                                                    >
                                                        {day}
                                                    </span>
                                                    {hasPnl && (
                                        ...
                                        {/* Weekly Summary Cell */}
                                        <div className="min-h-[80px] p-2 rounded-xl flex flex-col items-center justify-center bg-white dark:bg-[#1E2028] border border-dashboard relative shadow-sm hover:shadow-md transition-all">
                                            <span
                                                className={`text-[10px] font-bold absolute top-1.5 left-2 ${weeklyTotal_w >= 0 ? "text-primary" : "text-red-500"}`}
                                            >
                                                W{wi + 1}
                                            </span>
                                            <div className="flex flex-col items-center mt-2.5 w-full">
                                                <span
                                                    className={`w-full text-center px-0.5 text-base sm:text-lg tracking-tighter whitespace-nowrap font-bold leading-none mb-0.5 ${weeklyTotal_w >= 0 ? "text-primary" : "text-red-500"}`}
                                                >
                                                    {formatCurrency(
                                                        weeklyTotal_w,
                                                        true
                ...
                {/* Legend */}
                <div className="flex items-center justify-center gap-6 mt-6 pt-4 border-t border-dashboard">
...
export function CopyTradingMyAccount() {
    ...
    const [pvsrCache, setPvsrCache] = useState<
        Record<string, PVSRAccountDetail | null>
    >({});
        ...
        try {
            ...
            if (res.ok) {
                ...
                const approvedAccounts = (data.registrations || []).filter(
                    (r: Registration) =>
                        r.status === "APPROVED" || r.status === "DISCONNECTED"
                );
                approvedAccounts.forEach((r: Registration) =>
                    fetchPvsrData(r.mt5AccountNumber)
                );
    ...
    const handleExpand = (reg: Registration) => {
        ...
        if (
            isExpanding &&
            (reg.status === "APPROVED" || reg.status === "DISCONNECTED")
        ) {
        ...
        setConfirmDialog({
            ...
            action: async () => {
                const res = await fetch(
                    `/api/copy-trading/account/${reg.mt5AccountNumber}/delete`,
                    { method: "DELETE" }
                );
                if (res.ok) {
    ...
    const disconnectAccount = (reg: Registration) => {
        setConfirmDialog({
            ...
            action: async () => {
                const res = await fetch(
                    `/api/copy-trading/account/${reg.mt5AccountNumber}/disconnect`,
                    { method: "POST" }
                );
                if (res.ok) {
                    setRegistrations((prev) =>
                    ...
                    toast.success(
                        "Account disconnected. You will no longer receive trade signals."
                    );
                } else {
                    const data = await res.json().catch(() => null);
        ...
        setConfirmDialog({
            ...
            action: async () => {
                const res = await fetch("/api/copy-trading/reconnect", {
                    ...
                    body: JSON.stringify({
                        mt5AccountNumber: reg.mt5AccountNumber,
                    }),
                });
                if (res.ok) {
                    setRegistrations((prev) =>
                    ...
                    setExpandedId(null);
                    toast.success(
                        "Reconnection request sent! Awaiting approval."
                    );
                } else {
                    const data = await res.json().catch(() => null);
                    toast.error(
                        data?.error || "Failed to send reconnection request"
                    );
                }
            },
        });
    ...
    if (registrations.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center py-16">
                <div className="w-14 h-14 rounded-2xl bg-gray-100 dark:bg-white/5 flex items-center justify-center mb-4 border border-dashboard dark:border-white/[0.06]">
                    <Copy
                        size={24}
                ...
                <h3 className="text-lg font-bold text-gray-700 dark:text-white mb-1">
                    No Copy Trading Account
                </h3>
                <p className="text-sm text-gray-500 dark:text-gray-500 mb-6 text-center max-w-sm">
                    Connect your MT5 account to start receiving
                    institutional-grade trade signals from PVSR Capital.
                </p>
                <Button
    ...
    return (
        <div className="space-y-4">
            ...
            {registrations.map((reg) => {
                ...
                const broker =
                    reg.brokerName === "Any Broker"
                        ? reg.customBrokerName || "Custom Broker"
                        : reg.brokerName;
                ...
                const capital =
                    pvsrInfo?.accountInfo?.balance ?? reg.tradingCapital;

                return (
                    <div
                        key={reg.id}
                        className="bg-white dark:bg-[#1A1D27] rounded-xl border border-dashboard dark:border-white/[0.06] overflow-hidden"
                    >
                        {/* Status header bar */}
                        <div
                            className={`px-5 py-3 flex items-center gap-2.5 border-b border-dashboard ${sd.color}`}
                        >
                            ...
                            {reg.status === "APPROVED" &&
                                (() => {
                                    const acctStatus =
                                        pvsrInfo?.accountInfo?.accountStatus;
                                    const isOnline = acctStatus === "ONLINE";
                                    const isOffline = acctStatus === "OFFLINE";
                                    return (
                                        <div
                                            className={`relative flex items-center gap-2 px-3.5 py-1.5 rounded-full text-[11px] font-bold uppercase tracking-[0.08em] backdrop-blur-sm shadow-sm ${
                                                isOnline
                        ...
                        <div className="p-4">
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <div className="flex items-start gap-2.5">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-bold text-gray-700 dark:text-white mt-0.5">
                                            {broker}
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-2.5">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-bold text-gray-700 dark:text-white mt-0.5 font-mono">
                                            {reg.mt5AccountNumber}
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-2.5">
                            ...
                            {reg.status === "DISCONNECTED" &&
                                reg.disconnectedAt && (
                                    <div className="mt-3 px-3 py-2 rounded-lg bg-gray-50 dark:bg-white/5 border border-dashboard">
                                        <p className="text-xs text-gray-500">
                                            <span className="font-bold">
                                                Disconnected:
                                            </span>{" "}
                            ...
                            <div className="mt-3 pt-3 border-t border-dashboard flex items-center justify-between">
                                <div className="flex items-center gap-2">
                            ...
                            {hasPerformance &&
                                ...
                                (loadingPvsr[reg.mt5AccountNumber] ? (
                                    <div className="flex items-center justify-center py-12 mt-4 border-t border-dashboard">
                                    ...
                                    <AccountPerformanceView
                                        reg={reg}
                                        pvsrData={
                                            pvsrCache[reg.mt5AccountNumber] ||
                                            null
                                        }
                                    />
                                ))}
            ...
            <button
                onClick={() => setShowRegistration(true)}
                className="w-full py-4 border-2 border-dashed border-dashboard rounded-xl text-sm font-bold text-gray-500 dark:text-gray-400 hover:text-primary hover:border-primary/30 hover:bg-primary/5 transition-all flex items-center justify-center gap-2"
            >
                <Plus size={16} />
                Add Another Account
            </button>
