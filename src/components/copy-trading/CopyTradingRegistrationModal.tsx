...
export function CopyTradingRegistrationModal({ isOpen, onClose }: Props) {
 ...
 const inputClass = "w-full px-4 py-2.5 rounded-xl border border-dashboard dark:border-white/[0.06] bg-gray-50 dark:bg-white/5 text-sm text-gray-700 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary";
 ...
 <Button variant="outline" className="w-full flex justify-between items-center text-sm font-normal bg-gray-50 dark:bg-white/5 border-dashboard dark:border-white/[0.06] px-4 py-2.5 h-auto text-left shadow-none rounded-xl focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all">
