...
export function CopyTradingOverview() {
 ...
 <Button variant="outline" className="font-bold px-5 py-2.5 text-sm rounded-xl flex items-center gap-2 border-gray-300 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/5">
