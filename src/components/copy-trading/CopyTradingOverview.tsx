...
const howItWorks = [
    {
        ...
        title: "Register",
        description:
            "Submit your MT5 account details through our secure portal.",
        active: true,
    },
    {
        step: "02",
        title: "Get Approved",
        description: "Our team reviews and connects your account within 24h.",
    },
    {
        step: "03",
        title: "Start Copying",
        description: "Trades are mirrored in real-time to your MT5 terminal.",
    },
];
...
export function CopyTradingOverview() {
    ...
    return (
        <div className="space-y-5">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-white dark:bg-[#1A1D27] p-6 md:p-8 border border-dashboard dark:border-white/[0.06]">
                {/* Background pattern */}
                <div
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    <div className="flex-1 max-w-lg">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed mb-5 max-w-md">
                            Institutional-grade copy trading with ultra-low
                            latency. Connect your MT5 account and let verified
                        ...
                        <div className="flex gap-3 flex-wrap">
                            ...
                            <a
                                href="https://pvsrcapital.com/performance"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                <Button
                                    variant="outline"
                                    className="font-bold px-5 py-2.5 text-sm rounded-xl flex items-center gap-2 border-gray-300 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/5"
                                >
                    ...
                    <div className="grid grid-cols-2 gap-3 w-full md:w-auto md:min-w-[280px]">
                        {globalStats.map((stat) => (
                            <div
                                key={stat.label}
                                className="bg-white/80 dark:bg-white/[0.04] backdrop-blur-sm rounded-xl border border-dashboard dark:border-white/[0.06] px-3.5 py-3 hover:bg-white dark:hover:bg-white/[0.07] transition-colors shadow-sm dark:shadow-none"
                            >
                                ...
                                <div className="flex items-baseline gap-2">
                                    ...
                                    <span
                                        className={`text-[10px] font-bold ${stat.trendUp ? "text-emerald-400" : "text-red-400"}`}
                                    >
                                        {stat.trend}
                                    </span>
                                </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                {advantages.map((adv) => (
                    <div
                        key={adv.title}
                        className="group bg-white dark:bg-[#1A1D27] rounded-xl border border-dashboard dark:border-white/[0.06] overflow-hidden hover:shadow-md dark:hover:border-white/10 transition-all"
                    >
                        {/* Colored top bar */}
                        ...
                        <div className="p-4">
                            <div className="flex items-center justify-between mb-2.5">
                                <div
                                    className={`p-2 rounded-lg ${adv.iconBg} transition-colors`}
                                >
                                    <adv.icon size={16} />
                                </div>
                                <span
                                    className={`text-lg font-black ${adv.statColor}`}
                                >
                                    {adv.stat}
                                </span>
                            </div>
                            <h3 className="font-bold text-sm text-gray-700 dark:text-white mb-0.5">
                                {adv.title}
                            </h3>
            ...
            <div className="grid md:grid-cols-5 gap-4">
                {/* How It Works — 3 cols */}
                <div className="md:col-span-3 bg-white dark:bg-[#1A1D27] rounded-xl border border-dashboard dark:border-white/[0.06] p-5">
                    ...
                    <div className="space-y-0">
                        {howItWorks.map((step, i) => (
                            ...
                            >
                                ...
                                {/* Content */}
                                <div className="pb-4">
                                    <h4 className="font-bold text-sm text-gray-700 dark:text-white">
                                        {step.title}
                                    </h4>
                ...
                <div className="md:col-span-2 bg-white dark:bg-[#1A1D27] rounded-xl border border-dashboard dark:border-white/[0.06] p-5 flex flex-col">
                    <h3 className="text-sm font-black text-gray-700 dark:text-white uppercase tracking-wider mb-4">
                        Profit Sharing
                    </h3>
                    <div className="space-y-3 flex-1">
                        <div className="rounded-xl border-2 border-primary/30 bg-primary/5 dark:bg-primary/[0.07] p-4">
                            ...
                            <p className="text-xs text-gray-600 dark:text-gray-400">
                                Until total profit equals your initial deposit.
                            </p>
                        </div>
                        <div className="rounded-xl border border-dashboard dark:border-white/[0.06] bg-gray-50 dark:bg-white/[0.02] p-4">
                            <div className="flex items-center justify-between mb-1">
                            ...
                            <p className="text-xs text-gray-600 dark:text-gray-400">
                                After 100% profit milestone reached.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mt-4 pt-3 border-t border-dashboard">
                        ...
                        <p className="text-[10px] text-gray-400 text-center mt-2">
                            Your capital stays in your MT5 account. We never
                            hold your funds.
                        </p>
                    </div>
                </div>
