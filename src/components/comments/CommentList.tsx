...
export function CommentList({ comments, articleId, currentUser, onRefresh }: CommentListProps) {
    if (comments.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center text-center py-14 px-6 border-2 border-dashed border-gray-100 dark:border-white/5 rounded-3xl bg-gray-50/20 dark:bg-[#0b0d14]/20 relative overflow-hidden transition-all duration-300">
                ...
                <div className="relative z-10 flex flex-col items-center">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 max-w-sm leading-relaxed mb-6">
                        Be the first to share your expert insights, strategies, or questions. Connect with other traders!
                    </p>
                </div>
            </div>
        );
    ...
    return (
        <div className="flex gap-4 group/item relative">
            ...
            <div className="flex-shrink-0">
                <div className="w-10 h-10 rounded-full bg-gray-100 dark:bg-[#161822] overflow-hidden relative border border-gray-200/50 dark:border-white/10 ring-2 ring-primary/0 group-hover/item:ring-primary/20 dark:group-hover/item:ring-primary/30 p-0.5 transition-all duration-300 hover:scale-105">
                    {comment.user.image ? (
                        <Image
            ...
            <div className="flex-1">
                ...
                {comment.replies && comment.replies.length > 0 && (
                    <div className="mt-6 ml-2 sm:ml-4 pl-4 sm:pl-6 border-l border-gray-200/60 dark:border-white/5 space-y-6 relative before:absolute before:left-0 before:top-2 before:bottom-6 before:w-[1px] before:bg-gradient-to-b before:from-gray-200/60 dark:before:from-white/5 before:to-transparent">
