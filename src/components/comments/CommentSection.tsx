...
export function CommentSection({ articleId, currentUser: initialUser, initialComments = [] }: CommentSectionProps) {
    ...
    return (
        <section 
            id="comments" 
            className="py-12 px-6 sm:px-10 bg-white/70 dark:bg-[#12141c]/80 backdrop-blur-xl border border-gray-100 dark:border-white/5 rounded-3xl shadow-xl dark:shadow-[0_20px_50px_rgba(0,0,0,0.3)] relative overflow-hidden transition-all duration-300"
        >
            ...
            <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10 pb-6 border-b border-gray-100 dark:border-white/5">
            ...
            <div 
                id="comment-form-box" 
                className="bg-gray-50/50 dark:bg-[#090b10]/40 border border-gray-100 dark:border-white/5 p-6 sm:p-8 rounded-2xl scroll-mt-32 relative z-10 transition-all duration-300 hover:border-gray-200 dark:hover:border-white/10"
            >
                {currentUser ? (
                    <CommentForm
                        articleId={articleId}
                    ...
                    <div className="text-center py-8 px-4 flex flex-col items-center max-w-md mx-auto">
                        <div className="w-12 h-12 rounded-full bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 flex items-center justify-center mb-4 text-gray-400 dark:text-gray-500">
