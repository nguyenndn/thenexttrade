...
export function ReportPreview({ data, onDownload }: ReportPreviewProps) {
    ...
    return (
        <div className="bg-white dark:bg-[#0B0E14] p-6 rounded-xl border border-dashboard shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-gradient-to-br from-primary/10 to-blue-500/10 p-6 rounded-xl mb-8 border border-primary/10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <p
                            className={`text-2xl font-black ${data.summary.netPnL >= 0 ? "text-primary" : "text-red-500"}`}
                        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* By Strategy */}
                <div>
                    <h4 className="font-bold text-gray-700 dark:text-white mb-4 text-sm uppercase tracking-wider text-gray-600">
                        By Strategy
                    </h4>
                        ...
                        {data.byStrategy.slice(0, 5).map((strat: any) => (
                            ...
                            >
                                ...
                                <div className="text-right">
                                    <div
                                        className={`font-bold ${strat.pnl >= 0 ? "text-primary" : "text-red-500"}`}
                                    >
                                        {strat.pnl >= 0 ? "+" : ""}$
                                        {strat.pnl.toFixed(0)}
                                    </div>
                        ...
                        {data.byPair.slice(0, 5).map((pair: any) => (
                            ...
                            >
                                ...
                                <div className="flex items-center gap-4 text-sm">
                                    ...
                                    <span
                                        className={`font-bold ${pair.pnl >= 0 ? "text-primary" : "text-red-500"}`}
                                    >
                                        {pair.pnl >= 0 ? "+" : ""}$
                                        {pair.pnl.toFixed(0)}
                                    </span>
                            ...
                            {data.recentTrades?.length > 0 ? (
                                data.recentTrades
                                    ...
                                    .map((trade: any, i: number) => (
                                        ...
                                        >
                                            <td className="px-4 py-3 text-gray-600 dark:text-gray-500 whitespace-nowrap">
                                                {trade.date}
                                            </td>
                                            <td className="px-4 py-3 font-bold text-gray-700 dark:text-white whitespace-nowrap">
                                                {trade.symbol}
                                            </td>
                                            <td
                                                className={`px-4 py-3 font-bold whitespace-nowrap ${trade.type === "BUY" ? "text-green-500" : "text-red-500"}`}
                                            >
                                                {trade.type}
                                            </td>
 ...
 `}
                                            ...
                                            <td
                                                className={`px-4 py-3 text-right font-bold whitespace-nowrap ${trade.pnl >= 0 ? "text-primary" : "text-red-500"}`}
                                            >
                                                {trade.pnl >= 0 ? "+" : ""}$
                                                {trade.pnl.toFixed(2)}
                                            </td>
