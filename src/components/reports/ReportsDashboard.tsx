...
export function ReportsDashboard() {
    ...
    const [lastGenerateResult, setLastGenerateResult] =
        useState<GenerateReportResult | null>(null);

    const isReviewType =
        selectedType === "weekly-review" || selectedType === "monthly-review";
    const isExportType =
    ...
    const handleDownloadCustomCSV = () => {
        ...
        const rowLines = csvPreview.rows.map((row) =>
        ...
        <div className="space-y-4 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
                ...
                `}
                    ...
                    `}
                            ...
                            <p className="text-[12px] font-medium text-gray-500 dark:text-gray-400 leading-snug text-left w-full line-clamp-2">
                                {report.description}
                            </p>
                        </Button>
                    );
            ...
            {isReviewType && (
                <div className="animate-in fade-in duration-500 space-y-4">
                        ...
                        <div>
                            <p className="text-sm font-bold text-gray-700 dark:text-white">
                                {selectedType === "weekly-review"
                                    ? "Generate Latest Weekly Review"
                                    : "Generate Latest Monthly Review"}
                            </p>
                            <p className="text-xs text-gray-500">
                                Create a new review based on your latest trading
                                data.
                            </p>
                        </div>
                    ...
                    {lastGenerateResult?.code === "NO_TRADES_THIS_WEEK" &&
                        selectedType === "weekly-review" && (
                            <div className="flex items-start gap-3 bg-amber-50 dark:bg-amber-900/15 border border-amber-200 dark:border-amber-500/20 rounded-xl p-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs text-gray-600 dark:text-gray-400 mt-0.5">
                                        Add at least one trade for this week,
                                        then generate your weekly review to find
                                        your strongest setup and biggest leak.
                                    </p>
                        ...
                        <div className="flex items-center gap-3 bg-primary/5 dark:bg-primary/10 border border-primary/20 rounded-xl p-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-gray-600 dark:text-gray-400">
                                    Your weekly review completed a mission.
                                    Claim{" "}
                                    {lastGenerateResult.missionReward.totalEdge}{" "}
                                    Edge when you're ready.
                                </p>
                            </div>
                    ...
                    <div className="bg-white dark:bg-[#1E2028] p-5 md:p-8 rounded-xl border border-dashboard shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div className="flex flex-col xl:flex-row gap-4 items-end">
                            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-5 w-full">
                                <div>
                                    <label className="text-xs font-black uppercase tracking-wider text-gray-600 dark:text-gray-300 mb-2.5 block">
                                        Start Date
                                    </label>
                                    <input
                                        type="date"
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-3 mt-8 pt-6 border-t border-dashboard">
                            <span className="text-[10px] font-black text-gray-600 dark:text-gray-300 uppercase tracking-widest sm:mr-2">
                                Quick Presets:
                            </span>
                        ...
                        (selectedType === "trades" ||
                            ...
                            <div className="bg-white dark:bg-[#1E2028] p-5 md:p-8 rounded-xl border border-dashboard shadow-sm animate-in fade-in duration-500">
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                                    <div>
                                        <h3 className="font-black text-gray-700 dark:text-white text-lg tracking-tight">
                                            CSV Preview
                                        </h3>
                                        <p className="text-sm font-medium text-gray-600 dark:text-gray-300">
                                            Review data and remove unnecessary
                                ...
                                <DraggablePreviewTable
                                    initialData={csvPreview}
