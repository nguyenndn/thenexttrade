...
export function MistakesCell({ entry, onUpdate }: MistakesCellProps) {
 ...
 return (
 <span key={idx} className="px-2 py-1 rounded-full bg-gray-100 dark:bg-white/5 text-gray-600 dark:text-gray-300 text-[10px] font-bold border border-dashboard whitespace-nowrap">
 📝 {mCode}
 </span>
 );
 }
