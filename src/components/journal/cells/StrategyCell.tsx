            ...
            >
                ...
                <div className="flex items-center justify-between px-4 py-3 border-b border-dashboard">
                    ...
                    <Button
                        ...
                        className="w-6 h-6 p-0 text-gray-500 hover:text-gray-600 dark:hover:text-gray-300"
                    >
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            {entry.strategy && (
                                <Button
                                    ...
                                    size="sm"
                                    onClick={handleClear}
                                    className="h-4 px-1 text-[10px] text-red-500 hover:text-red-600 hover:underline bg-transparent"
                                >
                                    Remove
                                </Button>
                            )}
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-2 max-h-[200px] overflow-y-auto">
                            {strategies.length > 0 ? (
                                ...
                                <div className="text-xs text-gray-600 w-full text-center py-2">
                                    No strategies found.
                                </div>
                            )}
                        </div>
