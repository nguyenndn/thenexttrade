...
import {
    ...
    DialogTitle,
    DialogDescription,
} from "@/components/ui/Dialog"; // Assuming we have a base Dialog or use Radix defaults
...
export function ShareTradeModal({
    ...
    const [mode, setMode] = useState<"basic" | "full">(
        (entry.shareMode as "basic" | "full") || "full"
    );
    ...
    useEffect(() => {
        if (
            open &&
            (debouncedDescription !== savedDescRef.current ||
    ...
    const shareUrl =
        typeof window !== "undefined"
            ? `${window.location.origin}/share/${entry.id}`
            : "";
    ...
    return (
        ...
        */}
                <VisuallyHidden>
                    ...
                    <DialogDescription>
                        Share your trade details securely.
                    </DialogDescription>
                </VisuallyHidden>
                ...
                <div className="p-6 space-y-6 max-h-[85vh] overflow-y-auto">
                    ...
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-3">
                            <Button
                                ...
                                className="font-bold text-gray-700 dark:text-gray-300 border-dashboard hover:bg-gray-100 dark:hover:bg-white/5 transition-all flex items-center gap-2"
                            >
                                {isCapturing ? (
                                    <Loader2
                                        size={16}
                    ...
                    {/* Card Preview Area */}
                    <div
                        className="flex justify-center py-4 w-full rounded-xl bg-white dark:bg-[#1E2028]"
                        ref={cardRef}
                    >
                        <TradeShareCard
                            entry={{
                                ...entry,
                                showMoney: profileSettings
                                    ? profileSettings.showMoney
                                    : false,
                            }}
                            variant={mode}
                    ...
                    <div className="bg-white dark:bg-[#1E2028] rounded-xl border border-dashboard overflow-hidden transition-all duration-300 shadow-sm">
                        <Button
                            variant="outline"
                        ...
                        >
                            ...
                            <div
                                className={`transition-transform duration-300 ${descriptionOpen ? "rotate-180" : ""}`}
                            >
                                <ChevronDown
                                    size={16}
                        ...
                        <div
                            className={`grid transition-all duration-300 ease-in-out ${descriptionOpen ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}
                        >
                            <div className="overflow-hidden">
                                <div className="p-4 relative bg-gray-50/50 dark:bg-black/10 border-t border-dashboard">
                                    <textarea
                                        className="w-full p-4 rounded-xl bg-white dark:bg-[#1E2028] border border-dashboard focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none resize-none transition-all shadow-sm font-medium"
                                        rows={3}
