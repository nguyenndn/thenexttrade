 ...
 */}
 ...
 className="h-10 px-4 rounded-xl font-bold text-gray-700 dark:text-gray-300 border-dashboard hover:bg-gray-100 dark:hover:bg-white/5 transition-all flex items-center gap-2"
 >
