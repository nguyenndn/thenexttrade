        ...
        */}
        ...
        <div className="p-6 space-y-6 max-h-[85vh] overflow-y-auto">
              ...
              <div className="overflow-hidden">
                <div className="p-4 relative bg-gray-50/50 dark:bg-black/10 border-t border-dashboard">
                  ...
                  <div className="absolute bottom-6 right-6 pointer-events-none">
                    {isSaving ? (
                      <span className="text-xs text-gray-600 font-medium px-2 py-1 rounded-md bg-white/80 dark:bg-[#1E2028]/90 backdrop-blur-sm shadow-sm flex items-center gap-1 animate-pulse border border-dashboard">Saving...</span>
                    ) : lastSaved ? (
          ...
          <div className="flex items-center justify-between pt-4 border-t border-dashboard">
            ...
            <Button onClick={onClose} size="smd" className="font-bold">
              Done
            </Button>
          </div>
        </div>
