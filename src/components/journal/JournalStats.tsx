...
export default function JournalStats({ stats }: StatsProps) {
 ...
 return (
 <div key={index} className="rounded-xl border border-dashboard bg-white dark:bg-[#151925] p-4 shadow-sm hover:shadow-md transition-all duration-200 cursor-default">
