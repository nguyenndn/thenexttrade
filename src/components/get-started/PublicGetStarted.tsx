...
export function PublicGetStarted() {
  return (
    <div className="relative overflow-hidden bg-[#F7F4EC] text-slate-950 dark:bg-[#090805] dark:text-white">
        ...
        <div className="mx-auto max-w-[1180px]">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              ...
              <Link
                href="/auth/login"
                className="inline-flex min-h-12 items-center justify-center rounded-full border border-gold/15 bg-white px-8 py-3 text-sm font-black text-slate-950 shadow-sm transition hover:border-gold/45 hover:bg-gold/5 dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
              >
            ...
            <div className="rounded-lg border border-gold/10 bg-white p-6 shadow-xl shadow-gold/5 dark:border-white/[0.06] dark:bg-white/[0.03]">
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-3">
                {valueCards.map((card) => {
                  ...
                  return (
                    <div key={card.title} className="rounded-lg border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-white/[0.04]">
