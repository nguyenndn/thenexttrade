...
const launchSteps = [
    {
        ...
        description:
            "Create your secure workspace in seconds, select your username, and keep your profile lightweight.",
        icon: ShieldCheck,
    },
    {
        ...
        description:
            "Deploy our lightweight Expert Advisor on your MT5 terminal to sync execution history in real-time.",
        icon: Download,
    },
    {
        ...
        description:
            "Uncover patterns in your win rate, drawdown, sessions, and behavior without manual calculations.",
        icon: BarChart3,
    },
    {
        label: "Improve daily",
        ...
        description:
            "Turn metrics into habits. Use missions, rule checklists, and bias tracking to eliminate costly errors.",
        icon: NotebookPen,
    },
];
...
const valueCards = [
    {
        ...
        description:
            "Forget tedious Excel sheets. The moment you close a position on MT5, it is instantly analyzed.",
        icon: LineChart,
    },
    {
        title: "Psychology & Bias Logs",
        description:
            "Track your emotions. Detect revenge trading, FOMO, and loss aversion patterns automatically.",
        icon: CircleHelp,
    },
    {
        title: "Edge instead of noise",
        description:
            "We don't just show charts. We help you make one better decision before your next setup.",
        icon: Target,
    },
];
                ...
                <div className="mx-auto max-w-[1180px]">
                    <div className="mx-auto max-w-4xl text-center">
                        ...
                        <p className="mx-auto mt-5 max-w-2xl text-base font-medium leading-8 text-slate-700 dark:text-slate-300 sm:text-lg">
                            Connect your MT5 terminal in 60 seconds. Stop
                            wasting time on manual spreadsheets, and start
                            tracking your real execution edge.
                        </p>
                        ...
                        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
                            <Link
                                ...
                                className={cn(
                                    ...
                                    "w-full rounded-lg bg-gradient-to-r from-gold to-amber-500 hover:from-amber-500 hover:to-amber-600 border-none"
                                )}
                            >
                                Open Free Workspace
                            ...
                            <Link
                                ...
                                className={cn(
                                    ...
                                    "w-full rounded-lg border-dashboard hover:border-gold hover:bg-gold/5 dark:hover:bg-white/10"
                                )}
                            >
                    ...
                    <div className="mt-8 grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 dark:text-slate-300">
                                        You will be guided into the exact next
                                        step.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="mt-6 grid gap-3 sm:grid-cols-3">
                                {valueCards.map((card) => {
                                    ...
                                    return (
                                        <div
                                            key={card.title}
                                            className="rounded-lg border border-dashboard bg-slate-50 p-4 dark:bg-white/[0.04]"
                                        >
                                            <Icon
                                                className="text-gold"
                                                size={20}
                        ...
                        <div className="rounded-lg border border-gold/30 bg-gradient-to-br from-amber-500/[0.06] to-gold/[0.03] dark:from-gold/[0.04] dark:to-transparent dark:bg-[#0E1118] p-6 text-slate-950 dark:text-white shadow-xl shadow-gold/5 dark:shadow-black/20">
                            <div className="text-xs font-black uppercase tracking-[0.18em] text-gold">
                                Recommended path
                            </div>
                            ...
                            <p className="mt-3 text-sm leading-7 text-slate-600 dark:text-amber-50/80">
                                The easiest, safest way to link MetaTrader 5. It
                                runs quietly on your chart or VPS, pushing
                                closed positions to your secure dashboard in
                                real time.
                            </p>
                            <div className="mt-6 space-y-3">
                                {[
                                    "Create secure account",
                                    "Add MT5 account number",
                                    "Generate Sync API key",
                                    "Deploy the EA & sync instantly",
                                ].map((item) => (
                                    <div
                                        key={item}
                                        className="flex items-center gap-3 text-sm font-bold text-slate-800 dark:text-white"
                                    >
                                        <CheckCircle2
                                            size={17}
                                            style={{ color: GOLD }}
