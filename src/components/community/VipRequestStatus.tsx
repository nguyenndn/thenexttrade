                    ...
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="text-xs text-amber-600 dark:text-amber-400 truncate">
                                {request.broker} · {request.accountNumber} ·
                                Submitted{" "}
        ...
        return (
            <div className="rounded-xl border border-emerald-200 dark:border-emerald-500/20 bg-emerald-50 dark:bg-emerald-500/5 p-4 sm:p-5 space-y-4">
                ...
                <div className="text-sm text-emerald-700 dark:text-emerald-300/80 p-3 bg-emerald-100/50 dark:bg-emerald-500/10 rounded-lg space-y-1.5">
                    <p className="font-semibold text-emerald-800 dark:text-emerald-300 mb-2">
                        To get the private invite link:
                    </p>
                    <p className="flex items-start gap-2">
                        <span className="font-medium">1.</span>
                        <span>
                            Take a screenshot of this entire screen showing your
                            approved status.
                        </span>
                    </p>
                    <p className="flex items-start gap-2">
                    ...
                    <p className="flex items-start gap-2">
                        ...
                        <span>
                            <strong>Important:</strong> You must message from
                            the exact Telegram account you originally registered
                            with.
                        </span>
                    </p>
                </div>
