        ...
        return (
            <div className="text-center py-8 space-y-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                    Your VIP request is under review. You will see the result
                    here once processed. For urgent cases, contact{" "}
                    <a
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-center gap-2 text-sm font-medium">
                {(
                    ["broker", "account_status", "details", "review"] as Step[]
                ).map((s, i) => {
                        ...
                        {SUPPORTED_BROKERS.map((broker) => {
                            ...
                            return (
                                <button
                                    ...
                                    className="group flex flex-col items-center gap-3 p-6 rounded-xl border border-dashboard hover:border-primary dark:hover:border-primary/30 bg-white dark:bg-[#151925] hover:shadow-lg transition-all text-center"
                                >
                                    <img
                                        src={info.logo}
                                        alt={info.name}
                ...
                <div className="space-y-4">
                    <div className="text-center mb-2">
                        <p className="text-sm text-gray-800 dark:text-white">
                            Selected Broker:{" "}
                            <span className="font-bold">{brokerInfo.name}</span>
                        </p>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            Do you already have a {brokerInfo.name} account?
                        </p>
                    </div>
                        ...
                        <button
                            ...
                            className={`flex flex-col items-center gap-3 p-5 rounded-xl border-2 transition-all text-center ${
                                accountStatus === "new"
                                    ...
                                    : "border-dashboard hover:border-emerald-300 dark:hover:border-emerald-500/20 bg-white dark:bg-[#151925]"
                            }`}
                        >
                                ...
                                <div className="p-3 rounded-lg bg-white dark:bg-[#151925] border border-blue-100 space-y-1.5">
                                    ...
                                    <div className="text-xs space-y-0.5">
                                        <p className="text-gray-700 dark:text-gray-300">
                                            <strong>To:</strong>{" "}
                                            <a
                                                href={`mailto:${brokerInfo.ibTransferGuide.emails.to}`}
                                        ...
                                        {brokerInfo.ibTransferGuide.emails
                                            ...
                                            <p className="text-gray-700 dark:text-gray-300">
                                                <strong>CC:</strong>{" "}
                                                <a
                                                    href={`mailto:${brokerInfo.ibTransferGuide.emails.cc}`}
                                                    className="text-blue-600 dark:text-blue-400 hover:underline"
                                                >
                                                    {
                                                        brokerInfo
                    ...
                    <div className="p-4 rounded-xl bg-primary/5 border border-primary/15 space-y-3">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                            {[
                                {
                                    label: "Account",
                                    value: brokerInfo.accountType,
                                },
                                {
                                    label: "Leverage",
                                    value: brokerInfo.leverage,
                                },
                                { label: "Currency", value: "USD" },
                                {
                                    label: "Min. Deposit",
                                    value: `$${brokerInfo.minDeposit}`,
                                },
                            ].map((item) => (
                                <div
                                    key={item.label}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2.5 text-sm rounded-xl border border-dashboard bg-white dark:bg-[#151925] text-gray-800 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
                            />
                        </div>
                        <div className="space-y-1.5">
                            <label className="text-xs font-medium text-gray-700 dark:text-gray-300">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                value={userEmail}
                                disabled
                                className="w-full px-3 py-2.5 text-sm rounded-xl border border-dashboard bg-gray-50 dark:bg-[#0F1117] text-gray-500 dark:text-gray-400 cursor-not-allowed"
                            />
                        </div>
            ...
            {step === "review" && brokerInfo && selectedBroker && (
                <div className="space-y-4">
                    <div className="rounded-xl border border-dashboard bg-white dark:bg-[#151925] p-4 space-y-4">
                        <p className="text-sm text-gray-800 dark:text-white">
                            Broker Selected:{" "}
                            <span className="font-bold">{brokerInfo.name}</span>
                        </p>
                    ...
                    {showConfirm && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                            <div className="w-full max-w-sm bg-white dark:bg-[#1A1D27] rounded-2xl border border-dashboard p-6 shadow-2xl space-y-4">
                                ...
                                <div className="flex items-center justify-end gap-2 pt-2">
                                    <button
                                        ...
                                        className="inline-flex items-center gap-1.5 px-4 py-2.5 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors rounded-xl border border-dashboard"
                                    >
                                        <ArrowLeft size={14} /> Back
                                    </button>
                                    <button
