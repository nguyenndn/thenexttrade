...
function MetricHelpContent({
    ...
    return (
        <div className="space-y-2.5">
            ...
            {def.goodToKnow && (
                <p className="text-[10px] italic text-gray-400 dark:text-gray-500 leading-snug border-t border-dashboard pt-2">
                    {def.goodToKnow}
                </p>
            )}
        </div>
            ...
            <div className="inline-flex md:hidden">
                <Popover open={popoverOpen} onOpenChange={setPopoverOpen}>
                    ...
                    <PopoverContent
                        side={side}
                        align="center"
                        className="w-72 bg-white dark:bg-[#1E2028] border border-dashboard rounded-xl shadow-xl p-3.5 text-gray-700 dark:text-gray-200"
                    >
                        <MetricHelpContent
                            metricId={metricId}
                            compact={compact}
