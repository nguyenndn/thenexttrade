...
export function NotificationBell() {
 ...
 <PopoverContent className="w-[calc(100vw-2rem)] sm:w-80 p-0 rounded-xl bg-white dark:bg-[#1E2028] border-dashboard shadow-xl" align="end" sideOffset={8}>
 ...
 key={n.id}
 className={cn(
 "p-4 border-b border-dashboard hover:bg-gray-50 dark:hover:bg-white/5 transition cursor-pointer",
