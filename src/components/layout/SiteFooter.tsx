...
export function SiteFooter() {
  return (
    <footer id="site-footer" role="contentinfo" className="relative bg-slate-50 dark:bg-transparent text-gray-700 dark:text-white border-t border-dashboard dark:border-transparent overflow-hidden transition-colors duration-300">
      {/* Background Effects */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-12">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between">
            ...
            <div className="flex flex-col gap-4">
              ...
              <a href="mailto:support@thenexttrade.com" className="text-base font-semibold text-gray-600 hover:text-primary transition-colors flex items-center gap-2">
          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-0 sm:gap-8 lg:pl-12">
            ...
            <div className="w-full">
              ...
              <details className="sm:hidden group border-b border-dashboard">
                ...
                <ul className="space-y-3 px-2 pb-4">
                  <li><Link href="/academy" className="text-sm font-semibold text-gray-600 hover:text-primary transition-colors">Trading Academy</Link></li>
                  <li><Link href="/knowledge" className="text-sm font-semibold text-gray-600 hover:text-primary transition-colors">Knowledge Base</Link></li>
                  <li><Link href="/knowledge?category=market-analysis" className="text-sm font-semibold text-gray-600 hover:text-primary transition-colors">Market Analysis</Link></li>
                  <li><Link href="/knowledge?category=technical-analysis" className="text-sm font-semibold text-gray-600 hover:text-primary transition-colors">Technical Analysis</Link></li>
                  <li><Link href="/knowledge?category=trading-psychology" className="text-sm font-semibold text-gray-600 hover:text-primary transition-colors">Trading Psychology</Link></li>
                </ul>
              </details>
              {/* Desktop View */}
            ...
            <div className="w-full">
              ...
              <details className="sm:hidden group border-b border-dashboard">
                ...
                <ul className="space-y-3 px-2 pb-4">
                  <li><Link href="/tools/economic-calendar" className="text-sm font-semibold text-gray-600 hover:text-primary transition-colors">Economic Calendar</Link></li>
                  <li><Link href="/tools/market-hours" className="text-sm font-semibold text-gray-600 hover:text-primary transition-colors">Market Hours</Link></li>
                  <li><Link href="/tools/position-size-calculator" className="text-sm font-semibold text-gray-600 hover:text-primary transition-colors">Position Size Calculator</Link></li>
                </ul>
              </details>
              {/* Desktop View */}
              <div className="hidden sm:block">
            ...
            <div className="w-full">
              ...
              <details className="sm:hidden group border-b border-dashboard">
                ...
                <ul className="space-y-3 px-2 pb-4">
                  ...
                  <li><Link href="/about" className="text-sm font-semibold text-gray-600 hover:text-primary transition-colors">About Us</Link></li>
                  <li><Link href="/contact" className="text-sm font-semibold text-gray-600 hover:text-primary transition-colors">Contact Us</Link></li>
                </ul>
              </details>
              {/* Desktop View */}
              <div className="hidden sm:block">
        ...
        <div className="flex gap-4 p-5 rounded-2xl border border-amber-500/10 dark:border-amber-500/5 bg-amber-500/[0.02] dark:bg-amber-500/[0.01] text-left my-6">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[11px] sm:text-xs leading-relaxed font-semibold text-gray-500 dark:text-gray-400">
              ...
              <span className="text-amber-600 dark:text-amber-500 font-bold">high level of risk</span>{" "}
              and may not be suitable for all investors. You may lose more than your initial investment. Only trade with money you can afford to lose. Past performance is not indicative of future results. Please ensure you fully understand the risks involved and seek independent advice if necessary.
            </p>
          </div>
        </div>
