...
export function SiteFooter() {
 return (
 <footer id="site-footer" role="contentinfo" className="relative bg-slate-50 dark:bg-[#0d1117] text-gray-700 dark:text-white border-t border-dashboard dark:border-transparent overflow-hidden transition-colors duration-300">
 {/* Background Effects */}
