...
export function MobileNavigation({ isOpen, onClose, user }: MobileNavigationProps) {
 ...
 <div className={`max-w-7xl mx-auto rounded-xl border shadow-lg ${isDark ? 'bg-slate-900/95 border-slate-700' : 'bg-white border-dashboard'}`}>
 ...
 <div className={`border-t ${isDark ? 'border-slate-700' : 'border-dashboard'}`}>
 {user ? (
