...
export function CertificateCard({
    ...
    const captureAndDownload = async () => {
        ...
        const el = templateRef.current.querySelector(
        ...
        try {
            ...
            link.download = isMaster
                ? `TheNextTrade-Master-Certificate.png`
                : `TheNextTrade-Certificate-Level${levelOrder}.png`;
            link.href = dataUrl;
        ...
        return (
            <div className="relative bg-white dark:bg-[#151925] rounded-xl border border-dashboard shadow-sm p-6 opacity-70">
                ...
                <div className="mb-4">
                    ...
                    <h3 className="text-lg font-bold text-gray-600 dark:text-gray-400 mt-1">
                        {levelTitle}
                    </h3>
                    {levelDescription && (
        ...
        <>
            <div
                ...
                style={{
                    ...
                    transition:
                        "transform 0.4s cubic-bezier(0.16, 1, 0.3, 1), shadow 0.4s cubic-bezier(0.16, 1, 0.3, 1)",
                }}
                ...
                <div className="relative z-10 p-6 text-white">
                    ...
                    <div
                        className={cn(
                            ...
                            isMaster
                                ? "w-12 h-12 bg-white/20 shadow-lg shadow-white/10"
                                : "w-10 h-10 bg-yellow-400/90 shadow-md shadow-yellow-500/30"
                        )}
                    >
                        {isMaster ? (
            ...
            {showPreview && (
                ...
                >
                    ...
                    >
                        {/* Modal header */}
                        <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-3 bg-gray-100 backdrop-blur-sm border-b border-dashboard">
                            <h3 className="text-gray-800 font-bold text-sm">
                                {isMaster
                                    ? "Master Trader Certificate Preview"
                                    : `Certificate Preview — Level ${levelOrder}`}
                            </h3>
