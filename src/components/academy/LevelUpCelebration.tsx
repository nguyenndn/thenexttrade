...
export function LevelUpCelebration({ isActive, levelOrder, levelTitle, autoDismiss = true, onComplete }: LevelUpCelebrationProps) {
 ...
 <LevelIcon size={40} className="text-white relative z-10 drop-shadow-md" />
 </div>
 </motion.div>
 ...
 >
 <Sparkles size={12} className="text-amber-600 dark:text-amber-400 fill-current animate-pulse" />
 <span className="text-[10px] font-black uppercase tracking-[0.25em] text-amber-700 dark:text-amber-400">Level Up!</span>
 <Sparkles size={12} className="text-amber-600 dark:text-amber-400 fill-current animate-pulse" />
 </motion.div>
 ...
 <span className="text-xs font-black text-amber-700 dark:text-amber-400 tracking-wide uppercase">{theme.cta}</span>
 </div>
 </div>
