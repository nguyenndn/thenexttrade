...
const PHASES = [
    ...
    },
    {
        ...
        subtitle: "Patterns & Strategy Lab (Lvl 6 & 8)",
    ...
    return (
        <div className="relative min-h-[600px] w-full py-20 px-4 overflow-hidden bg-slate-50 dark:bg-[#0B0E14] transition-colors duration-300">
            ...
            <div className="absolute inset-0 opacity-0 dark:opacity-60 z-0 pointer-events-none transition-opacity duration-300">
                ...
                <div
                    className="absolute bottom-[10%] right-[10%] w-[400px] h-[400px] bg-green-500/20 rounded-full blur-[120px] animate-pulse-slow"
            ...
            <div className="max-w-4xl mx-auto relative z-10 space-y-24">
                {PHASES.map((phase, index) => {
                    ...
                    const levelModuleStatuses =
                        levelData?.modules.map((m) => {
                            const totalLessons = m.lessons.length;
                            const completedLessons = m.lessons.filter((l) =>
                            ...
                            const quizPassed =
                                m.quiz?.attempts?.[0]?.passed ?? false;
                            const hasStarted = completedLessons > 0;

                            if (allLessonsDone && (!m.quiz || quizPassed))
                                return "complete" as const;
                            if (allLessonsDone && m.quiz && !quizPassed)
                                return "awaiting-quiz" as const;
                            if (hasStarted) return "in-progress" as const;
                            return "not-started" as const;
                        }) ?? [];

                    const levelComplete =
                        levelModuleStatuses.length > 0 &&
                        levelModuleStatuses.every((s) => s === "complete");
                    const levelActive =
                        !levelComplete &&
                        levelModuleStatuses.some((s) => s !== "not-started");
                    ...
                    return (
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className={cn(
                                    "w-full md:w-1/2 flex flex-col gap-4 order-2 md:order-none",
                                    index % 2 === 0
                            ...
                            >
                                <div>
                                    <h3
                                        className={cn(
                                            "text-2xl font-black uppercase tracking-wider bg-clip-text text-transparent bg-gradient-to-r",
                                            phase.color,
                                            isLocked &&
                                ...
                                >
                                    {levelData?.description ||
                                        "Advanced content for verified traders."}
                                </div>
                            </motion.div>
                            ...
                            <div className="relative z-20 flex-shrink-0 order-1 md:order-none">
                                <div
                                    className={cn(
                                        ...
                                        isLocked
                                            ? "bg-gray-100 border-dashboard text-gray-500 dark:bg-gray-900 dark:text-gray-600 grayscale"
                                            : levelComplete
                                              ...
                                              : levelActive
                                                ...
                                                : `bg-white dark:bg-gray-900 border-dashboard text-gray-700 dark:text-white`
                                    )}
                                >
                                    {/* Glow Effect */}
                                    {!isLocked && (
                            ...
                            <div
                                className={cn(
                                    ...
                                    index % 2 === 0
                                        ? "pl-0 md:pl-8 md:text-left"
                                        : "pr-0 md:pr-8 md:text-right",
                            ...
                            >
                                {levelData && levelData.modules.length > 0 ? (
                                            ...
                                            (module, mIdx) => {
                                                ...
                                                return (
                                                    <Link
                                                        ...
                                                        href={
                                                            module.lessons[0]
                                                                ? `${basePath}/lessons/${module.lessons[0].slug}`
                                                                : "#"
                                                        }
                                                        className={cn(
                                                            "block group w-full max-w-[90%] sm:max-w-sm",
                                                            !module
                                                                .lessons[0] &&
                                                    ...
                                                    >
                                                                ...
                                                                isComplete
                                                                    ...
                                                                    : isAwaitingQuiz
                                                                      ...
                                                                      : isInProgress
                                                                        ...
                                                                        : "bg-white dark:bg-white/5 border-dashboard hover:border-primary dark:hover:border-white/20",
                                                                index % 2 !==
                                                                    0 &&
                                                                    "md:flex-row-reverse"
                                                            )}
                                                        >
                                                            ...
                                                            {isComplete ? (
                                                                ...
                                                                <span
                                                                    className={cn(
                                                                        "text-[10px] font-bold text-cyan-600 dark:text-cyan-400 ml-auto whitespace-nowrap",
                                                                        index %
                                                                            2 !==
                                                                            0 &&
                                                                            "mr-auto ml-0"
                                                                ...
                                                                <ChevronRight
                                                                    size={14}
                                                                    className={cn(
                                                                        "text-gray-500 group-hover:text-primary dark:group-hover:text-white transition-colors ml-auto",
                                                                        index %
                                                                            2 !==
                                                                            0 &&
                                                                            "rotate-180 mr-auto ml-0"
                                                                    )}
                                                                />
                                                            )}
                                                        </div>
                                    ...
                                    <div className="text-xs font-mono text-gray-500 dark:text-gray-600 border border-dashboard rounded-lg p-3 inline-block">
                                        RESTRICTED AREA
                                    </div>
                                )}
                            </div>
