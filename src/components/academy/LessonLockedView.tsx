            ...
            <main className="pt-28 pb-20">
                <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm mb-10 max-w-md mx-auto">
                        This lesson is part of our premium curriculum. Create a
                        free account to unlock all levels and track your
                        progress.
                    </p>
                    ...
                    {/* What you get */}
                    <div className="mt-16 bg-gray-50 dark:bg-white/5 rounded-2xl border border-dashboard p-6 text-left">
