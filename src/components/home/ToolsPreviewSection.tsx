            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <Link
                        ...
                        className="group relative flex items-center p-6 bg-gradient-to-br from-white to-purple-50/50 dark:from-[#1E2028] dark:to-[#1E2028] rounded-2xl border border-gray-200 dark:border-white/10 hover:border-purple-200 dark:hover:border-purple-500/30 hover:shadow-lg transition-all duration-300"
                    >
                        {/* Icon Box */}
                    ...
                    <Link
                        ...
                        className="group relative flex items-center p-6 bg-gradient-to-br from-white to-pink-50/50 dark:from-[#1E2028] dark:to-[#1E2028] rounded-2xl border border-gray-200 dark:border-white/10 hover:border-pink-200 dark:hover:border-pink-500/30 hover:shadow-lg transition-all duration-300"
                    >
                        {/* Icon Box */}
