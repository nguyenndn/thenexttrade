    ...
    return (
        <div className="rounded-xl bg-slate-50 dark:bg-white/[0.04] p-3.5 border border-slate-200/70 dark:border-white/[0.05] text-xs space-y-1.5">
            <div className="flex items-center justify-between text-[11px] font-bold">
                ...
                <span className="text-purple-600 dark:text-purple-400 font-bold text-[10px] bg-purple-500/10 px-2 py-0.5 rounded">
                    10+ Leaks Caught
                </span>
            </div>
            <p className="text-[11px] text-gray-500 dark:text-gray-400">
    ...
    return (
        <div className="rounded-xl bg-slate-50 dark:bg-white/[0.04] p-3.5 border border-slate-200/70 dark:border-white/[0.05] text-xs space-y-1.5">
            <div className="flex items-center justify-between text-[11px] font-bold">
                ...
                <span className="text-blue-600 dark:text-blue-400 font-bold text-[10px] bg-blue-500/10 px-2 py-0.5 rounded">
                    8/10 On Track
                </span>
            </div>
            <p className="text-[11px] text-gray-500 dark:text-gray-400">
