                    ...
                    {unlocked && (
                        <>
                            <motion.div
                                ...
                                style={{
                                    boxShadow: `0 0 20px 8px ${item.glowColor}`,
                                }}
                            ...
                            <motion.div
                                className="absolute inset-0 rounded-full"
                                style={{
                                    boxShadow: `0 0 30px 12px ${item.glowColor}`,
                                }}
                                initial={{ opacity: 0, scale: 0.5 }}
                                animate={{
                                    opacity: [0, 0.5, 0],
                            ...
                            <motion.div
                                ...
                                style={{
                                    boxShadow: `0 0 15px 4px ${item.glowColor}`,
                                }}
                                animate={{
                                    opacity: [0.2, 0.5, 0.2],
                                    scale: [1, 1.15, 1],
            ...
            >
                ...
                >
                    <div className="flex items-center gap-3 mb-4">
                        <span
                            className={`text-xs font-black uppercase tracking-widest bg-gradient-to-r ${item.accentColor} bg-clip-text text-transparent`}
                        >
                            Phase {item.phase}
                        </span>
        ...
        <section className="px-4 mb-24 max-w-5xl mx-auto">
            ...
            >
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300">
                    Four phases that shaped everything
                </p>
            </motion.div>
            ...
            <div ref={containerRef} className="relative">
                ...
                <motion.div
                    ...
                    style={{
                        ...
                        height: "100%",
                        background:
                            "linear-gradient(to bottom, #ef4444, #f59e0b, #3b82f6, #00c878)",
                    }}
                />
                ...
                <motion.div
                    ...
                    style={{
                        ...
                        boxShadow:
                            "0 0 12px 4px rgba(0, 200, 120, 0.8), 0 0 30px 10px rgba(0, 200, 120, 0.4)",
                    }}
                />
