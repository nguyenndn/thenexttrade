    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between z-10 font-mono text-[9px] font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest">
                ...
                <span className="text-amber-600/80 dark:text-amber-400">RISK MODEL: 1%</span>
            </div>
            ...
            {/* Lower grid metrics */}
            <div className="grid grid-cols-4 gap-1.5 z-10 border-t border-slate-100 dark:border-white/10 pt-3">
                {/* Risk */}
                <div className="bg-[#faf6f0] dark:bg-white/[0.04] border border-amber-200/40 dark:border-white/10 rounded-lg p-1.5 text-center flex flex-col justify-between transition-colors">
                    <span className="text-[7px] font-black text-slate-400 dark:text-slate-400 uppercase tracking-wider">
                        Risk $
                    </span>
                ...
                {/* Max DD */}
                <div className="bg-[#faf6f0] dark:bg-white/[0.04] border border-amber-200/40 dark:border-white/10 rounded-lg p-1.5 text-center flex flex-col justify-between">
                    <span className="text-[7px] font-black text-slate-400 dark:text-slate-400 uppercase tracking-wider">
                        Max DD
                    </span>
                    <span className="text-[10px] font-bold text-slate-700 dark:text-slate-200 font-mono mt-0.5">
