  ...
  return (
    <div className="h-44 w-full bg-slate-50 dark:bg-slate-50 rounded-xl p-4 flex flex-col justify-between relative overflow-hidden border border-slate-200/80 select-none">
      ...
      <div className="flex items-center justify-between z-10">
        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest font-mono">Sessions Timeline</span>
        <div className="flex items-center gap-1 bg-cyan-50 border border-cyan-200 px-2 py-0.5 rounded-full">
          <span className="w-1.5 h-1.5 rounded-full bg-cyan-500 animate-pulse" />
          <span className="text-[9px] text-cyan-600 font-extrabold uppercase tracking-wider">LIVE SESSIONS</span>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center gap-2.5 relative my-2 z-10">
        ...
        <div className="relative h-2 w-full bg-slate-200/60 rounded-full overflow-hidden">
          ...
          />
          <span className="absolute left-2.5 top-0 text-[7px] font-black text-white uppercase tracking-wider leading-none pt-0.5">SYD</span>
        </div>
        ...
        <div className="relative h-2 w-full bg-slate-200/60 rounded-full overflow-hidden">
          ...
          />
          <span className="absolute left-2.5 top-0 text-[7px] font-black text-white uppercase tracking-wider leading-none pt-0.5">TKY</span>
        </div>
        ...
        <div className="relative h-2 w-full bg-slate-200/60 rounded-full overflow-hidden">
          ...
          />
          <span className="absolute left-1/3 ml-2.5 top-0 text-[7px] font-black text-white uppercase tracking-wider leading-none pt-0.5">LDN</span>
        </div>
        ...
        <div className="relative h-2 w-full bg-slate-200/60 rounded-full overflow-hidden">
          ...
          />
          <span className="absolute left-[54.1%] ml-2.5 top-0 text-[7px] font-black text-white uppercase tracking-wider leading-none pt-0.5">NY</span>
        </div>
        ...
        {mounted && (
          ...
          >
            ...
            <span className="absolute top-[-10px] text-[7px] font-black text-red-500 bg-white px-1.5 rounded border border-red-200 shadow-sm leading-none py-0.5 select-none whitespace-nowrap">NOW</span>
          </div>
        )}
      </div>
