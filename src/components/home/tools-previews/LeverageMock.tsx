    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between z-10 font-mono text-[9px] font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest">
                ...
                <span className="text-blue-600/80 dark:text-blue-400">RISK METRIC</span>
            </div>
            ...
            <div className="flex-1 flex flex-col justify-center items-center z-10 py-1">
                ...
                <span className="text-2xl font-black text-blue-700 dark:text-blue-400 tracking-tight font-mono">
                    1:10
                </span>

                {/* Visual Slider Mock */}
                <div className="w-28 h-1 bg-slate-200 dark:bg-white/10 rounded-full relative mt-2 overflow-visible">
                    <div
            ...
            {/* Detail grid */}
            <div className="grid grid-cols-3 gap-1.5 z-10 border-t border-slate-100 dark:border-white/10 pt-3">
                {/* Margin Used */}
                <div className="bg-[#edf4fc] dark:bg-white/[0.04] border border-blue-200/40 dark:border-white/10 rounded-lg p-1.5 text-center flex flex-col justify-between">
                ...
                <div className="bg-[#edf4fc] dark:bg-white/[0.04] border border-blue-200/40 dark:border-white/10 rounded-lg p-1.5 text-center flex flex-col justify-between">
                    ...
                    <span className="text-[10px] font-bold text-blue-600 dark:text-blue-400 font-mono mt-0.5">
                        10% ACCT
                    </span>
                </div>
            </div>
