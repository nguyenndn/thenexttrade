  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-center items-center z-10 py-1">
        <span className="text-[8px] font-black text-slate-500 uppercase tracking-wider mb-0.5">Effective Leverage</span>
      ...
      <div className="grid grid-cols-3 gap-1.5 z-10 border-t border-slate-100 pt-3">
        ...
        <div className="bg-[#edf4fc] border border-blue-200/40 rounded-lg p-1.5 text-center flex flex-col justify-between">
          <span className="text-[7px] font-black text-slate-500 uppercase tracking-wider">Margin Used</span>
          <span className="text-[10px] font-bold text-slate-700 font-mono mt-0.5">10.00%</span>
        </div>
        {/* Multiplier */}
        <div className="bg-[#edf4fc] border border-blue-200/40 rounded-lg p-1.5 text-center flex flex-col justify-between">
          <span className="text-[7px] font-black text-slate-500 uppercase tracking-wider">Multiplier</span>
          <span className="text-[10px] font-bold text-slate-700 font-mono mt-0.5">10x</span>
        </div>
        {/* 1% Move */}
        <div className="bg-[#edf4fc] border border-blue-200/40 rounded-lg p-1.5 text-center flex flex-col justify-between">
          <span className="text-[7px] font-black text-slate-500 uppercase tracking-wider">1% Move</span>
          <span className="text-[10px] font-bold text-blue-600 font-mono mt-0.5">10% ACCT</span>
        </div>
      </div>
    </div>
  );
