...
export function FibonacciMock() {
  ...
  const levels = [
    { label: "100%", price: "1.2050", color: "bg-amber-500", textColor: "text-amber-600" },
    { label: "78.6%", price: "1.1925", color: "bg-cyan-500", textColor: "text-cyan-600" },
    { label: "61.8%", price: "1.1834", color: "bg-violet-500", textColor: "text-violet-600" },
    { label: "50%", price: "1.1775", color: "bg-emerald-500", textColor: "text-emerald-600" },
    { label: "38.2%", price: "1.1716", color: "bg-blue-500", textColor: "text-blue-600" },
    { label: "0%", price: "1.1550", color: "bg-slate-400", textColor: "text-slate-500" }
  ];
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-center gap-1.5 z-10 py-1.5 font-mono text-[9px] font-bold">
        {levels.map((lvl) => (
          <div key={lvl.label} className="flex items-center justify-between gap-3">
            <span className={`w-8 text-left ${lvl.textColor} font-black`}>{lvl.label}</span>
