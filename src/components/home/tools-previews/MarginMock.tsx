    ...
    return (
        ...
        >
            ...
            <div className="flex-1 flex flex-col items-center justify-center z-10 py-1">
                ...
                <span
                    className={`text-2xl font-black text-emerald-700 tracking-tight font-mono transition-transform duration-300 ${hovered ? "scale-105" : "scale-100"}`}
                >
                    $1,000
                </span>
            ...
            <div className="grid grid-cols-4 gap-1.5 z-10 border-t border-emerald-100/50 pt-3">
                ...
                <div className="bg-[#ebf5f1] border border-emerald-200/40 rounded-lg p-1.5 text-center flex flex-col justify-between">
                    ...
                    <span className="text-[10px] font-bold text-emerald-600 font-mono mt-0.5">
                        $2,000
                    </span>
                </div>
            </div>
