                ...
                return (
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 p-6 md:p-8 lg:p-12 w-full max-w-4xl">
                            ...
                            >
                                <span
                                    className={`inline-block px-4 py-1.5 mt-2 mb-3 md:mb-4 lg:mb-5 rounded-lg ${catColor.bg} ${catColor.text} text-[10px] md:text-xs font-black uppercase tracking-widest shadow-lg`}
                                >
