...
import { X, Check, FileSpreadsheet, Sparkles, PlugZap, Brain, Target, BookOpenCheck } from "lucide-react";
        ...
        <div className="max-w-5xl mx-auto">
            ...
            {essenceCards.map((card) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-sm font-black text-gray-900 dark:text-white">{card.label}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
            <div className="flex items-center gap-2 p-3 rounded-xl bg-red-50/50 dark:bg-red-500/5 border border-red-100/50 dark:border-red-500/10">
              ...
              <span className="text-xs font-black uppercase tracking-wider text-red-500">Spreadsheet / Manual Review</span>
            </div>
            <div className="flex items-center gap-2 p-3 rounded-xl bg-gold/5 border border-gold/20">
              ...
              <span className="text-xs font-black uppercase tracking-wider text-gold">TheNextTrade Improvement Loop</span>
            </div>
          </div>
