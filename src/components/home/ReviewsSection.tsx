        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-center">
            {visibleReviews.map((review, idx) => {
              ...
              const isSide = visibleCount === 3 && (idx === 0 || idx === 2);
              ...
              if (isMiddle) {
                ...
                cardClasses = "scale-95 opacity-40 dark:opacity-30 blur-[1.5px] pointer-events-none z-10 relative";
              } else {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <Quote size={24} className="text-gold/10 dark:text-gold/5 shrink-0" />
                  </div>
                  ...
                  <div className="flex items-center justify-between border-t border-dashboard/80 dark:border-white/5 pt-3 mt-auto">
                    ...
                    <div className="flex items-center gap-2.5">
                      <div className="relative shrink-0">
                        <div className={`w-9 h-9 rounded-full ${review.color} flex items-center justify-center text-white text-xs font-black`}>
                          {review.initials}
                        </div>
