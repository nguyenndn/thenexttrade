...
import { KeyRound, Wrench, Download, CheckCircle2, ArrowRight } from "lucide-react";
...
const INSTALLATION_STEPS: StepItem[] = [
  {
    step: "01",
    title: "Download File",
    description: "Get the compiled `.ex5` file from your dashboard download tab once verified.",
  },
  {
    step: "02",
    title: "Deploy to MT5",
    description: "Open MT5, go to File > Open Data Folder, navigate to MQL5/Experts, and paste the file.",
  },
  {
    step: "03",
    title: "Allow DLL Imports",
    description: "Drag the EA onto your chart. In the settings window, check 'Allow DLL imports' and 'Allow Algo Trading'.",
  },
  {
    step: "04",
    title: "Load Preset File",
    description: "Apply the recommended `.set` preset file provided in your dashboard to load optimal parameters.",
  },
];
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 shrink-0">
          ...
          >
            <TabsList className="bg-gray-50/75 dark:bg-white/[0.02] border border-gray-200 dark:border-white/5 rounded-xl p-1 gap-1 w-full sm:w-auto">
              {[
                { id: "access", label: "1. Access Path", icon: KeyRound },
                { id: "install", label: "2. Install on MT5", icon: Wrench },
              ].map((tab) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4 relative z-10">
                ...
                <span className="text-2xl font-black text-gold/20">0{item.step}</span>
              </div>
