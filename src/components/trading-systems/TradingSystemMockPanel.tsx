...
export function TradingSystemMockPanel({ slug }: MockPanelProps) {
    ...
    const [activeMockTab, setActiveMockTab] = useState<
        "TRADE" | "S&D ZONE" | "TREND" | "SEMI AUTO" | "SYNC"
    >("TRADE");
    ...
    if (slug === "trade-manager") {
        ...
        return (
            <div className="mx-auto w-full lg:w-[550px] [zoom:0.85] sm:[zoom:1.0] lg:[zoom:1.1] border-2 border-[#f7b500] bg-[#0f1522] p-1.5 text-left font-mono text-[10px] text-slate-200 shadow-2xl shadow-slate-955/20 lg:mx-0">
                {/* Terminal Header */}
                <div className="mb-2 flex items-center justify-between gap-2 bg-[#0b111d] px-2.5 py-1.5 border-b border-slate-800">
                    ...
                    <div className="flex shrink-0 items-center gap-3 text-[10.5px] font-black text-[#ffd21f] sm:text-[11.5px]">
                        ...
                        <div className="flex items-center gap-1">
                            <Clock
                                size={11}
                                className="text-[#ffd21f] shrink-0"
                            />
                    ...
                    {tabs.map((tab) => {
                        ...
                        return (
                            <div
                                ...
                                className={`border px-1 py-2 flex items-center justify-center gap-1.5 text-center text-[9.5px] sm:text-[11.5px] font-black uppercase tracking-wide cursor-pointer select-none transition-all ${
                                    isActive
                    ...
                    {activeMockTab === "TRADE" && (
                        <div className="animate-in fade-in duration-200 w-full flex-1 flex flex-col justify-between">
                            <div className="grid gap-2 md:grid-cols-[1.08fr_1fr_1.14fr]">
                                <div className="flex flex-col justify-between gap-1 h-full">
                                    {[
                                        ...
                                        <div
                                            key={row.label}
                                            className="relative grid grid-cols-[55px_1fr_25px] min-h-7 items-center border border-slate-800 bg-[#0d1420] px-2 pl-3"
                                        >
                                            <span
                                                className={`absolute left-0 top-0 h-full w-1 ${row.bar}`}
                                            />
                                            <span
                                                className={`font-black ${row.text} text-left`}
                                            >
                                                {row.label}
                                            </span>
                                ...
                                <div className="space-y-2 bg-[#0b111d] p-2">
                                    <div className="flex items-center justify-between gap-2">
                                        <span className="whitespace-nowrap font-black text-[#ffd21f]">
                                            Lot Size:
                                        </span>
                                        <span className="border border-slate-800 bg-slate-900 px-1 text-[#ffd21f] select-none hover:bg-slate-850 cursor-pointer">
                                            -
                                        </span>
                                    ...
                                    {[
                                        ...
                                        >
                                            <span className="font-black text-[#ffd21f]">
                                                {label}
                                            </span>
                                            <span
                                ...
                                <div className="grid grid-cols-2 gap-1.5">
                                    {[
                                        ...
                                        },
                                        {
                                            label: "SELL NOW ↓",
                                            className:
                                                "col-span-2 bg-rose-500 hover:bg-rose-600",
                                        },
                                        {
                                            label: "SET PENDING",
                                            className:
                            ...
                            <div className="mt-1 grid grid-cols-4 gap-px bg-[#172333] text-center text-[9.5px]">
                                <div className="py-2 font-black text-emerald-400">
                                    BUY: +$0.00
                                </div>
                                <div className="py-2 font-black text-emerald-400">
                                    SELL: +$0.00
                                </div>
                                <div className="py-2 font-black text-white">
                                    0.00 LOTS
                                </div>
                                <div className="py-2 font-black text-white">
                                    0 POS
                                ...
                                {[
                                    {
                                        ...
                                        isButton: true,
                                        btnStyle:
                                            "bg-slate-750 border-slate-650 text-slate-400",
                                    },
                                    {
                                        label: "Mobile DCA:",
                                        val: "MOBILE DCA: OFF",
                                    ...
                                    >
                                        ...
                                        {row.isButton ? (
                                            ...
                                            <span
                                                className={`font-black text-right pr-1 text-[11.5px] ${row.color}`}
                                            >
                                                {row.val}
                                            </span>
                                        )}
                        ...
                        <div className="grid grid-cols-2 gap-3 divide-x divide-slate-850 animate-in fade-in duration-200">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center justify-between gap-1.5 border border-slate-800 p-1.5 px-2.5 bg-[#0b111d]">
                                    <span className="font-black text-slate-400 text-[10.5px] uppercase">
                                        Status
                                    </span>
                                ...
                                <div className="space-y-1.5 border-t border-slate-800 pt-2 text-[11px] font-bold">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-black text-white text-[11.5px]">
                                            0
                                        </span>
                                    </div>
                                    <div className="flex justify-between">
                            ...
                            <div className="pl-3 space-y-2">
                                ...
                                <div className="space-y-1 pt-1.5 border-t border-slate-800">
                                    <div className="text-center font-black text-slate-400 text-[10.5px] uppercase">
                                        Custom Range
                                    </div>
