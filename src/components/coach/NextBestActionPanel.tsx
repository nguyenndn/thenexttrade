            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5 relative z-10">
                ...
                <div className="shrink-0 flex items-center sm:self-center self-start">
                    <Link href={action.ctaHref}>
                        <Button className="bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-yellow-600 text-white font-extrabold px-6 h-12 rounded-xl shadow-md shadow-amber-500/25 hover:shadow-lg hover:scale-105 active:scale-95 transition-all duration-300 flex items-center gap-2 border-0 group/btn">
