...
export function RecommendedForYou({ recommendations }: RecommendedForYouProps) {
    ...
    return (
        <div className="bg-white dark:bg-[#151925] border border-dashboard rounded-2xl overflow-hidden shadow-sm">
            <div className="p-5 border-b border-dashboard flex items-center gap-2">
                <GraduationCap
                        ...
                        >
                            <div className="space-y-2">
                                <div className="flex flex-wrap items-center gap-2">
                                    <span
                                        className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md text-[10px] font-extrabold uppercase tracking-widest ${
                                            isLesson
                            ...
                            <div className="shrink-0 self-start md:self-center">
                                <Link href={rec.url}>
                                    <Button
                                        variant="outline"
                                        className="h-10 px-4 rounded-xl text-xs font-extrabold flex items-center gap-1.5 border-dashboard hover:bg-gray-50 dark:hover:bg-white/5 active:scale-95 transition-all duration-300 hover:text-amber-500 dark:hover:text-gold"
                                    >
                                        <span>
                                            {isLesson
                                                ? "Start Study"
