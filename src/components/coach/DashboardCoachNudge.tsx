...
export function DashboardCoachNudge({ nextBestAction, learningRecommendations }: DashboardCoachNudgeProps) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="max-w-xl border-amber-500/20 dark:border-white/5 bg-white dark:bg-[#0F1116] p-6 rounded-2xl shadow-2xl whitespace-normal" style={{ whiteSpace: 'normal', wordBreak: 'break-word' }}>
                ...
                <div className="space-y-6 w-full">
                    ...
                    {learningRecommendations && learningRecommendations.length > 0 && (
                        <div className="space-y-3 w-full">
                            <h4 className="text-[10px] font-black uppercase tracking-widest text-gray-400 dark:text-gray-500 border-b border-gray-100 dark:border-white/5 pb-1">
                            ...
                            <div className="space-y-3 w-full">
                                {learningRecommendations.map((rec) => {
                                    ...
                                    return (
                                        <div 
                                            key={rec.id} 
                                            className="flex items-start justify-between gap-4 p-3 bg-gray-50/50 dark:bg-white/[0.01] border border-gray-100 dark:border-white/5 rounded-xl hover:border-amber-500/20 dark:hover:border-gold/20 transition-all duration-300 w-full"
