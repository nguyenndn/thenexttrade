...
export function MistakeDashboard() {
    ...
    const mostCostly = data.mostCostlyMistake
        ? getMistakeByCode(data.mostCostlyMistake)
        : null;
    const mostFrequent = data.mostFrequentMistake
        ? getMistakeByCode(data.mostFrequentMistake)
        : null;

    const costlyStat = mostCostly
        ? data.mistakeStats.find((s) => s.code === mostCostly.code)
        : null;
    const frequentStat = mostFrequent
        ? data.mistakeStats.find((s) => s.code === mostFrequent.code)
        : null;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                ...
                <div className="bg-white dark:bg-[#1E2028] p-6 rounded-xl border border-dashboard shadow-sm hover:shadow-md transition-shadow group">
                    <div className="flex items-center gap-3.5 mb-3">
                        ...
                        <p className="text-[11px] font-black uppercase tracking-wider text-gray-600 dark:text-gray-300">
                            Cost of Mistakes
                        </p>
                    </div>
                ...
                <div className="bg-white dark:bg-[#1E2028] p-6 rounded-xl border border-dashboard shadow-sm hover:shadow-md transition-shadow group">
                    ...
                    <div className="flex items-center gap-2 mt-2 text-[11px] font-bold tracking-wide uppercase">
                        <span className="text-primary">
                            {data.cleanTradeWinRate.toFixed(0)}% clean
                        </span>
                        <span className="text-gray-300 dark:text-gray-600">
                            vs
                        </span>
                        <span className="text-red-500">
                            {data.mistakeTradeWinRate.toFixed(0)}% w/ mistakes
                        </span>
                    </div>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-5 h-full">
                ...
                <div className="bg-white dark:bg-[#1E2028] p-6 md:p-8 rounded-xl border border-dashboard shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            <h3 className="text-xl font-black text-gray-700 dark:text-white tracking-tight">
                                Mistakes by Cost
                            </h3>
                            <p className="text-sm text-gray-500 font-medium">
                                Identify your most expensive errors.
                            </p>
                        </div>
                ...
                <div className="bg-white dark:bg-[#1E2028] p-6 md:p-8 rounded-xl border border-dashboard shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 font-medium">
                                Track how often these issues occur.
                            </p>
                        </div>
                    </div>
