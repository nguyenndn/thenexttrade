        ...
        <div className="text-center py-16 bg-white dark:bg-[#1E2028] rounded-xl border-2 border-dashed border-gray-200 dark:border-white/10 mt-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <a href="/dashboard/academy">
                    <Button
                        variant="outline"
                        className="gap-2 px-5 h-10 text-sm font-bold rounded-xl border-gray-200 dark:border-white/10 hover:border-primary/30 hover:bg-primary/5 transition-all duration-300"
                    >
