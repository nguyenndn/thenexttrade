...
export function StrategyCard({
 ...
 return (
 <div className={`bg-white dark:bg-[#1E2028] p-6 rounded-xl border shadow-sm group hover:border-primary/50 hover:shadow-md transition-shadow ${isGhost ? 'border-dashed border-gray-300 dark:border-white/20' : 'border-dashboard '
 }`}>
 {/* Header */}
 ...
 <div className="text-sm text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-white/5 p-3 rounded-lg border border-dashboard whitespace-pre-line max-h-[100px] overflow-y-auto custom-scrollbar">
 {strategy.rules}
 </div>
 </div>
 )}
 ...
 <div className="py-6 text-center bg-gray-50 dark:bg-white/5 rounded-xl border border-dashed border-dashboard">
