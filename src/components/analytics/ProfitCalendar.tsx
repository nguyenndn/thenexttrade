...
export function ProfitCalendar({ data, equityCurve, accountId }: ProfitCalendarProps) {
 ...
 return (
 <div ref={calendarRef} className="bg-white dark:bg-[#1E2028] p-6 rounded-xl border border-dashboard shadow-sm hover:shadow-md transition-shadow duration-200 group">
 {/* Header */}
