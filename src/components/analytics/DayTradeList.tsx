                ...
                <div className="overflow-y-auto flex-1 custom-scrollbar">
                    ...
                    <div className="px-6 py-4">
                        <div className="flex justify-between items-end pl-4">
                            <div className="border-l-[3px] border-[#3B82F6] pl-4">
                                <p className="text-[10px] font-bold text-gray-600 dark:text-gray-300 uppercase tracking-widest mb-1">
                                    Net P&L
                                </p>
                                <h3
                                    className={`text-[2.25rem] font-bold leading-tight tracking-tight ${netPnl >= 0 ? "text-[#3B82F6]" : "text-red-500"}`}
                                >
                                    {netPnl >= 0 ? "+" : ""}
                            ...
                            <div className="flex flex-col items-end pb-1">
                                {growth !== 0 && (
                                    <>
                                        ...
                                        <span
                                            className={`text-sm font-bold ${growth >= 0 ? "text-[#3B82F6]" : "text-red-500"}`}
                                        >
                                            {growth >= 0 ? "+" : ""}
                                            {growth.toFixed(2)}%
                                        </span>
                    ...
                    <div className="px-6 py-5 border-t border-dashboard">
                        <div className="flex justify-between items-center mb-5">
                            <div>
                                <p className="text-[11px] text-gray-600 dark:text-gray-300 mb-1 font-medium italic">
                                    Start Balance
                                </p>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center text-sm">
                                <span className="text-gray-600 dark:text-gray-300 flex items-center gap-1.5">
                                    <span className="flex items-center justify-center w-4 h-4 rounded-full bg-gray-100 dark:bg-white/10 text-[9px] font-bold text-gray-600 dark:text-gray-300">
                                        $
                                    </span>
                                    Commissions & Fees
                                </span>
                    ...
                    <div className="px-6 py-5 border-t border-dashboard">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center text-sm">
                                ...
                                <span className="font-bold text-gray-700 dark:text-white">
                                    {stats?.avgHoldTimeMinutes || 0} min
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 divide-x divide-dashboard border-t border-dashboard">
                        <div className="p-4 text-center">
                            <p className="text-[10px] text-gray-600 dark:text-gray-300 mb-1.5 font-bold uppercase tracking-wider">
                                Winrate
                            </p>
