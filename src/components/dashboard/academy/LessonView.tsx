...
export default function LessonView({
 ...
 <Button variant="outline" className="rounded-xl font-bold border-dashboard bg-white dark:bg-[#151925] hover:bg-gray-50 dark:hover:bg-white/10 text-gray-600 dark:text-gray-300">
 <ArrowLeft size={16} />
 Back to Map
 </Button>
 </Link>
