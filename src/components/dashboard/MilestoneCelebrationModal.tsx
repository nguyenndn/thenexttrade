...
const ICON_MAP: Record<string, { Icon: LucideIcon; gradient: string; shadow: string }> = {
    Cable: {
        Icon: Cable,
...
export function MilestoneCelebrationModal() {
    ...
    const handleCelebrate = async (navigateToLink: boolean) => {
        ...
        trackEvent("milestone_celebrated", { milestoneId: current.id, navigated: navigateToLink ? "yes" : "no" });
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            {/* Modal */}
            <div
                className={`relative z-10 bg-white dark:bg-[#1E2028] rounded-2xl w-full max-w-md overflow-hidden border border-gray-200 dark:border-white/10 shadow-2xl transition-all duration-500 ${
                    isVisible
