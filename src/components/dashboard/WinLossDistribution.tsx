...
export function WinLossDistribution({ wins, losses, breakEvens, winRate }: WinLossDistributionProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-[#0B0E14] rounded-xl border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow border-t-4 border-t-emerald-500 p-5">
