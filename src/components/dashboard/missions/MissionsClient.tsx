...
export function MissionsClient({ initialMissions, userXp }: MissionsClientProps) {
 ...
 <p className="text-sm font-medium">No missions in this category yet.</p>
 </div>
 )}
 </Tabs>
 </div>
...
function StatCard({
 ...
 <div className={`w-9 h-9 rounded-xl flex items-center justify-center bg-gray-50 dark:bg-white/5 ${color}`}>
 <Icon size={16} />
 </div>
 <div>
