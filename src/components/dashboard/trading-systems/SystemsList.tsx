        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                {filteredProducts.length === 0 ? (
                    <div className="col-span-1 md:col-span-2 text-center py-16 bg-white dark:bg-[#1E2028] rounded-xl border-2 border-dashed border-dashboard">
                        {/* Animated Bot Icon */}
                        ...
                        <p className="text-gray-600 dark:text-gray-300 px-6 max-w-sm mx-auto mb-6">
                            No trading systems match your search. Try a
                            different keyword or check back later for new
                            releases.
                        </p>
