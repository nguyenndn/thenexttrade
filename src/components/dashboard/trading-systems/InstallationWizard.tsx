...
export function InstallationWizard({ type }: InstallationWizardProps) {
    ...
    const steps = [
            ...
            content: (
                <div className="bg-green-50 dark:bg-green-500/10 border border-green-100 dark:border-green-500/20 rounded-xl p-6">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
                        Ensure you save the file to an easily accessible
                        location like your <strong>Desktop</strong> or{" "}
        ...
        },
        {
            ...
            description:
                "Locate the correct folder in your MetaTrader 5 terminal.",
            icon: FolderOpen,
            content: (
                <div className="space-y-4">
                    <p className="text-gray-600 dark:text-gray-300">
                        In your MT5 terminal, click on <strong>File</strong> in
                        the top menu, then select{" "}
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4">
                    <p className="text-gray-600 dark:text-gray-300">
                        Open the <strong>MQL5</strong> folder. Inside, find and
                        open the
        ...
        },
        {
            title: "Copy File",
            description:
                "Move the downloaded .ex5 file into the target folder.",
            icon: Copy,
            content: (
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4">
                    <p className="text-gray-600 dark:text-gray-300">
                        Right-click on the <strong>Navigator</strong> panel in
                        MT5 (usually on the left side) and select{" "}
                    ...
                    <p className="text-sm text-gray-600">
                        Your new{" "}
                        {type === "MT5_EA" ? "Expert Advisor" : "Indicator"}{" "}
    ...
    return (
        <div className="w-full max-w-2xl mx-auto">
            ...
            {/* Step Card */}
            <div className="bg-white dark:bg-[#151925] border border-dashboard rounded-xl p-8 shadow-xl shadow-gray-200/50 dark:shadow-none min-h-[400px] flex flex-col relative overflow-hidden">
                {/* Background Decor */}
                ...
                <div className="mt-12 pt-8 border-t border-dashboard flex items-center justify-between relative z-10">
                    <Button
                        variant="outline"
                        onClick={handlePrev}
