...
function SidebarItemComponent({
    ...
    return (
        <div className="mb-1">
            ...
            {hasSubItems && item.items && isExpanded && !collapsed && (
                <div className="relative pl-6 pr-3 py-1 flex flex-col gap-1">
                    {/* Vertical connector line */}
                    <div className="absolute left-[35px] top-0 bottom-4 w-px bg-gray-200 dark:bg-white/10" />
...
export function Sidebar({
    ...
    useEffect(() => {
        if (!pathname || lastExpandedPathRef.current === pathname) return;
