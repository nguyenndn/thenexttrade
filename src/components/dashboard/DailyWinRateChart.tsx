...
export function DailyWinRateChart({
    data,
    height = 300,
    selectedDates,
                    ...
                    {hasData ? (
                        <>
                            <div className="flex items-center gap-2 mb-1">
                                <div
                                    className={`w-2 h-2 rounded-full ${winRate >= 50 ? "bg-emerald-500" : "bg-amber-500"}`}
                                />
                                <p
                                    className={`text-sm font-black ${winRate >= 50 ? "text-emerald-600 dark:text-emerald-400" : "text-amber-600 dark:text-amber-400"}`}
                                >
