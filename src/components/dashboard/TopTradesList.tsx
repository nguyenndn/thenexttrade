...
export function TopTradesList({ bestTrades, worstTrades }: TopTradesListProps) {
    ...
    return (
        <div className="flex flex-col h-full w-full border-t-4 border-t-cyan-500 overflow-hidden">
            {/* Container Header */}
                ...
                <div className="flex-1">
                    ...
                    <div className="divide-y divide-gray-50 dark:divide-white/5">
                        ...
                        <div className="grid grid-cols-12 gap-2 px-5 py-2.5 text-[10px] font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-white/[0.02]">
                            ...
                            <div className="col-span-2 text-center text-gray-500/70 dark:text-gray-400/70">
                                Lot
                            </div>
                        ...
                        <div>
                            {bestTrades.length === 0 ? (
                                <div className="py-8 text-center text-xs text-gray-500 dark:text-gray-400 font-medium">
                                ...
                                bestTrades.map((trade) => (
                                    <div
                                        key={trade.id}
                                        className="grid grid-cols-12 gap-2 items-center px-5 py-3 hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors cursor-default border-t border-gray-50 dark:border-white/5 first:border-0"
                                    >
