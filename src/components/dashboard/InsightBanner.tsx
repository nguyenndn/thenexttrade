...
export function InsightBanner({ insight, score }: InsightBannerProps) {
    ...
    const handleDismiss = () => {
        ...
        Object.keys(localStorage).forEach((k) => {
            if (
                k.startsWith("dismissed_insight_") &&
                k !== `dismissed_insight_${today}`
            ) {
    ...
    return (
        ...
        >
            ...
            {score !== null && score !== undefined && (
                <div
                    className={`hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold shrink-0 ${
                        score >= 75
