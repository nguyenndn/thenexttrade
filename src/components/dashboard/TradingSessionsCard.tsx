...
export function TradingSessionsCard({ data }: TradingSessionsCardProps) {
 ...
 return (
 <div className="bg-white dark:bg-[#0B0E14] rounded-xl border border-dashboard shadow-sm hover:shadow-md transition-shadow border-t-4 border-t-indigo-500 h-auto xl:h-[400px] flex flex-col overflow-hidden">
 {/* Header */}
