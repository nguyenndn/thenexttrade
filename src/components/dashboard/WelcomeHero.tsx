...
const goalMessages: Record<string, { title: string; subtitle: string }> = {
    track: {
        ...
        subtitle:
            "Connect your MT5 account and your dashboard will automatically organize every trade - entries, exits, and results.",
    },
    mistakes: {
        title: "Let's find what's costing you money.",
        subtitle:
            "Your dashboard will analyze patterns in your trades and spotlight recurring mistakes so you can fix them fast.",
    },
    discipline: {
...
export function WelcomeHero({
    ...
    useEffect(() => {
        if (!hasTracked.current) {
            trackEvent("new_user_zero_state_viewed", {
                tradingGoal: tradingGoal || "none",
            });
        ...
        <div className="space-y-4">
                ...
                <div className="relative z-10 p-6 md:p-8">
                    ...
                    <div className="flex items-center gap-2 mb-4">
                        <div className="relative p-2 bg-primary/10 rounded-xl">
                            <Rocket
                                size={20}
                                className="text-primary animate-[wiggle_2s_ease-in-out_infinite]"
                            />
                    ...
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className="text-xs font-bold text-gray-500 dark:text-gray-400 tabular-nums">
                            ...
                            {activationState.totalCount} done
                        </span>
                    </div>
                    ...
                    {nextStep && (
                        <Link
                            ...
                            onClick={() =>
                                handleCtaClick(nextStep.id, nextStep.ctaHref)
                            }
                        >
                            <Button
                                variant="primary"
                                className="gap-2 shadow-lg shadow-primary/25 px-6 py-3 text-sm"
                            >
                                {nextStep.ctaLabel}
                                <ArrowRight size={16} />
                            </Button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {secondarySteps.map((step) => (
                        <Link
                            ...
                            href={step.ctaHref}
                            onClick={() =>
                                handleCtaClick(step.id, step.ctaHref)
                            }
            ...
            <div className="relative rounded-2xl border border-dashboard bg-white dark:bg-[#0B0E14] overflow-hidden">
                ...
                <div className="relative h-36 md:h-48 overflow-hidden">
                    <svg
                        viewBox="0 0 400 120"
                        className="w-full h-full blur-[2px] opacity-40 dark:opacity-25"
