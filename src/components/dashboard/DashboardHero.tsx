...
const HERO_WIDGETS_CONFIG: Record<
    HeroWidgetType,
    { label: string; metricId: string }
> = {
...
export function DashboardHero({
    data,
    isEditable = false,
    heroWidgets = ["TOTAL_BALANCE", "PERIOD_PNL", "WIN_RATE", "TRADE_SCORE"],
    onHeroWidgetChange,
    onHeroWidgetsReorder,
}: DashboardHeroProps) {
    ...
    const totalTrades =
        data.dashboardData.totalTrades !== undefined
            ? data.dashboardData.totalTrades
            : data.dashboardData.winCount +
              data.dashboardData.lossCount +
              data.dashboardData.breakEvenCount;
    ...
    const scoreColor =
        tradeScore !== null ? getScoreColor(tradeScore) : "transparent";
                ...
                return (
                    <>
                        ...
                        <Link
                            ...
                            className="text-xs text-gray-600 dark:text-gray-300 mt-1 hover:text-amber-500 dark:hover:text-amber-400 transition-colors inline-block font-semibold"
                        >
                            {tradeScore !== null
                                ? "View Details →"
                                : "Need 30+ trades"}
                        ...
                        <div
                            ...
                            className={cn(
                                ...
                                isEditable
                                    ...
                                    : "outline-amber-500/0",
                                draggedIndex === idx &&
                                    "opacity-40 scale-[0.98] outline-amber-500 bg-amber-500/5",
                                idx > 0 &&
                                    "border-l-0 lg:border-l border-gray-200 dark:border-gray-800"
                            )}
                        >
