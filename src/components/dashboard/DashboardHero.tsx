...
export function DashboardHero({ totalBalance, periodPnL, winRate, tradeScore, isDark }: DashboardHeroProps) {
 ...
 return (
 <div id="onborda-hero" className="relative overflow-hidden rounded-xl bg-gradient-to-r from-white to-gray-50 dark:from-[#0B0E14] dark:to-[#131720] border border-dashboard p-4 sm:p-6 shadow-lg">
 {/* Glow effects */}
 ...
 {/* Period P&L */}
 <div className="text-center border-l-0 lg:border-l border-dashboard">
 <div className="mb-1.5 flex items-center justify-center gap-1.5">
