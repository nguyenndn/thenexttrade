...
export function ActivationChecklist({ state }: ActivationChecklistProps) {
    ...
    return (
        <div className="rounded-2xl border border-dashboard bg-white dark:bg-[#0B0E14] overflow-hidden">
                    ...
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400">
                                Set up the workflow that makes your trading data
                                useful.
                            </p>
                        </div>
                    </div>
            ...
            {/* Next Step CTA */}
            {nextStep && (
                <div className="px-5 py-4 bg-primary/5 dark:bg-primary/10 border-b border-dashboard">
                    <div className="flex items-center justify-between gap-4">
                        ...
                        >
                            <Button
                                variant="primary"
                                className="shrink-0 gap-1.5 text-sm px-4 py-2"
                            >
                                {nextStep.ctaLabel}
                                <ArrowRight size={14} />
                            </Button>
