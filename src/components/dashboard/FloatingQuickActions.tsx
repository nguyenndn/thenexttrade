                        ...
                        {actions.map((action, index) => (
                            ...
                            >
                                <Link
                                    ...
                                    className={`flex items-center gap-3 px-4 py-3 bg-white dark:bg-[#1E2028] border border-gray-200 dark:border-white/10 rounded-xl shadow-xl hover:shadow-2xl transition-all group ${isLeftAligned ? 'flex-row-reverse' : ''}`}
                                >
