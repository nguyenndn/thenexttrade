...
export function AccountModal({ account, onClose, onSave }: AccountModalProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
            <div className="bg-white dark:bg-[#1E2028] rounded-2xl w-full max-w-lg overflow-hidden border border-gray-100 dark:border-white/5 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
