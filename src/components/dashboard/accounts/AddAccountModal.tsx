...
const BROKER_IB_INSTRUCTIONS: Record<string, BrokerInstruction> = {
    ...
    VANTAGE: {
        ...
        emailBody:
            "Hi, Kindly assist to reassign my account under IB Number (111451 or 142655) as I want to trade with him.\n\nThanks.",
    ...
    VTMARKETS: {
        ...
        emailSubject: "Account Reassign - Client Email",
        emailBody:
            "Hi, Kindly assist to reassign my account under IB Number (830422) as I want to trade with him.\n\nThanks.",
        steps: [
            "Send an email from your registered email",
    ...
    ULTIMAMARKETS: {
        ...
        emailSubject:
            "Please Help me transfer my Account to affiliate: 7234903",
        emailBody:
            "Hi, info, Could you please help me transfer my account under affiliate 7234903?\n\nThanks very much!",
        steps: [
            "Send an email from your registered email",
...
function CopyableField({ label, value }: { label: string; value: string }) {
    ...
    return (
        <div className="flex items-center justify-between p-2.5 rounded-lg bg-white dark:bg-[#1E2028] border border-dashboard">
...
export function AddAccountModal({ brokers }: AddAccountModalProps) {
    ...
    const [pendingData, setPendingData] = useState<SubmitAccountInput | null>(
        null
    );
    ...
    return (
        <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogTrigger asChild>
                <Button className="bg-[#00C888] hover:bg-[#00B078] text-white font-bold rounded-lg px-6 h-10 shadow-none border-none transition-colors border-0">
                    <Plus size={16} className="mr-2" strokeWidth={3} />
                    <span className="text-sm">Add Account</span>
                </Button>
            </DialogTrigger>
            <DialogContent className="bg-white dark:bg-[#1A1D27] rounded-xl border-0 dark:border max-w-lg p-0 overflow-hidden shadow-2xl dark:shadow-[0_0_40px_rgba(0,0,0,0.5)]">
                ...
                {view === "instructions" &&
                    ...
                    (() => {
                        ...
                        const brokerName =
                            selectedBrokerData?.name || brokerSlug;
                        const ibCode = selectedBrokerData?.ibCode || "";
                        const affiliateUrl =
                            selectedBrokerData?.affiliateUrl || "";
                                ...
                                <div className="bg-gray-50 dark:bg-[#151925] rounded-xl p-5 mb-5 space-y-4">
                                    ...
                                    {brokerSlug === "EXNESS" && (
                                        <>
                                            ...
                                            <div className="space-y-2 pt-2">
                                                <CopyableField
                                                    label="Partner IB Link"
                                                    value={affiliateUrl}
                                                />
                                                <CopyableField
                                                    label="Partner IB Code"
                                                    value={ibCode}
                                                />
                                            </div>

                                            <div className="flex gap-2.5 pt-1">
                                                <span className="w-6 h-6 rounded-full bg-emerald-500/10 text-emerald-500 flex items-center justify-center text-xs font-black shrink-0">
                                                    4
                                                </span>
                                    ...
                                    {instruction?.method === "email" && (
                                        <>
                                            ...
                                            {/* Email Template Card */}
                                            <div className="bg-white dark:bg-[#1E2028] rounded-xl border border-dashboard overflow-hidden">
                                                {/* Email Header Fields */}
                                                <div className="border-b border-dashboard p-3 space-y-2">
                                                    <div className="flex items-center gap-2 text-sm">
                                                        <span className="text-gray-400 dark:text-gray-500 font-bold w-10 shrink-0">
                                                            To:
                                                        </span>
                                                ...
                                                {/* Subject */}
                                                <div className="border-b border-dashboard p-3">
                                                    <div className="flex items-center gap-2 text-sm">
                                                        <span className="text-gray-400 dark:text-gray-500 font-bold w-16 shrink-0">
                                                            Subject:
                                                        </span>
                                                        <span className="font-medium text-gray-700 dark:text-white">
                                                            {
                                                                instruction.emailSubject
                                                            }
                                                        </span>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="p-3 rounded-lg bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-500/20 text-xs text-emerald-700 dark:text-emerald-400 flex gap-2 font-medium">
                                        ...
                                        />
                                        <p>
                                            After your IB transfer is complete,
                                            come back here and submit your MT5
                                            account.
                                        </p>
                                    </div>
                                    ...
                                    <div className="p-3 rounded-lg bg-amber-50 dark:bg-amber-500/10 border border-amber-100 dark:border-amber-500/20 text-xs text-amber-700 dark:text-amber-400 flex gap-2 font-medium">
                                        ...
                                        <p>
                                            ...
                                            You must open a NEW trading account
                                            after changing IB.
                                        </p>
                                    </div>
                                </div>
                ...
                {view === "verify_ib" && pendingData && (
                    <div className="p-8">
                        ...
                        <p className="text-sm text-center text-gray-600 dark:text-gray-300 mb-10 max-w-[320px] mx-auto leading-relaxed">
                            Your trading account must be registered under our
                            Introducing Broker (IB) to receive free access to
                            the EA.
                        </p>
                    ...
                    <div className="p-8 pt-6 relative">
                        ...
                        <div className="flex items-center justify-center gap-4 mb-10">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-bold text-[#00C888]">
                                    IB
                                </span>
                            </div>
                        ...
                        <div className="bg-amber-50/50 dark:bg-amber-500/5 border border-amber-200 dark:border-amber-500/20 rounded-xl p-5 mb-8">
                            <div className="flex gap-3 items-start">
                                ...
                                <p className="text-sm text-amber-700 dark:text-amber-400 leading-relaxed">
                                    ...
                                    Having sufficient balance ensures the EA can
                                    manage trades properly and protect your
                    ...
                    <div className="p-6">
                        <DialogHeader>
                            ...
                            <DialogDescription className="text-gray-600 dark:text-gray-300">
                                Enter your trading account information to
                                activate license.
                            </DialogDescription>
                        </DialogHeader>
                        ...
                        >
                                        ...
                                        <div
                                            ...
                                            className={cn(
                                                ...
                                                selectedBroker === broker.slug
                                                    ...
                                                    : "border-dashboard hover:border-[#00C888]/40 bg-gray-50 dark:bg-white/5"
                                            )}
                                        >
                            ...
                            <div className="relative w-full py-2">
                                ...
                                <div className="relative flex justify-center text-xs">
                                    <span className="px-3 bg-white dark:bg-[#1E2028] text-gray-500 font-medium">
                                        or
                                    </span>
                                </div>
                            </div>
                    ...
                    <div className="p-6">
                        <DialogHeader>
                            ...
                            <DialogDescription className="text-sm text-gray-600 dark:text-gray-300 mt-1 pl-8">
                                Sign up with a supported broker below to get
                                started with our EAs.
                            </DialogDescription>
                        </DialogHeader>
                        ...
                        <div className="space-y-3 mt-4">
                            {brokers.map((broker) => (
                                <div
                                    key={broker.slug}
                                    className="flex items-center gap-3 p-3 rounded-xl border border-dashboard hover:border-dashboard dark:hover:border-white/10 bg-gray-50/50 dark:bg-white/[0.02] transition-colors"
                                >
                                    <div className="w-12 h-12 rounded-lg bg-white dark:bg-white/10 border border-dashboard flex items-center justify-center flex-shrink-0 p-1.5">
                                        {/* eslint-disable-next-line @next/next/no-img-element */}
                                        <img
                                            src={broker.logo}
                                            alt={broker.name}
                        ...
                        <p className="text-xs text-center text-gray-600 dark:text-gray-300 mt-6 leading-relaxed">
                            Once registered, return here and enter your MT5
                            account number to activate your license.
                        </p>
                        ...
                        <Button
                            ...
                            type="button"
                            onClick={() => setView("form")}
                            className="w-full h-auto mt-4 py-3 px-4 rounded-xl border text-gray-700 dark:text-gray-300 border-dashboard hover:border-gray-300 dark:hover:border-white/20 hover:bg-gray-50 dark:hover:bg-white/5 transition-all flex items-center justify-center gap-2 font-bold text-sm"
                        >
                        ...
                        <div className="flex flex-col items-center text-center space-y-6 animate-in zoom-in duration-500">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-300 max-w-[280px] mx-auto leading-relaxed">
                                    Your MT5 account has been submitted for
