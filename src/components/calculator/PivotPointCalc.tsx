            ...
            <div className="space-y-6">
                ...
                <div className="grid sm:grid-cols-3 gap-6">
                    <CalcInput
                        ...
                        value={inputs.high}
                        onChange={(v) =>
                            setInputs({ ...inputs, high: parseFloat(v) || 0 })
                        }
                        step="0.0001"
                    />
                    <CalcInput
                        ...
                        value={inputs.low}
                        onChange={(v) =>
                            setInputs({ ...inputs, low: parseFloat(v) || 0 })
                        }
                        step="0.0001"
                    />
                    <CalcInput
                        ...
                        value={inputs.close}
                        onChange={(v) =>
                            setInputs({ ...inputs, close: parseFloat(v) || 0 })
                        }
                        step="0.0001"
                    />
                </div>
            ...
            <div className="bg-white dark:bg-white/5 rounded-xl border border-dashboard overflow-hidden">
                <div className="px-4 py-3 border-b border-dashboard">
                    <p className="text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                        {METHODS.find((m) => m.id === inputs.method)?.name}{" "}
                        Pivot Levels
                    </p>
                </div>
