    ...
    const results = useMemo(() => {
        ...
        const totalReturn =
            inputs.startBalance > 0
                ? ((balance - inputs.startBalance) / inputs.startBalance) * 100
                : 0;
    ...
    return (
        <div className="grid lg:grid-cols-2 gap-8">
            <div className="space-y-6">
                    ...
                    <div className="flex bg-gray-100 dark:bg-white/5 p-1 rounded-xl gap-1">
                        {PERIOD_OPTIONS.map((opt) => (
                            <button
                                ...
                                type="button"
                                onClick={() =>
                                    setInputs({ ...inputs, periodType: opt.id })
                                }
                                className={cn(
                ...
                <div className="grid sm:grid-cols-3 gap-6">
                    <CalcInput
                        ...
                        onChange={(v) =>
                            setInputs({ ...inputs, periods: parseInt(v) || 1 })
                        }
                    />
                    <CalcInput
                        label="Addition"
            ...
            <div className="space-y-4">
                {/* Mini chart */}
                <div className="bg-white dark:bg-white/5 rounded-xl border border-dashboard p-4">
