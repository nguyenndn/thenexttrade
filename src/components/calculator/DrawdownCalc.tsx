        ...
        <div className="grid lg:grid-cols-2 gap-8">
            <div className="space-y-6">
                <CalcInput
                    ...
                    onChange={(v) =>
                        setInputs({ ...inputs, balance: parseFloat(v) || 0 })
                    }
                    suffix="$"
                />
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setInputs({
                                    ...inputs,
                                    consecutiveLosses: parseInt(e.target.value),
                                })
                            }
            ...
            <div className="space-y-4">
                ...
                <CalcResultGrid>
                    <CalcResultCard
                        label="Remaining"
                        value={`$${results.remaining.toFixed(0)}`}
                    />
                    <CalcResultCard
                        label="Total Loss"
                        value={`-$${results.totalLoss.toFixed(0)}`}
                        valueColor="text-red-600 dark:text-red-400"
                    />
                    <CalcResultCard
                        label="Recovery Needed"
                        value={`${results.recoveryPct.toFixed(1)}%`}
                        valueColor={severity.color}
                    />
                    <CalcResultCard
                        label="Trades to Recover"
                        value={`${results.tradesToRecover}`}
