...
export function PipValueCalc() {
    ...
    const pipValuePerMicro = PIP_VALUES[pair.toUpperCase()] || 0.1;
        ...
        <div className="grid lg:grid-cols-2 gap-8">
                        ...
                        <div className="flex bg-gray-100 dark:bg-white/5 p-1 rounded-xl gap-1">
                            {[
                                ...
                                <button
                                    ...
                                    className={`relative flex-1 py-2.5 rounded-lg text-xs font-bold transition-colors z-10 ${
                                        lotSize === lt.val
                                            ? "text-white"
            ...
            <div className="space-y-4">
                ...
                <div className="bg-white dark:bg-white/5 rounded-xl border border-dashboard overflow-hidden">
                    <div className="px-4 py-2.5 border-b border-dashboard">
                    ...
                    <div className="divide-y divide-dashboard">
                        {quickPips.map((pips) => (
                            <div
                                key={pips}
                                className="flex items-center justify-between px-4 py-2.5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors"
                            >
