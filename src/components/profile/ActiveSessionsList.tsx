...
export function ActiveSessionsList() {
 ...
 return (
 <div key={session.id} className={`flex items-center justify-between p-4 rounded-xl border transition-all ${isCurrent ? 'bg-green-50/50 dark:bg-green-500/5 border-green-200 dark:border-green-500/30' : 'bg-gray-50 dark:bg-white/5 border-dashboard '}`}>
