    ...
    const handleSubmit = async (formData: FormData) => {
        ...
        try {
            ...
            if (error.message && error.message.includes("exceeded")) {
                errorMessage =
                    "File is too large. Please upload an image smaller than 1MB.";
    ...
    return (
        <div className="w-full">
            ...
            <form action={handleSubmit}>
                {/* Avatar Section */}
                <div className="pb-8 border-b border-dashboard flex flex-col sm:flex-row items-center gap-8">
                ...
                <div className="mt-8 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full h-11 pl-9 pr-4 bg-gray-50 dark:bg-[#0B0E14] border border-dashboard rounded-xl focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary dark:text-white placeholder:text-gray-600 transition-all font-medium"
                            />
                        </div>
                        <p className="text-xs text-gray-600">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="w-full px-4 py-3 bg-gray-50 dark:bg-[#0B0E14] border border-dashboard rounded-xl focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary dark:text-white placeholder:text-gray-600 resize-none transition-all"
                        />
                        <p className="text-xs text-gray-600">
