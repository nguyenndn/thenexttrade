            ...
            <div>
                <div className="flex justify-between items-start">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 text-sm">Your account is secured with an extra layer of protection.</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
                ...
                {step === 'disable-verify' && (
                    <div className="mt-6 bg-red-50 dark:bg-white/5 rounded-xl p-6 border border-red-200 dark:border-white/10 animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <p className="text-sm text-gray-500 mb-4">Please enter your 2FA code to confirm disabling this security feature.</p>
                ...
                <div className="mt-6 bg-gray-50 dark:bg-white/5 rounded-xl p-6 border border-gray-200 dark:border-white/10 animate-in fade-in zoom-in-95 duration-200">
                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                        <div className="bg-white p-4 rounded-xl border border-gray-200 dark:border-white/10 w-fit mx-auto md:mx-0">
                            ...
                            */}
                            {qrCode.startsWith('data:') ? (
                                ...
                                <div className="w-40 h-40 bg-gray-200 flex items-center justify-center text-xs text-gray-500">
                                    QR Not Displayable
                                </div>
                            )}
                        </div>
                        ...
                        <div className="flex-1 space-y-4">
                            <div>
                                <label className="text-xs font-bold uppercase text-gray-500 mb-1 block">Manual Entry Code</label>
