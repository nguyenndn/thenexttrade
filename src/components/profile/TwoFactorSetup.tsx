...
export function TwoFactorSetup({ isEnabled, onUpdate }: TwoFactorSetupProps) {
    const [step, setStep] = useState<"idle" | "setup" | "disable-verify">(
        "idle"
    );
    ...
    if (isEnabled) {
        return (
            <div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-sm">
                                Your account is secured with an extra layer of
                                protection.
                            </p>
                        </div>
                    </div>
                ...
                {step === "disable-verify" && (
                    <div className="mt-6 bg-red-50 dark:bg-white/5 rounded-xl p-6 border border-red-200 animate-in fade-in zoom-in-95 duration-200">
                        <h3 className="font-bold text-gray-700 dark:text-white mb-4">
                            Verify to Disable 2FA
                        </h3>
                        <p className="text-sm text-gray-600 mb-4">
                            Please enter your 2FA code to confirm disabling this
                            security feature.
                        </p>
                        ...
                        <div className="flex gap-2">
                            <input
                                ...
                                placeholder="123456"
                                maxLength={6}
                                className="w-full max-w-[200px] px-4 py-2 bg-white dark:bg-black/20 border border-dashboard rounded-xl focus:outline-none focus:border-red-500 font-mono text-center tracking-widest text-lg"
                            />
                            <Button
                                variant="destructive"
                                size="smd"
                        ...
                        <Button
                            ...
                            className="text-sm text-gray-600 underline decoration-dotted mt-4"
                        >
                            Cancel
                        </Button>
                    </div>
    ...
    return (
        <div>
            ...
            {step === "setup" && (
                <div className="mt-6 bg-gray-50 dark:bg-white/5 rounded-xl p-6 border border-dashboard animate-in fade-in zoom-in-95 duration-200">
                    <h3 className="font-bold text-gray-700 dark:text-white mb-4">
                        Scan QR Code
                    </h3>
                    <div className="flex flex-col md:flex-row gap-8">
                        <div className="bg-white p-4 rounded-xl border border-dashboard w-fit mx-auto md:mx-0">
 ...
 */}
                        ...
                        <div className="flex-1 space-y-4">
                            ...
                            <Button
                                variant="link"
                                onClick={() => setStep("idle")}
                                className="text-sm text-gray-600 underline decoration-dotted px-0 justify-start"
                            >
                                Cancel Setup
                            </Button>
                        </div>
