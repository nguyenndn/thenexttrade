            ...
            <div className="w-full overflow-x-auto pb-2 scrollbar-none">
                <div className="flex space-x-1 bg-gray-100 dark:bg-slate-800 p-1 rounded-xl w-fit min-w-max">
                    <Button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 h-auto rounded-lg text-sm font-medium transition-all whitespace-nowrap ${
                            activeTab === "profile"
                                ? "bg-white dark:bg-slate-700 text-gray-700 dark:text-white shadow-sm hover:bg-white dark:hover:bg-slate-700 hover:text-gray-700 dark:hover:text-white"
