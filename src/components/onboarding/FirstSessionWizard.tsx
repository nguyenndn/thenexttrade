...
export function FirstSessionWizard({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        hideCloseButton
        className="border-gray-200 dark:border-white/10 bg-white dark:bg-[#0F1116] p-0 rounded-2xl shadow-2xl overflow-hidden"
        style={{
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        disabled={isPending}
        className="w-full text-left flex items-center gap-3 p-3 rounded-xl border border-gray-200 dark:border-white/10 hover:border-primary/30 dark:hover:border-primary/20 bg-white dark:bg-white/[0.01] transition-all duration-300 group disabled:opacity-60"
      >
    ...
    <div className="space-y-2.5">
      ...
      {options.map((opt) => (
        <button
          ...
          className="w-full text-left flex items-start gap-3 p-3 rounded-xl border border-gray-200 dark:border-white/10 hover:border-primary/30 dark:hover:border-primary/20 bg-white dark:bg-white/[0.01] transition-all duration-300 group"
        >
...
function StepBringFirstData({
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Context hint */}
      <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-gray-50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/5">
        <HelpCircle
          size={14}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-1">
          ...
          {tradeCount >= 3 && (
            <Link href="/dashboard/reports/weekly" onClick={onComplete}>
              <Button
                variant="outline"
                className="font-extrabold text-xs h-9 px-4 rounded-xl border-gray-200 dark:border-white/10 hover:border-primary/30 transition-all"
              >
