...
export function FirstSessionWizard({
    ...
    const [mobileFallbackMethod, setMobileFallbackMethod] = useState<
        "EA_SYNC" | null
    >(null);
    ...
    useEffect(() => {
        if (open && !hasTrackedRef.current) {
            ...
            trackEvent("first_session_wizard_shown", {
                        ...
                        <>
                            ...
                            {state.currentStep === "CHOOSE_SYNC_METHOD" && (
                                <StepChooseSyncMethod
                                    onSelect={handleSyncMethodSelect}
                                />
                            )}
                            {state.currentStep === "BRING_FIRST_DATA" && (
                                <StepBringFirstData
                ...
                <div className="flex items-start gap-2.5">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="mt-1 text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
                            Add your account number so TheNextTrade can organize
                            trades and build your dashboard.
                        </p>
                    </div>
                </div>
        ...
        <div className="space-y-2.5">
            <div className="space-y-1 mb-1">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                    Pick the setup that matches how you use MT5. You can change
                    this later.
                </p>
            </div>
            ...
            {options.map((opt) => (
                ...
                >
                    <div className="p-2 bg-gray-100 dark:bg-white/5 rounded-lg shrink-0 group-hover:bg-primary/10 transition-colors">
                        {React.cloneElement(
                            opt.icon as React.ReactElement<{ size?: number }>,
                            {
                                size: 18,
                            }
                        )}
            ...
            <div className="p-4 bg-gradient-to-br from-emerald-500/[0.05] to-primary/[0.03] border border-emerald-500/15 rounded-xl space-y-3 text-center">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed max-w-md mx-auto">
                        You can now review win rate, P/L, symbols, reports, and
                        next actions from real trade data.
                    </p>
                </div>
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="mt-1.5 text-xs text-gray-600 dark:text-gray-400 leading-relaxed font-semibold">
                            Because MetaTrader 5 auto-syncing requires running
                            our local helper app, setup must be completed on a{" "}
                            <strong>Windows Desktop or VPS</strong>.
                        </p>
                    </div>
                </div>
            </div>
