...
export const TRADING_SYSTEMS_DATA: SystemData[] = [
  {
    ...
    longDescription: "<div class=\"space-y-4\"><p><em>v3.0 — The Ultimate Automated Gold EA! 🚀</em></p><div class=\"space-y-2 mt-2\"><p>— <strong>Smart Sequence Pruning</strong> — Rolling recovery system utilizing scalp profits from new trades to systematically trim and close deep drawdown positions.</p><p>— <strong>Trend Master Filtering</strong> — Daily (D1) directional control restricting grid entries strictly to high-probability trend directions.</p><p>— <strong>News Filter Integration</strong> — Pauses first-order initialization 15 minutes before and after high-impact macroeconomic events.</p><p>— <strong>Mobile Remote Control</strong> — Toggle EA status remotely from MT5 mobile app using custom pending order price triggers.</p></div><p class=\"font-extrabold text-gold mt-4\">≫ Trade smarter, execute safer. ⚡</p><p class=\"text-xs text-gray-555 dark:text-gray-400 italic\">This is how you master Gold volatility — with institutional-grade risk controls 🛡️</p></div>",
    type: "AUTO_TRADE",
    platform: "MT5",
    icon: Bot,
  ...
  },
  {
    ...
    longDescription: "<div class=\"space-y-4\"><p><em>v1.4 — Minor Upgrade! 🥳</em></p><div class=\"space-y-2 mt-2\"><p>— <strong>Toggle dashboard filter trend</strong> — Toggle MT5 trend indicators and matrix panel seamlessly.</p><p>— <strong>Hotkey support</strong> — Execute actions instantly with your keyboard ( B → BUY NOW, S → SELL NOW, X → CLOSE ALL, E → Break Even).</p><p>— <strong>All panel buttons fully clickable</strong> — Designed for high-speed operation inside the MT5 Strategy Tester.</p><p>— <strong>Add up to 3 custom indicators</strong> — Enter indicator name or file path during backtests with no extra setup needed.</p><p>— <strong>Simulate real entries</strong> — Practice entries, pending orders, and automated SL/TP management under live conditions.</p><p>— <strong>Test your full strategy</strong> — Backtest, refine, and prove your setup before risking capital.</p></div><p class=\"font-extrabold text-blue-500 dark:text-blue-400 mt-4\">≫ Test smarter, execute faster. ⚡</p><p class=\"text-xs text-gray-550 dark:text-gray-400 italic flex items-center gap-1.5\">This is how you build confidence in your setup — before risking real money <span class=\"text-base\">🤔</span></p></div>",
    type: "MANUAL_ASSIST",
    platform: "MT5",
  ...
  },
  {
    ...
    longDescription: "<div class=\"space-y-4\"><p><em>v1.0 — 5-Layer Adaptive Survival Grid! 🦅</em></p><div class=\"space-y-2 mt-2\"><p>— <strong>5-Layer Modular Architecture</strong> — Advanced system designed for ultimate survival, dynamically adjusting spacing and multipliers across 3 drawdown levels.</p><p>— <strong>Phoenix Profit Bank</strong> — Proprietary engine that harvests scalp gains to peel off and prune the oldest high-risk positions, pulling target take-profits closer.</p><p>— <strong>Auto-Hedge Recovery Module</strong> — Locks down float drawdowns with isolated counter-trend positions to safely navigate vertical market spikes.</p><p>— <strong>Multi-Layered Protection System (MLPS)</strong> — Active spike control and ADX filters block entries during volatile macro news releases.</p><p>— <strong>State Persistence & Crash Recovery</strong> — Utilizes MT5 global variables to persist grid state and recover seamlessly after terminal restarts.</p></div><p class=\"font-extrabold text-emerald-500 dark:text-emerald-400 mt-4\">≫ Survive longer, harvest smarter. ⚡</p><p class=\"text-xs text-gray-550 dark:text-gray-400 italic\">This is how you build a resilient grid portfolio — with mechanical hedging controls 🛡️</p></div>",
    type: "AUTO_TRADE",
    platform: "MT5",
    icon: Bot,
    targetAsset: "XAUUSD (Gold)",
