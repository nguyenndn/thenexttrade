...
export async function getActivationState(
    ...
    const onboarding =
        (settings.onboarding as { preferredSyncMethod?: string }) || {};
    ...
    switch (syncMethod) {
        case "EA_SYNC":
            ...
            connectDescription =
                "Attach Trade Manager EA to your MT5 chart to start auto-syncing trades.";
        ...
        case "MANUAL":
            ...
            connectDescription =
                "Add an account to organize your manual trade entries.";
        ...
        default: // EA fallback
            connectTitle = "Set up Trade Manager";
            connectDescription =
                "Install Trade Manager EA to auto-sync trades from MT5 to your dashboard.";
            connectCtaLabel = "Set Up Trade Manager";
            connectCtaHref = "/dashboard/accounts?setup=sync&method=ea";
            break;
    }
    ...
    const steps: ActivationStep[] = [
        ...
        },
        {
            ...
            description:
                "Weekly reviews turn raw trades into one clear strength, one leak, and one focus.",
            ...
            disabledReason:
                "Sync more trades before your first weekly review is ready.",
        },
        {
            id: "START_ACADEMY",
            title: "Complete your first Academy lesson",
            description:
                "Lessons help turn trading activity into a repeatable playbook.",
        ...
        },
        {
            ...
            description:
                "Check-ins build consistency and feed your Edge Missions.",
            ctaLabel: "Check In",
    ...
    const nextStep =
        sorted.find((s) => !s.completed && s.available !== false) ?? null;
