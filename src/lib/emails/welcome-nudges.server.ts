...
export async function processWelcomeNudges(): Promise<WelcomeNudgeResult> {
 ...
 const welcomeNudges: Record<string, boolean> = settings.welcomeNudges || {};
 ...
 message: user._count.tradingAccounts === 0
 ...
 link: user._count.tradingAccounts === 0
 ? "/dashboard/accounts"
 : "/dashboard",
 icon: "BarChart3",
 priority: "NORMAL",
 ...
 message: "After just one trade, your dashboard unlocks: Performance Charts, AI Trade Score, Psychology Tracker, Session Analytics, and Weekly Reports.",
