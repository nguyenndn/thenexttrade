...
export function buildActivationEmailHtml(
  ...
  if (type === "NO_ACCOUNT_24H") {
    ...
    body = `
      ...
      <ul>
        <li><strong>AI Trade Score</strong>: Professional feedback on every trade.</li>
        <li><strong>Psychology Tracker</strong>: Identify mental errors costing you money.</li>
        <li><strong>Weekly Performance Reviews</strong>: Direct, actionable feedback every weekend.</li>
      </ul>
    ...
    body = `
      ...
      <p>Alternatively, you can always log trades manually on your mobile phone via your Journal hub.</p>
    `;
  }
    ...
    <div style="background-color: #f8fafc; padding: 40px 10px;">
      <div style="${emailStyles}">
        <div style="text-align: center; margin-bottom: 30px;">
          <h2 style="color: #00C888; margin: 0; font-size: 26px;">TheNextTrade</h2>
        </div>
        <div style="font-size: 16px; line-height: 1.6; color: #334155;">
          ${body}
        </div>
        <div style="border-t: 1px solid #e2e8f0; margin-top: 40px; padding-top: 20px; font-size: 12px; color: #94a3b8; text-align: center;">
          <p>You received this email because of your registration on TheNextTrade.</p>
          <p>
            <a href="${link.split("/dashboard")[0]}/dashboard/settings" style="color: #00C888; text-decoration: none;">Manage Email Preferences</a> · 
