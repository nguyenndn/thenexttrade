 ...
 */
const MISTAKE_LESSON_MAP: Record<
    string,
    {
        lessonSlugs: string[];
        description: string;
...
> = {
    ...
    "overtrading-day": {
        ...
        description:
            "You trade too frequently on certain days, leading to lower win rates.",
    },
    "weak-pair": {
        lessonSlugs: ["price-action-trading-for-beginners"],
        description: "You have consistently poor results on specific pairs.",
    },
    "emotion-pattern": {
        lessonSlugs: ["trading-routine-for-consistency"],
        description:
            "Certain emotional states correlate with losses in your trades.",
    },
    "plan-compliance": {
        lessonSlugs: [
            "trading-plan-how-to-create-one",
    ...
    cooldown_after_losses: {
        lessonSlugs: ["revenge-trading-and-how-to-stop-it"],
        description:
            "You continued trading immediately after hitting your loss streak threshold.",
    },
};
