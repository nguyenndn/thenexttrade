...
export async function generateActivitySnapshots() {
 ...
 active: results.filter((r) => ["ACTIVE_TRADER", "HIGH_VALUE_ACTIVE"].includes(r.activityStatus)).length,
 ...
 totalEstimatedRevenue: results.reduce((s, r) => s + r.estimatedIbRevenue, 0),
 };
}
