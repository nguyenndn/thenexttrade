...
export const AiTradingResultSchema = z
    .object({
...
export function validateAndCleanResult(
    rawJson: unknown
): { ok: true; data: AiTradingResult } | { ok: false; error: z.ZodError } {
