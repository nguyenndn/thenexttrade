...
export const OpenRouterAdapter: AiGatewayProviderAdapter = {
    providerCode: "openrouter",

    testCredential(input) {
        return testOpenAiCompatibleCredential(
            input,
    ...
    async execute(
        ...
        try {
            res = await fetch(
                input.baseUrl || "https://openrouter.ai/api/v1/chat/completions",
                {
                    ...
                    body: JSON.stringify({
                        model: input.modelId || "deepseek/deepseek-chat",
                        messages: [
        ...
        try {
            ...
            return {
                ...
                message: "OpenRouter returned malformed JSON (outer payload).",
                rawResponseText: responseText,
                httpStatus: res.status,
            };
        }
        ...
        try {
            ...
            return {
                ...
                error_code: "MODEL_RESPONSE_INVALID",
                message:
                    "OpenRouter returned invalid JSON inside the completion content.",
                rawResponseText: responseText,
                httpStatus: res.status,
            };
        }
