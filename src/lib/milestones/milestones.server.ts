...
export const MILESTONES: MilestoneDefinition[] = [
    {
        ...
        message:
            "Your MT5 account is linked. Trades will start syncing automatically.",
        icon: "Cable",
    ...
    },
    {
        ...
        message:
            "Your first weekly review is here. Discover patterns and insights from your trading week.",
        icon: "FileText",
    ...
    },
    {
        ...
        message:
            "You've logged 10 trades. Psychology tracker is now powered with enough data for meaningful insights.",
        icon: "Trophy",
    ...
    },
    {
        ...
        message:
            "Knowledge is your edge! Keep learning to sharpen your trading skills.",
        icon: "GraduationCap",
    ...
    },
    {
        ...
        title: "50 Trades! 🔥",
        message:
            "Half a century of trades logged. Your analytics are now statistically significant.",
        icon: "TrendingUp",
    ...
    },
    {
        ...
        message:
            "You've defined your first strategy. Now tag trades to track which strategies perform best.",
        icon: "Target",
...
export async function checkAndTriggerMilestones(
    ...
    const completedMilestones: MilestoneId[] =
        settings.milestones?.completed || [];
 ...
 */
export async function getCompletedMilestones(
    userId: string
): Promise<MilestoneId[]> {
    const user = await prisma.user.findUnique({
        where: { id: userId },
