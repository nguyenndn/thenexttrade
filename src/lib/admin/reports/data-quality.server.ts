...
export async function getDataQualityReport(): Promise<DataQualityReport> {
 ...
 if (accountsNoServer > 0) issues.push({ group: "Trading", issue: "Account without server", count: accountsNoServer, severity: "low", suggestedFix: "Check EA sync data", href: "/admin/ea/accounts" });
