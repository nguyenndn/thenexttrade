...
export function getSampleReportEmailData(type: "WEEKLY" | "MONTHLY"): ReportEmailData {
 ...
 type: "WEEKLY",
 netPnL: 342.50, // Positive example
 winRate: 64.3,
 totalTrades: 14,
 profitFactor: 2.15,
 avgWin: 65.00,
 ...
 prevWinRate: 58.0,
 topSymbols: [
 { name: "XAUUSD", pnl: 280.00 },
 { name: "EURUSD", pnl: 92.50 },
 { name: "BTCUSD", pnl: -30.00 }
 ],
 topMistakes: [
 ...
 type: "MONTHLY",
 netPnL: -185.30, // Negative example
 winRate: 48.5,
 totalTrades: 68,
 profitFactor: 0.88,
 avgWin: 45.20,
 ...
 prevWinRate: 55.2,
 topSymbols: [
 { name: "XAUUSD", pnl: -320.00 },
 { name: "GBPUSD", pnl: 185.20 },
 { name: "USDJPY", pnl: -50.50 }
 ],
 topMistakes: [
...
export function renderWelcomeEmailHtml(template: WelcomeEmailTemplate, userName = "Email Lab Trader"): string {
 const appUrl = process.env.NEXT_PUBLIC_APP_URL || "http://localhost:3000";
 const btnStyles = `
...
export function renderWelcomePreviewEmail(template: "d0" | "d1" | "d3"): { html: string; subject: string } {
